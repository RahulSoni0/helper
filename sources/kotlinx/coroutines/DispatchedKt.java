...
public final class DispatchedKt {
    ...
    public static final <T> void resumeCancellable(Continuation<? super T> continuation, T t) {
        ...
        if (continuation instanceof DispatchedContinuation) {
            ...
            try {
                ...
                if (job == null || job.isActive()) {
                    ...
                    dispatchedContinuation.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(job.getCancellationException())));
                    z = true;
                }
                if (!z) {
                    ...
                    continuation2.resumeWith(Result.m1941constructorimpl(t));
        ...
        continuation.resumeWith(Result.m1941constructorimpl(t));
    }
    ...
    public static final <T> void resumeCancellableWithException(Continuation<? super T> continuation, Throwable th) {
        ...
        if (continuation instanceof DispatchedContinuation) {
            ...
            try {
                ...
                if (!z) {
                    ...
                    Continuation<T> continuation2 = dispatchedContinuation.continuation;
                    Result.Companion companion2 = Result.Companion;
                    continuation2.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(th, continuation2))));
                    Unit unit = Unit.INSTANCE;
                    ThreadContextKt.restoreThreadContext(context, updateThreadContext);
                }
                do {
                ...
                try {
                    dispatchedTask.handleFatalException$kotlinx_coroutines_core(th2, (Throwable) null);
                } catch (Throwable th3) {
                    eventLoop$kotlinx_coroutines_core.decrementUseCount(true);
                    throw th3;
                }
        ...
        Result.Companion companion3 = Result.Companion;
        continuation.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(th, continuation))));
    }
