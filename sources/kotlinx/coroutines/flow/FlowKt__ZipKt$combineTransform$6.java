...
@DebugMetadata(mo18317c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo18318f = "Zip.kt", mo18319i = {0}, mo18320l = {294}, mo18321m = "invokeSuspend", mo18322n = {"$this$flow"}, mo18323s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$6.f297p$ = (FlowCollector) obj;
    ...
    @DebugMetadata(mo18317c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo18318f = "Zip.kt", mo18319i = {0, 0}, mo18320l = {294}, mo18321m = "invokeSuspend", mo18322n = {"$receiver", "it"}, mo18323s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C11642 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;

        /* renamed from: p$ */
        private FlowCollector f298p$;
        private Object[] p$0;
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            ...
            C11642 r0 = new C11642(this.this$0, continuation);
            r0.f298p$ = flowCollector;
            r0.p$0 = tArr;
            return r0;
        }

        public final Object invoke(Object obj, Object obj2, Object obj3) {
            return ((C11642) create((FlowCollector) obj, (Object[]) obj2, (Continuation) obj3)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f298p$;
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            this.this$0.$transform.invoke(this.f298p$, this.p$0, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f297p$;
            ...
            }, new C11642(this, (Continuation) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            FlowCollector flowCollector2 = (FlowCollector) this.L$0;
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C11642(this, (Continuation) null), this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
