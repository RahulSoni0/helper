...
@DebugMetadata(mo18317c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2", mo18318f = "Zip.kt", mo18319i = {0, 0}, mo18320l = {246}, mo18321m = "invokeSuspend", mo18322n = {"$receiver", "it"}, mo18323s = {"L$0", "L$1"})
...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        ...
        flowKt__ZipKt$combine$$inlined$unsafeFlow$2$lambda$2.f282p$ = flowCollector;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = this.f282p$;
