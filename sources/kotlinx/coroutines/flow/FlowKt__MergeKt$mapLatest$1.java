...
@DebugMetadata(mo18317c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", mo18318f = "Merge.kt", mo18319i = {0, 0, 1, 1}, mo18320l = {178, 178}, mo18321m = "invokeSuspend", mo18322n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, mo18323s = {"L$0", "L$1", "L$0", "L$1"})
...
final class FlowKt__MergeKt$mapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
        ...
        flowKt__MergeKt$mapLatest$1.f265p$ = flowCollector;
