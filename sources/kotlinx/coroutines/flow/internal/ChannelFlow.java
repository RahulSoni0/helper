...
public abstract class ChannelFlow<T> implements Flow<T> {
    ...
    public BroadcastChannel<T> broadcastImpl(CoroutineScope coroutineScope, CoroutineStart coroutineStart) {
        ...
        return BroadcastKt.broadcast$default(coroutineScope, this.context, getProduceCapacity(), coroutineStart, (Function1) null, getCollectToFun$kotlinx_coroutines_core(), 8, (Object) null);
    }
