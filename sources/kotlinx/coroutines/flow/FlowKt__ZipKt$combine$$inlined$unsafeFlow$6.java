...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$6 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        return CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$6$lambda$1(this), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$6$lambda$2((Continuation) null, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, new FlowKt__ZipKt$combine$$inlined$unsafeFlow$6$lambda$1(this), new FlowKt__ZipKt$combine$$inlined$unsafeFlow$6$lambda$2((Continuation) null, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
