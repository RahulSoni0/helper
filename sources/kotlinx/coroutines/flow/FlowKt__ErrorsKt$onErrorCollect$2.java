...
@DebugMetadata(mo18317c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$onErrorCollect$2", mo18318f = "Errors.kt", mo18319i = {0, 0, 0, 0}, mo18320l = {230}, mo18321m = "invokeSuspend", mo18322n = {"$this$catch", "e", "$this$emitAll$iv", "flow$iv"}, mo18323s = {"L$0", "L$1", "L$2", "L$3"})
...
final class FlowKt__ErrorsKt$onErrorCollect$2 extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super T> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
        ...
        flowKt__ErrorsKt$onErrorCollect$2.f261p$ = flowCollector;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = this.f261p$;
