...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$4 implements Flow<R> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        return this.$this_unsafeTransform$inlined.collect(new C1128xb62f807b(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C1128xb62f807b(flowCollector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
