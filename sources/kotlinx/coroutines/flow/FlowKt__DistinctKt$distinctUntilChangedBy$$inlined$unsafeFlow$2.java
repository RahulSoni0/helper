...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$2 implements Flow<T> {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        ...
        return this.$this_distinctUntilChangedBy$inlined.collect(new C1034x4e1b3e0c(flowCollector, objectRef, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        objectRef.element = NullSurrogateKt.NULL;
        InlineMarker.mark(0);
        this.$this_distinctUntilChangedBy$inlined.collect(new C1034x4e1b3e0c(flowCollector, objectRef, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
