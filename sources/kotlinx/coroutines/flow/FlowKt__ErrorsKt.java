...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> onErrorCollect(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        ...
        return FlowKt.m1928catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, (Continuation) null));
    }
    ...
    public static final <T> Flow<T> m1929catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
