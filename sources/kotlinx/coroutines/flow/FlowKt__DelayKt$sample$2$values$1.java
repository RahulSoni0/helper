...
@DebugMetadata(mo18317c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", mo18318f = "Delay.kt", mo18319i = {0, 0}, mo18320l = {137}, mo18321m = "invokeSuspend", mo18322n = {"$this$produce", "$this$collect$iv"}, mo18323s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__DelayKt$sample$2$values$1.f258p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ProducerScope producerScope = this.f258p$;
            Flow flow = this.this$0.$this_sample;
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(new C1022xe7e632(producerScope), this) == coroutine_suspended) {
