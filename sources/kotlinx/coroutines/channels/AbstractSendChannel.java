...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    @Metadata(mo18299bv = {1, 0, 3}, mo18300d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u0000*\u0004\b\u0001\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00028\u0001¢\u0006\u0002\u0010\u0006J\u0018\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0014¨\u0006\f"}, mo18301d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$SendConflatedDesc;", "E", "Lkotlinx/coroutines/channels/AbstractSendChannel$SendBufferedDesc;", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "element", "(Lkotlinx/coroutines/internal/LockFreeLinkedListHead;Ljava/lang/Object;)V", "finishOnSuccess", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "next", "kotlinx-coroutines-core"}, mo18302k = 1, mo18303mv = {1, 1, 15})
    /* compiled from: AbstractChannel.kt */
    ...
    private final void invokeOnCloseHandler(Throwable th) {
        ...
        if (obj != null && obj != AbstractChannelKt.HANDLER_INVOKED && C0842x3bb65290.m23m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if (!C0842x3bb65290.m23m(atomicReferenceFieldUpdater, this, (Object) null, function1)) {
            Object obj = this.onCloseHandler;
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend != null && C0842x3bb65290.m23m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
        ...
        while (true) {
            if (getFull()) {
                ...
                if (access$enqueueSend == null) {
                    ...
                    cancellableContinuation.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(sendException)));
                    break;
                } else if (access$enqueueSend != AbstractChannelKt.ENQUEUE_FAILED && !(access$enqueueSend instanceof Receive)) {
                    throw new IllegalStateException(("enqueueSend returned " + access$enqueueSend).toString());
                }
            }
            Object offerInternal = offerInternal(e);
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                if (offerInternal instanceof Closed) {
                    ...
                    cancellableContinuation.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(sendException2)));
                } else {
                    throw new IllegalStateException(("offerInternal returned " + offerInternal).toString());
                }
            }
