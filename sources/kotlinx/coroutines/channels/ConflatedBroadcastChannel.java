...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    @Metadata(mo18299bv = {1, 0, 3}, mo18300d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, mo18301d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, mo18302k = 1, mo18303mv = {1, 1, 15})
    /* compiled from: ConflatedBroadcastChannel.kt */
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj, new State(obj2, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if ((obj2 instanceof Closed) && C0842x3bb65290.m23m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    private final Closed offerInternal(E e) {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj, new State(e, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj, th == null ? CLOSED : new Closed(th)));
        if (obj != null) {
            Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
            if (subscriberArr != null) {
