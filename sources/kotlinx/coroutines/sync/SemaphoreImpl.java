            ...
            if (semaphoreSegment != null) {
                ...
                if (andSet != null) {
                    if (andSet != SemaphoreKt.CANCELLED) {
                        ...
                        ((CancellableContinuation) andSet).resumeWith(Result.m1941constructorimpl(unit));
                        return;
                    }
                } else {
                    return;
