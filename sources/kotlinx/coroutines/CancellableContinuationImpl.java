...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public final CancelledContinuation resumeWithExceptionMode$kotlinx_coroutines_core(Throwable th, int i) {
        ...
        return resumeImpl(new CompletedExceptionally(th, false, 2, (DefaultConstructorMarker) null), i);
    }
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (cancelHandler2 == null) {
                    cancelHandler2 = makeHandler(function1);
                }
                if (C0842x3bb65290.m23m(_state$FU, this, obj, cancelHandler2)) {
                    return;
                }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj, new CancelledContinuation(this, th, z)));
        if (z) {
            try {
    ...
    private final CancelledContinuation resumeImpl(Object obj, int i) {
        while (true) {
            ...
            } else if (C0842x3bb65290.m23m(_state$FU, this, obj2, obj)) {
                disposeParentHandle();
                dispatchResume(i);
                return null;
            }
    ...
    public Object tryResume(T t, Object obj) {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj2, t2));
        disposeParentHandle();
        return obj2;
    }
    ...
    public Object tryResumeWithException(Throwable th) {
        ...
        } while (!C0842x3bb65290.m23m(_state$FU, this, obj, new CompletedExceptionally(th, false, 2, (DefaultConstructorMarker) null)));
        disposeParentHandle();
        return obj;
    }
}
