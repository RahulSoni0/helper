...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m1941constructorimpl(new HandlerContext(asHandler(mainLooper, true), "Main"));
        } catch (Throwable th) {
