        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                if (exceptionalResult$kotlinx_coroutines_core == null && job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(cancellationException, continuation))));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.Companion;
                    continuation.resumeWith(Result.m1941constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exceptionalResult$kotlinx_coroutines_core, continuation))));
                } else {
                    ...
                    continuation.resumeWith(Result.m1941constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    obj = Result.m1941constructorimpl(Unit.INSTANCE);
                } catch (Throwable th3) {
                    th = th3;
                    Result.Companion companion5 = Result.Companion;
                    obj = Result.m1941constructorimpl(ResultKt.createFailure(th));
                    handleFatalException$kotlinx_coroutines_core(th, Result.m1944exceptionOrNullimpl(obj));
                }
                handleFatalException$kotlinx_coroutines_core(th, Result.m1944exceptionOrNullimpl(obj));
            }
