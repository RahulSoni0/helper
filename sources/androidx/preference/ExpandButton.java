...
final class ExpandButton extends Preference {
    ...
    private void initLayout() {
        setLayoutResource(C0573R.layout.expand_button);
        setIcon(C0573R.C0575drawable.ic_arrow_down_24dp);
        setTitle(C0573R.string.expand_button_title);
        ...
        for (Preference next : list) {
            ...
            if (arrayList.contains(next.getParent())) {
                ...
                if (charSequence == null) {
                    ...
                    charSequence = getContext().getString(C0573R.string.summary_collapsed_preference_list, new Object[]{charSequence, title});
                }
            }
        }
