...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    public PreferenceViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        TypedArray obtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes((AttributeSet) null, C0573R.styleable.BackgroundStyle);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0573R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (drawable == null) {
    ...
    private static class PreferenceResourceDescriptor {
        ...
        public int hashCode() {
            return ((((MetaDo.META_OFFSETWINDOWORG + this.mLayoutResId) * 31) + this.mWidgetLayoutResId) * 31) + this.mClassName.hashCode();
        }
    }
}
