...
public class NavGraph extends NavDestination implements Iterable<NavDestination> {
    ...
    public void onInflate(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0530R.styleable.NavGraphNavigator);
        setStartDestination(obtainAttributes.getResourceId(C0530R.styleable.NavGraphNavigator_startDestination, 0));
