...
public class NavDestination {
    ...
    public void onInflate(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0530R.styleable.Navigator);
        setId(obtainAttributes.getResourceId(C0530R.styleable.Navigator_android_id, 0));
        this.mIdName = getDisplayName(context, this.mId);
        setLabel(obtainAttributes.getText(C0530R.styleable.Navigator_android_label));
