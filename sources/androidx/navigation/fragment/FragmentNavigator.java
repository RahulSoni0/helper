...
public class FragmentNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0535R.styleable.FragmentNavigator);
            String string = obtainAttributes.getString(C0535R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
