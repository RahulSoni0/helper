    ...
    static /* synthetic */ class C05061 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.NavBackStackEntry.C05061.<clinit>():void");
        }
    }

    private static Lifecycle.State getStateAfter(Lifecycle.Event event) {
        switch (C05061.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
            case 1:
            case 2:
