...
public class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((this.f91id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f92id.equals(idAndState.f92id);
        }

        public int hashCode() {
            return (this.f92id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            return new WorkInfo(UUID.fromString(this.f93id), this.state, this.output, this.tags, this.runAttemptCount);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (str == null ? workInfoPojo.f93id != null : !str.equals(workInfoPojo.f93id)) {
                return false;
            }
