                ...
                taskExecutor.executeOnBackgroundThread(new Runnable() {
                    public void run() {
                        synchronized (obj) {
                            ...
                            if (C08341.this.mCurrentOutput == null && apply != null) {
                                C08341.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            } else if (C08341.this.mCurrentOutput != null && !C08341.this.mCurrentOutput.equals(apply)) {
                                C08341.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            }
                        }
