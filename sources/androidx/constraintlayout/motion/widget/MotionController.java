    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (i16 < size) {
                if (motionPathsArr[i16].hasCustomData(str7)) {
                    ...
                    motionPathsArr[i16].getCustomData(str7, dArr5[i17], 0);
                    i17++;
                }
                i16++;
                i3 = 2;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                dArr6[i18] = (double) motionPathsArr[i18].time;
                dArr7[i18][0] = (double) motionPathsArr[i18].f29x;
                dArr7[i18][1] = (double) motionPathsArr[i18].f30y;
            }
