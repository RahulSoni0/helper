...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f53CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f54TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        if (isMailTo(str)) {
            ...
            mailTo.mHeaders.put(f54TO, str3);
            return mailTo;
        }
    ...
    public String getTo() {
        return this.mHeaders.get(f54TO);
    }

    public String getCc() {
        return this.mHeaders.get(f53CC);
    }
