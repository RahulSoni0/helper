...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0054R.style.Theme_AppCompat_Empty);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0054R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0054R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0054R.C0057id.decor_content_parent);
            ...
            if (viewGroup != null) {
                ...
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0054R.C0057id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0054R.C0057id.action_bar_activity_content);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0054R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0054R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0054R.attr.actionBarSize
        ...
        L_0x00b5:
            ...
            int r4 = androidx.appcompat.C0054R.C0057id.action_mode_bar_stub
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0054R.attr.actionBarTheme, typedValue, true);
            Resources.Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0054R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0054R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0054R.C0055color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0054R.C0055color.abc_decor_view_status_guard);
        }
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            if (typedValue.resourceId != 0) {
                ...
                newTheme.applyStyle(C0054R.style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0054R.layout.abc_list_menu_item_layout);
