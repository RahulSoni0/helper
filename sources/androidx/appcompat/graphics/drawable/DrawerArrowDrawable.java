...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0054R.styleable.DrawerArrowToggle, C0054R.attr.drawerArrowStyle, C0054R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        ...
        setGapSize((float) Math.round(obtainStyledAttributes.getDimension(C0054R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = obtainStyledAttributes.getDimensionPixelSize(C0054R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(obtainStyledAttributes.getDimension(C0054R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(obtainStyledAttributes.getDimension(C0054R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
