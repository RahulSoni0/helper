...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0054R.styleable.ButtonBarLayout, attributeSet, obtainStyledAttributes, 0, 0);
    ...
    private void setStacked(boolean z) {
        ...
        View findViewById = findViewById(C0054R.C0057id.spacer);
