...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0054R.styleable.CompoundButton
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0054R.styleable.CompoundButton
            ...
            int r11 = androidx.appcompat.C0054R.styleable.CompoundButton_buttonCompat     // Catch:{ all -> 0x008e }
        ...
        L_0x003f:
            ...
            int r11 = androidx.appcompat.C0054R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x005e
            int r11 = androidx.appcompat.C0054R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x008e }
            int r11 = r0.getResourceId(r11, r2)     // Catch:{ all -> 0x008e }
        ...
        L_0x005e:
            int r11 = androidx.appcompat.C0054R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x0071
            android.widget.CompoundButton r11 = r10.mView     // Catch:{ all -> 0x008e }
            int r12 = androidx.appcompat.C0054R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x008e }
        ...
        L_0x0071:
            int r11 = androidx.appcompat.C0054R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x008a
            android.widget.CompoundButton r11 = r10.mView     // Catch:{ all -> 0x008e }
            int r12 = androidx.appcompat.C0054R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x008e }
            r1 = -1
