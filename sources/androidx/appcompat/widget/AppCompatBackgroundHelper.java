...
class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(view, view.getContext(), C0054R.styleable.ViewBackgroundHelper, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        try {
            ...
            if (obtainStyledAttributes.hasValue(C0054R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0054R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), (PorterDuff.Mode) null));
            }
        } finally {
