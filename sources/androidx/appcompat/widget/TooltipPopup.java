...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View inflate = LayoutInflater.from(context).inflate(C0054R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = inflate;
        this.mMessageView = (TextView) inflate.findViewById(C0054R.C0057id.message);
        ...
        layoutParams.windowAnimations = C0054R.style.Animation_AppCompat_Tooltip;
