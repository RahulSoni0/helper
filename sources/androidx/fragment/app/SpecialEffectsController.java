...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0335R.C0338id.special_effects_controller_view_tag);
        if (tag instanceof SpecialEffectsController) {
            return (SpecialEffectsController) tag;
        }
        SpecialEffectsController createController = specialEffectsControllerFactory.createController(viewGroup);
        viewGroup.setTag(C0335R.C0338id.special_effects_controller_view_tag, createController);
    ...
    static class Operation {
        ...
        enum State {
            ...
            public void applyState(View view) {
                int i = C04103.f65xe493b431[ordinal()];
                if (i == 1) {
        ...
        public final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C04103.f64xb9e640f0[lifecycleImpact.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    if (FragmentManager.isLoggingEnabled(2)) {
    ...
    static /* synthetic */ class C04103 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f64xb9e640f0     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f64xb9e640f0     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f65xe493b431     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = f65xe493b431     // Catch:{ NoSuchFieldError -> 0x004d }
            ...
            L_0x004d:
                int[] r0 = f65xe493b431     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.SpecialEffectsController.C04103.<clinit>():void");
        }
    }
