...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0335R.styleable.FragmentContainerView);
            if (classAttribute == null) {
                classAttribute = obtainStyledAttributes.getString(C0335R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            } else {
                str = HtmlTags.CLASS;
            }
    ...
    FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        String classAttribute = attributeSet.getClassAttribute();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0335R.styleable.FragmentContainerView);
        classAttribute = classAttribute == null ? obtainStyledAttributes.getString(C0335R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = obtainStyledAttributes.getString(C0335R.styleable.FragmentContainerView_android_tag);
        obtainStyledAttributes.recycle();
        int id = getId();
