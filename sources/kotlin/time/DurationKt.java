...
public final class DurationKt {
    ...
    private static final double m1906timesmvk6XK0(int i, double d) {
        return Duration.m1886timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1905timeskIfJnKk(double d, double d2) {
        return Duration.m1885timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        return Duration.m1859constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
