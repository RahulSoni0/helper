...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m273ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m274ln(float f) {
