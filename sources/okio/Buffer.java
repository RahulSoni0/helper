...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 4) {
                return ((readByte() & UByte.MAX_VALUE) << 24) | ((readByte() & UByte.MAX_VALUE) << BidiOrder.f1242S) | ((readByte() & UByte.MAX_VALUE) << 8) | (readByte() & UByte.MAX_VALUE);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & UByte.MAX_VALUE) << 24) | ((bArr[i3] & UByte.MAX_VALUE) << BidiOrder.f1242S);
            int i5 = i4 + 1;
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m280of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m280of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
