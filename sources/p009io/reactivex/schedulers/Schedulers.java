package p009io.reactivex.schedulers;

import java.util.concurrent.Callable;
import java.util.concurrent.Executor;
import p009io.reactivex.Scheduler;
import p009io.reactivex.internal.schedulers.ComputationScheduler;
import p009io.reactivex.internal.schedulers.ExecutorScheduler;
import p009io.reactivex.internal.schedulers.IoScheduler;
import p009io.reactivex.internal.schedulers.NewThreadScheduler;
import p009io.reactivex.internal.schedulers.SchedulerPoolFactory;
import p009io.reactivex.internal.schedulers.SingleScheduler;
import p009io.reactivex.internal.schedulers.TrampolineScheduler;
...
public final class Schedulers {
    ...
    /* renamed from: IO */
    static final Scheduler f1649IO = RxJavaPlugins.initIoScheduler(new IOTask());
    ...
    /* renamed from: io */
    public static Scheduler m985io() {
        return RxJavaPlugins.onIoScheduler(f1649IO);
    }
