...
import p009io.reactivex.internal.observers.BiConsumerSingleObserver;
import p009io.reactivex.internal.observers.BlockingMultiObserver;
import p009io.reactivex.internal.observers.ConsumerSingleObserver;
import p009io.reactivex.internal.observers.FutureSingleObserver;
import p009io.reactivex.internal.operators.completable.CompletableFromSingle;
import p009io.reactivex.internal.operators.completable.CompletableToFlowable;
...
import p009io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p009io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p009io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p009io.reactivex.internal.operators.single.SingleAmb;
import p009io.reactivex.internal.operators.single.SingleCache;
import p009io.reactivex.internal.operators.single.SingleContains;
import p009io.reactivex.internal.operators.single.SingleCreate;
import p009io.reactivex.internal.operators.single.SingleDefer;
import p009io.reactivex.internal.operators.single.SingleDelay;
import p009io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p009io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p009io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p009io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p009io.reactivex.internal.operators.single.SingleDematerialize;
import p009io.reactivex.internal.operators.single.SingleDetach;
import p009io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p009io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p009io.reactivex.internal.operators.single.SingleDoFinally;
import p009io.reactivex.internal.operators.single.SingleDoOnDispose;
import p009io.reactivex.internal.operators.single.SingleDoOnError;
import p009io.reactivex.internal.operators.single.SingleDoOnEvent;
import p009io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p009io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p009io.reactivex.internal.operators.single.SingleDoOnTerminate;
import p009io.reactivex.internal.operators.single.SingleEquals;
import p009io.reactivex.internal.operators.single.SingleError;
import p009io.reactivex.internal.operators.single.SingleFlatMap;
import p009io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p009io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p009io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p009io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p009io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p009io.reactivex.internal.operators.single.SingleFromCallable;
import p009io.reactivex.internal.operators.single.SingleFromPublisher;
import p009io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p009io.reactivex.internal.operators.single.SingleHide;
import p009io.reactivex.internal.operators.single.SingleInternalHelper;
import p009io.reactivex.internal.operators.single.SingleJust;
import p009io.reactivex.internal.operators.single.SingleLift;
import p009io.reactivex.internal.operators.single.SingleMap;
import p009io.reactivex.internal.operators.single.SingleMaterialize;
import p009io.reactivex.internal.operators.single.SingleNever;
import p009io.reactivex.internal.operators.single.SingleObserveOn;
import p009io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p009io.reactivex.internal.operators.single.SingleResumeNext;
import p009io.reactivex.internal.operators.single.SingleSubscribeOn;
import p009io.reactivex.internal.operators.single.SingleTakeUntil;
import p009io.reactivex.internal.operators.single.SingleTimeout;
import p009io.reactivex.internal.operators.single.SingleTimer;
import p009io.reactivex.internal.operators.single.SingleToFlowable;
import p009io.reactivex.internal.operators.single.SingleToObservable;
import p009io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p009io.reactivex.internal.operators.single.SingleUsing;
import p009io.reactivex.internal.operators.single.SingleZipArray;
import p009io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo18132as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo18207to(Function<? super Single<T>, R> function) {
        try {
