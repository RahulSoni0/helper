...
import p009io.reactivex.internal.schedulers.NewThreadWorker;
import p009io.reactivex.internal.schedulers.SchedulerWhen;
        ...
        final class PeriodicTask implements Runnable, SchedulerRunnableIntrospection {
            ...
            public void run() {
                ...
                if (!this.f1538sd.isDisposed()) {
                    ...
                    this.f1538sd.replace(Worker.this.schedule(this, j - now, TimeUnit.NANOSECONDS));
                }
            }
