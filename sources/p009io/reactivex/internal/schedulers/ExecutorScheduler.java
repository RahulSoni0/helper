...
import p009io.reactivex.schedulers.SchedulerRunnableIntrospection;
...
public final class ExecutorScheduler extends Scheduler {
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p009io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f1626dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f1626dr = delayedRunnable;
        }

        public void run() {
            this.f1626dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f1626dr));
        }
    }
}
