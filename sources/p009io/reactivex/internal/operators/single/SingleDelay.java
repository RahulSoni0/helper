...
public final class SingleDelay<T> extends Single<T> {
    ...
    final class Delay implements SingleObserver<T> {
        ...
        /* renamed from: sd */
        private final SequentialDisposable f1619sd;

        Delay(SequentialDisposable sequentialDisposable, SingleObserver<? super T> singleObserver) {
            this.f1619sd = sequentialDisposable;
            this.downstream = singleObserver;
        }

        public void onSubscribe(Disposable disposable) {
            this.f1619sd.replace(disposable);
        }

        public void onSuccess(T t) {
            this.f1619sd.replace(SingleDelay.this.scheduler.scheduleDirect(new OnSuccess(t), SingleDelay.this.time, SingleDelay.this.unit));
        }

        public void onError(Throwable th) {
            this.f1619sd.replace(SingleDelay.this.scheduler.scheduleDirect(new OnError(th), SingleDelay.this.delayError ? SingleDelay.this.time : 0, SingleDelay.this.unit));
        }
        ...
        final class OnError implements Runnable {
            ...
            /* renamed from: e */
            private final Throwable f1620e;
            ...
            public void run() {
                Delay.this.downstream.onError(this.f1620e);
            }
        }
    }
}
