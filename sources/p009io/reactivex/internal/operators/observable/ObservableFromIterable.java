...
import p009io.reactivex.internal.observers.BasicQueueDisposable;
...
public final class ObservableFromIterable<T> extends Observable<T> {
    ...
    static final class FromIterableDisposable<T> extends BasicQueueDisposable<T> {
        ...
        /* renamed from: it */
        final Iterator<? extends T> f1602it;
        ...
        public void run() {
            while (!isDisposed()) {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.f1602it.next(), "The iterator returned a null value"));
                    if (!isDisposed()) {
                        try {
                            if (!this.f1602it.hasNext()) {
                                if (!isDisposed()) {
        ...
        public T poll() {
            ...
            if (!this.checkNext) {
                this.checkNext = true;
            } else if (!this.f1602it.hasNext()) {
                this.done = true;
                return null;
            }
            return ObjectHelper.requireNonNull(this.f1602it.next(), "The iterator returned a null value");
        }
