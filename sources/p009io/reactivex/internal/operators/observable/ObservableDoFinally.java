...
import p009io.reactivex.internal.observers.BasicIntQueueDisposable;
...
public final class ObservableDoFinally<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class DoFinallyObserver<T> extends BasicIntQueueDisposable<T> implements Observer<T> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                if (disposable instanceof QueueDisposable) {
                    this.f1600qd = (QueueDisposable) disposable;
                }
        ...
        public int requestFusion(int i) {
            QueueDisposable<T> queueDisposable = this.f1600qd;
            boolean z = false;
        ...
        public boolean isEmpty() {
            return this.f1600qd.isEmpty();
        }

        public T poll() throws Exception {
            T poll = this.f1600qd.poll();
