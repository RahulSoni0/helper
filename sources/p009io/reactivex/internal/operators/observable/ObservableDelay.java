...
public final class ObservableDelay<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class DelayObserver<T> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            this.f1598w.schedule(new OnNext(t), this.delay, this.unit);
        }

        public void onError(Throwable th) {
            this.f1598w.schedule(new OnError(th), this.delayError ? this.delay : 0, this.unit);
        }

        public void onComplete() {
            this.f1598w.schedule(new OnComplete(), this.delay, this.unit);
        }
        ...
        final class OnNext implements Runnable {
            ...
            public void run() {
                DelayObserver.this.downstream.onNext(this.f1599t);
            }
        }
        ...
        final class OnError implements Runnable {
            ...
            public void run() {
                try {
                    ...
                    DelayObserver.this.f1598w.dispose();
                }
            }
        }
