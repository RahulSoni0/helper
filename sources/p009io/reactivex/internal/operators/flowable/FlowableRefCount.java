...
public final class FlowableRefCount<T> extends Flowable<T> {
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        synchronized (this) {
            ...
            z = true;
            if (refConnection.connected || j2 != ((long) this.f1574n)) {
                z = false;
            } else {
    ...
    public void cancel(p009io.reactivex.internal.operators.flowable.FlowableRefCount.RefConnection r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x003f:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p009io.reactivex.internal.operators.flowable.FlowableRefCount.cancel(io.reactivex.internal.operators.flowable.FlowableRefCount$RefConnection):void");
    }
