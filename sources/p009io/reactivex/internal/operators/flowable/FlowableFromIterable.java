...
import p009io.reactivex.internal.subscriptions.BasicQueueSubscription;
...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        public final T poll() {
            Iterator<? extends T> it = this.f1571it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return ObjectHelper.requireNonNull(this.f1571it.next(), "Iterator.next() returned a null value");
        }
