...
class PdfStamperImp extends PdfWriter {
            ...
            if (z) {
                if (!pdfReader.isRebuilt()) {
                    ...
                    while (true) {
                        ...
                        this.f1154os.write(bArr, 0, read);
                    }
    ...
    public void readColorProfile() {
        ...
        if (asArray != null) {
            ...
            if (asArray.size() > 0) {
                ...
                int i = 0;
                while (i < asArray.size() && ((r3 = asArray.getAsDict(i)) == null || (pdfStream = r3.getAsStream(PdfName.DESTOUTPUTPROFILE)) == null)) {
                    i++;
                }
        ...
        if (!this.closed) {
            ...
            if (!this.documentOCG.isEmpty()) {
                ...
                if (asDict == null) {
                    ...
                    PdfDictionary asDict2 = asDict.getAsDict(PdfName.f1282D);
                    if (asDict2 == null) {
                        asDict2 = new PdfDictionary();
                        asDict.put(PdfName.f1282D, asDict2);
                    }
                    asDict2.put(PdfName.ORDER, this.OCProperties.getAsDict(PdfName.f1282D).get(PdfName.ORDER));
                    asDict2.put(PdfName.RBGROUPS, this.OCProperties.getAsDict(PdfName.f1282D).get(PdfName.RBGROUPS));
                    asDict2.put(PdfName.OFF, this.OCProperties.getAsDict(PdfName.f1282D).get(PdfName.OFF));
                    asDict2.put(PdfName.f1265AS, this.OCProperties.getAsDict(PdfName.f1282D).get(PdfName.f1265AS));
                }
    ...
    public void close(PdfIndirectReference pdfIndirectReference, int i) throws IOException {
        ...
        if (this.crypto != null) {
            ...
            PdfArray asArray = this.reader.trailer.getAsArray(PdfName.f1315ID);
        ...
        this.body.writeCrossReferenceTable(this.f1154os, pdfIndirectReference3, pdfIndirectReference, pdfIndirectReference2, pdfObject, this.prevxref);
        if (this.fullCompression) {
            writeKeyInfo(this.f1154os);
            this.f1154os.write(getISOBytes("startxref\n"));
            this.f1154os.write(getISOBytes(String.valueOf(this.body.offset())));
            this.f1154os.write(getISOBytes("\n%%EOF\n"));
        } else {
            new PdfWriter.PdfTrailer(this.body.size(), this.body.offset(), pdfIndirectReference3, pdfIndirectReference, pdfIndirectReference2, pdfObject, this.prevxref).toPdf(this, this.f1154os);
        }
        this.f1154os.flush();
        if (isCloseStream()) {
            this.f1154os.close();
        }
        getCounter().written(this.f1154os.getCounter());
    }
    ...
    public void addComments(com.itextpdf.text.pdf.FdfReader r12) throws java.io.IOException {
        ...
        L_0x0060:
            ...
            com.itextpdf.text.pdf.PdfName r9 = com.itextpdf.text.pdf.PdfName.f1331NM
    ...
    public void flatFields() {
        ...
        L_0x0085:
            ...
            com.itextpdf.text.pdf.PdfName r10 = com.itextpdf.text.pdf.PdfName.f1295F
        ...
        L_0x009d:
            ...
            goto L_0x0398
        L_0x00a9:
            com.itextpdf.text.pdf.PdfName r12 = com.itextpdf.text.pdf.PdfName.f1264AP
            com.itextpdf.text.pdf.PdfDictionary r12 = r9.getAsDict(r12)
            if (r12 == 0) goto L_0x00c0
            com.itextpdf.text.pdf.PdfName r13 = com.itextpdf.text.pdf.PdfName.f1325N
        ...
        L_0x017d:
            ...
            com.itextpdf.text.pdf.PdfName r6 = com.itextpdf.text.pdf.PdfName.f1264AP     // Catch:{ DocumentException | IOException -> 0x0194 }
        ...
        L_0x0208:
            ...
            com.itextpdf.text.pdf.PdfName r4 = com.itextpdf.text.pdf.PdfName.f1264AP     // Catch:{ DocumentException | IOException -> 0x0194 }
        ...
        L_0x0229:
            ...
            r2 = r10 & 2
            if (r2 != 0) goto L_0x02bf
            com.itextpdf.text.pdf.PdfName r2 = com.itextpdf.text.pdf.PdfName.f1325N
        ...
        L_0x0266:
            ...
            if (r2 == 0) goto L_0x0299
            com.itextpdf.text.pdf.PdfName r2 = com.itextpdf.text.pdf.PdfName.f1265AS
    ...
    public void eliminateAcroformObjects() {
        ...
        if (pdfObject != null) {
            ...
            pdfDictionary.remove(PdfName.f1289DR);
        }
    }
                ...
                if (asArray != null) {
                    ...
                    while (i2 < asArray.size()) {
                        ...
                        if ((!(directObject instanceof PdfIndirectReference) || directObject.isIndirect()) && (directObject instanceof PdfDictionary)) {
                            ...
                            PdfNumber asNumber = pdfDictionary.getAsNumber(PdfName.f1295F);
                            int intValue = asNumber != null ? asNumber.intValue() : 0;
                            if (!((intValue & 4) == 0 || (intValue & 2) != 0 || (pdfObject = pdfDictionary.get(PdfName.f1264AP)) == null)) {
                                ...
                                PdfObject pdfObject2 = pdfDictionary2.get(PdfName.f1325N);
                                PdfStream asStream = pdfDictionary2.getAsStream(PdfName.f1325N);
                                ...
                                if ((pdfObject2 instanceof PdfIndirectReference) && !pdfObject2.isIndirect()) {
                                    ...
                                    pdfAppearance = new PdfAppearance((PdfIndirectReference) pdfObject2);
                                } else if (!(!pdfObject3.isDictionary() || (asName = pdfDictionary2.getAsName(PdfName.f1265AS)) == null || (pdfIndirectReference = (PdfIndirectReference) ((PdfDictionary) pdfObject3).get(asName)) == null)) {
    ...
    private Rectangle transformBBoxByMatrix(Rectangle rectangle, double[] dArr) {
        ...
        arrayList.add(Double.valueOf(transformPoint.f1105x));
        arrayList2.add(Double.valueOf(transformPoint.f1106y));
        Point transformPoint2 = transformPoint((double) rectangle.getRight(), (double) rectangle.getTop(), dArr2);
        arrayList.add(Double.valueOf(transformPoint2.f1105x));
        arrayList2.add(Double.valueOf(transformPoint2.f1106y));
        Point transformPoint3 = transformPoint((double) rectangle.getLeft(), (double) rectangle.getTop(), dArr2);
        arrayList.add(Double.valueOf(transformPoint3.f1105x));
        arrayList2.add(Double.valueOf(transformPoint3.f1106y));
        Point transformPoint4 = transformPoint((double) rectangle.getRight(), (double) rectangle.getBottom(), dArr2);
        arrayList.add(Double.valueOf(transformPoint4.f1105x));
        arrayList2.add(Double.valueOf(transformPoint4.f1106y));
    ...
    private Point transformPoint(double d, double d2, double[] dArr) {
        ...
        point.f1105x = (dArr[0] * d) + (dArr[2] * d2) + dArr[4];
        point.f1106y = (dArr[1] * d) + (dArr[3] * d2) + dArr[5];
        return point;
    }
    ...
    public void addDocumentField(PdfIndirectReference pdfIndirectReference) {
        ...
        if (!pdfDictionary.contains(PdfName.f1283DA)) {
    ...
    public void addFieldResources() throws IOException {
        if (!this.fieldTemplates.isEmpty()) {
            ...
            PdfDictionary pdfDictionary2 = (PdfDictionary) PdfReader.getPdfObject(pdfDictionary.get(PdfName.f1289DR), pdfDictionary);
            if (pdfDictionary2 == null) {
                pdfDictionary2 = new PdfDictionary();
                pdfDictionary.put(PdfName.f1289DR, pdfDictionary2);
                markUsed((PdfObject) pdfDictionary);
            }
            ...
            if (pdfDictionary.get(PdfName.f1283DA) == null) {
                pdfDictionary.put(PdfName.f1283DA, new PdfString("/Helv 0 Tf 0 g "));
                markUsed((PdfObject) pdfDictionary);
            }
        }
    ...
    private void outlineTravel(PRIndirectReference pRIndirectReference) {
        while (pRIndirectReference != null) {
            ...
            PdfReader.killIndirect(pdfDictionary.get(PdfName.f1260A));
    ...
    public void setPageAction(PdfName pdfName, PdfAction pdfAction, int i) throws PdfException {
        if (pdfName.equals(PAGE_OPEN) || pdfName.equals(PAGE_CLOSE)) {
            PdfDictionary pageN = this.reader.getPageN(i);
            PdfDictionary pdfDictionary = (PdfDictionary) PdfReader.getPdfObject(pageN.get(PdfName.f1261AA), pageN);
            if (pdfDictionary == null) {
                pdfDictionary = new PdfDictionary();
                pageN.put(PdfName.f1261AA, pdfDictionary);
    ...
    public void setAdditionalAction(PdfName pdfName, PdfAction pdfAction) throws PdfException {
        if (pdfName.equals(DOCUMENT_CLOSE) || pdfName.equals(WILL_SAVE) || pdfName.equals(DID_SAVE) || pdfName.equals(WILL_PRINT) || pdfName.equals(DID_PRINT)) {
            PdfDictionary asDict = this.reader.getCatalog().getAsDict(PdfName.f1261AA);
            if (asDict == null) {
                if (pdfAction != null) {
                    asDict = new PdfDictionary();
                    this.reader.getCatalog().put(PdfName.f1261AA, asDict);
                } else {
                    return;
                }
            }
