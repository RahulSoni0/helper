...
public class BidiLine {
    ...
    public boolean getParagraph(int r12) {
        ...
        L_0x00a4:
            ...
            com.itextpdf.text.pdf.languages.ArabicLigaturizer.processNumbers(r2, r0, r1, r3)
            r1 = 2
    ...
    public void save() {
        ...
        if (this.runDirection != 1) {
            ...
            if (length < i5) {
                this.storedOrderLevels = new byte[i5];
                this.storedIndexChars = new int[i5];
            }
            byte[] bArr = this.orderLevels;
            int i6 = this.currentChar;
            System.arraycopy(bArr, i6, this.storedOrderLevels, i6, i5 - i6);
            int[] iArr = this.indexChars;
            int i7 = this.currentChar;
            System.arraycopy(iArr, i7, this.storedIndexChars, i7, this.totalTextLength - i7);
        }
    }
    ...
    public com.itextpdf.text.pdf.PdfLine processLine(float r27, float r28, int r29, int r30, int r31, float r32, float r33, float r34) {
        ...
        L_0x0025:
            ...
            r1 = r1[r10]
            java.lang.String r2 = ""
            r0.<init>((java.lang.String) r2, (com.itextpdf.text.pdf.PdfChunk) r1)
            r6.add(r0)
        ...
        L_0x00b9:
            char[] r1 = r8.text
            int r2 = r8.currentChar
            boolean r21 = com.itextpdf.text.Utilities.isSurrogatePair((char[]) r1, (int) r2)
            if (r21 == 0) goto L_0x00d0
            char[] r1 = r8.text
            int r2 = r8.currentChar
            int r1 = com.itextpdf.text.Utilities.convertToUtf32((char[]) r1, (int) r2)
        ...
        L_0x0314:
            ...
            com.itextpdf.text.pdf.PdfChunk r0 = new com.itextpdf.text.pdf.PdfChunk
            r0.<init>((java.lang.String) r4, (com.itextpdf.text.pdf.PdfChunk) r13)
            r3 = r2[r11]
            int r1 = r1.length()
            int r3 = r3 - r1
            r8.currentChar = r3
