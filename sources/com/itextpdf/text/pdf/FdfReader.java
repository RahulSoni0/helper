...
public class FdfReader extends PdfReader {
    ...
    public void kidNode(PdfDictionary pdfDictionary, String str) {
        ...
        for (int i = 0; i < asArray.size(); i++) {
            ...
            PdfString asString = asDict.getAsString(PdfName.f1362T);
            if (asString != null) {
            ...
            pdfDictionary2.remove(PdfName.f1362T);
    ...
    public void readFields() {
        ...
        if (asDict != null) {
            PdfString asString = asDict.getAsString(PdfName.f1295F);
            if (asString != null) {
    ...
    public byte[] getAttachedFile(String str) throws IOException {
        ...
        return pdfDictionary != null ? getStreamBytes((PRStream) getPdfObject(((PRIndirectReference) ((PdfDictionary) getPdfObject(((PRIndirectReference) pdfDictionary.get(PdfName.f1379V)).getNumber())).getAsDict(PdfName.f1294EF).get(PdfName.f1295F)).getNumber())) : new byte[0];
    }

    public String getFieldValue(String str) {
        PdfObject pdfObject;
        PdfDictionary pdfDictionary = this.fields.get(str);
        if (pdfDictionary == null || (pdfObject = getPdfObject(pdfDictionary.get(PdfName.f1379V))) == null) {
            return null;
        }
        if (pdfObject.isName()) {
