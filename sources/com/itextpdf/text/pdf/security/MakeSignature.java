...
import com.itextpdf.text.p015io.StreamUtil;
...
public class MakeSignature {
    ...
    public static void signDetached(PdfSignatureAppearance pdfSignatureAppearance, ExternalDigest externalDigest, ExternalSignature externalSignature, Certificate[] certificateArr, Collection<CrlClient> collection, OcspClient ocspClient, TSAClient tSAClient, int i, CryptoStandard cryptoStandard, SignaturePolicyIdentifier signaturePolicyIdentifier) throws IOException, DocumentException, GeneralSecurityException {
        ...
        if (signaturePolicyIdentifier2 != null) {
            pdfPKCS7.setSignaturePolicy(signaturePolicyIdentifier2);
        }
        byte[] digest = DigestAlgorithms.digest(pdfSignatureAppearance.getRangeStream(), externalDigest.getMessageDigest(str));
        ...
        pdfPKCS7.setExternalDigest(externalSignature.sign(pdfPKCS7.getAuthenticatedAttributeBytes(digest, bArr, collection2, cryptoStandard2)), bArr2, externalSignature.getEncryptionAlgorithm());
