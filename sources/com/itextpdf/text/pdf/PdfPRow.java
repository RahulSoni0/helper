...
public class PdfPRow implements IAccessibleElement {
    ...
    /* renamed from: id */
    protected AccessibleElementId f1396id;
    ...
    public PdfPRow(PdfPCell[] pdfPCellArr, PdfPRow pdfPRow) {
        ...
        this.adjusted = false;
        this.role = PdfName.f1370TR;
        this.accessibleAttributes = null;
        this.f1396id = new AccessibleElementId();
        this.cells = pdfPCellArr;
        this.widths = new float[pdfPCellArr.length];
        initExtraHeights();
        if (pdfPRow != null) {
            this.f1396id = pdfPRow.f1396id;
                ...
                if (pdfPCell == null) {
                    ...
                    if (image != null) {
                        if (pdfPCell.getRotation() != 0) {
                            ...
                            i4 = i8;
                            double rotation = (double) pdfPCell.getRotation();
                        ...
                        if (pdfPCell.getRotation() == 90 || pdfPCell.getRotation() == 270) {
                            ...
                            try {
                                ...
                                if (f13 > 0.0f) {
                                    ...
                                    if (pdfPCell.getRotation() == 90) {
                                        float top2 = ((pdfPCell.getTop() + f2) - f12) + pdfPCell.getEffectivePaddingBottom();
                            ...
                            float effectivePaddingTop2 = top - ((f12 - pdfPCell.getEffectivePaddingTop()) - pdfPCell.getEffectivePaddingBottom());
                            if (fixedHeight > 0.0f && pdfPCell.getHeight() > f12) {
                                top = (pdfPCell.getTop() + f2) - pdfPCell.getEffectivePaddingTop();
                                effectivePaddingTop2 = pdfPCell.getEffectivePaddingBottom() + ((pdfPCell.getTop() + f2) - f12);
                            }
                            if ((top > effectivePaddingTop2 || columnText4.zeroHeightElement()) && left2 < right) {
                                columnText4.setSimpleColumn(left2, effectivePaddingTop2 - 0.001f, right, top);
        ...
        while (true) {
            ...
            if (pdfPCell == null) {
                ...
                if (image != null) {
                    ...
                    try {
                        int go = duplicate.mo32522go(true);
    ...
    public void setId(AccessibleElementId accessibleElementId) {
        this.f1396id = accessibleElementId;
    }
