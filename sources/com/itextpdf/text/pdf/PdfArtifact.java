...
public class PdfArtifact implements IAccessibleElement {
    ...
    /* renamed from: id */
    protected AccessibleElementId f1251id = new AccessibleElementId();
    ...
    public void setId(AccessibleElementId accessibleElementId) {
        this.f1251id = accessibleElementId;
    }
    ...
    static /* synthetic */ class C18151 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.PdfArtifact.C18151.<clinit>():void");
        }
    }

    public void setType(ArtifactType artifactType) {
        PdfString pdfString;
        int i = C18151.$SwitchMap$com$itextpdf$text$pdf$PdfArtifact$ArtifactType[artifactType.ordinal()];
        if (i == 1) {
