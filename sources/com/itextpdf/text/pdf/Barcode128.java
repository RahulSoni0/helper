...
public class Barcode128 extends Barcode {
    ...
    static {
        ...
        intHashtable.put(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, -1);
    ...
    static /* synthetic */ class C18111 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.Barcode128.C18111.<clinit>():void");
        }
    }
    ...
    public enum Barcode128CodeSet {
        ...
        public char getStartSymbol() {
            int i = C18111.$SwitchMap$com$itextpdf$text$pdf$Barcode128$Barcode128CodeSet[ordinal()];
            if (i != 1) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:73:0x0275, code lost:
        r9 = START_C;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:81:0x02b7, code lost:
        r9 = START_B;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:86:0x02e4, code lost:
        if (r1 == com.itextpdf.text.pdf.Barcode128.Barcode128CodeSet.AUTO) goto L_0x011c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:88:0x02ea, code lost:
        if (r9 != r18.getStartSymbol()) goto L_0x02ee;
     */
    ...
    public static java.lang.String getRawText(java.lang.String r16, boolean r17, com.itextpdf.text.pdf.Barcode128.Barcode128CodeSet r18) {
        ...
        L_0x011c:
            ...
            r12 = 4
            switch(r9) {
                case 103: goto L_0x023e;
                case 104: goto L_0x01b0;
                case 105: goto L_0x0128;
    ...
    public Rectangle getBarcodeSize() {
        ...
        return new Rectangle(Math.max((((float) ((str.length() + 2) * 11)) * this.f1219x) + (this.f1219x * 2.0f), f3), this.barHeight + f);
    }
