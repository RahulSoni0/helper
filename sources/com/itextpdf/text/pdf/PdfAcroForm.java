...
public class PdfAcroForm extends PdfDictionary {
    ...
    public boolean isValid() {
        ...
        if (this.calculationOrder.size() > 0) {
            put(PdfName.f1280CO, this.calculationOrder);
        }
        ...
        put(PdfName.f1283DA, new PdfString("/Helv 0 Tf 0 g "));
    ...
    public PdfFormField addRadioButton(PdfFormField pdfFormField, String str, float f, float f2, float f3, float f4) {
        ...
        if (((PdfName) pdfFormField.get(PdfName.f1379V)).toString().substring(1).equals(str)) {
