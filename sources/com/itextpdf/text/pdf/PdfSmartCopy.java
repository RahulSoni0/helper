    ...
    static class ByteStore {
        ...
        private void serDic(PdfDictionary pdfDictionary, int i, ByteBuffer byteBuffer, HashMap<RefKey, Integer> hashMap) throws IOException {
            ...
            if (i > 0) {
                ...
                for (int i2 = 0; i2 < array.length; i2++) {
                    if (!array[i2].equals(PdfName.f1338P) || (!pdfDictionary.get((PdfName) array[i2]).isIndirect() && !pdfDictionary.get((PdfName) array[i2]).isDictionary())) {
        ...
        public boolean equals(Object obj) {
            if ((obj instanceof ByteStore) && hashCode() == obj.hashCode()) {
                return Arrays.equals(this.f1400b, ((ByteStore) obj).f1400b);
            }
            return false;
        }
