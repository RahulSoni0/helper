...
public class DocumentFont extends BaseFont {
        ...
        if (PdfName.TYPE1.equals(asName2) || PdfName.TRUETYPE.equals(asName2)) {
            ...
            if (asName3 != null) {
                ...
                if (PdfName.TYPE0.equals(asName2)) {
                    ...
                    PdfNumber pdfNumber = (PdfNumber) PdfReader.getPdfObjectRelease(pdfDictionary.get(PdfName.f1292DW));
                    if (pdfNumber != null) {
                        this.defaultWidth = pdfNumber.intValue();
                    }
                    this.hMetrics = readWidths((PdfArray) PdfReader.getPdfObjectRelease(pdfDictionary.get(PdfName.f1383W)));
    ...
    private void processType0(PdfDictionary pdfDictionary) {
        try {
            ...
            PdfNumber pdfNumber = (PdfNumber) PdfReader.getPdfObjectRelease(pdfDictionary2.get(PdfName.f1292DW));
            int i = 1000;
            if (pdfNumber != null) {
                i = pdfNumber.intValue();
            }
            IntHashtable readWidths = readWidths((PdfArray) PdfReader.getPdfObjectRelease(pdfDictionary2.get(PdfName.f1383W)));
