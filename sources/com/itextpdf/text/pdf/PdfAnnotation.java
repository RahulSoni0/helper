...
public class PdfAnnotation extends PdfDictionary implements IAccessibleElement {
    public static final PdfName AA_BLUR = PdfName.f1269BL;
    public static final PdfName AA_DOWN = PdfName.f1282D;
    public static final PdfName AA_ENTER = PdfName.f1293E;
    public static final PdfName AA_EXIT = PdfName.f1389X;
    public static final PdfName AA_FOCUS = PdfName.f1301FO;
    public static final PdfName AA_JS_CHANGE = PdfName.f1379V;
    public static final PdfName AA_JS_FORMAT = PdfName.f1295F;
    public static final PdfName AA_JS_KEY = PdfName.f1320K;
    public static final PdfName AA_JS_OTHER_CHANGE = PdfName.f1272C;
    public static final PdfName AA_UP = PdfName.f1375U;
    public static final PdfName APPEARANCE_DOWN = PdfName.f1282D;
    public static final PdfName APPEARANCE_NORMAL = PdfName.f1325N;
    public static final PdfName APPEARANCE_ROLLOVER = PdfName.f1347R;
    ...
    public static final PdfName HIGHLIGHT_INVERT = PdfName.f1313I;
    public static final PdfName HIGHLIGHT_NONE = PdfName.f1325N;
    public static final PdfName HIGHLIGHT_OUTLINE = PdfName.f1332O;
    public static final PdfName HIGHLIGHT_PUSH = PdfName.f1338P;
    public static final PdfName HIGHLIGHT_TOGGLE = PdfName.f1362T;
    ...
    /* renamed from: id */
    private AccessibleElementId f1250id = null;
    ...
    public PdfAnnotation(PdfWriter pdfWriter, float f, float f2, float f3, float f4, PdfAction pdfAction) {
        ...
        put(PdfName.RECT, new PdfRectangle(f, f2, f3, f4));
        put(PdfName.f1260A, pdfAction);
        put(PdfName.BORDER, new PdfBorderArray(0.0f, 0.0f, 0.0f));
        put(PdfName.f1272C, new PdfColor(0, 0, 255));
    }
    ...
    public static PdfAnnotation createScreen(PdfWriter pdfWriter, Rectangle rectangle, String str, PdfFileSpecification pdfFileSpecification, String str2, boolean z) throws IOException {
        ...
        createAnnotation.put(PdfName.f1295F, new PdfNumber(4));
        ...
        if (z) {
            ...
            createAnnotation.put(PdfName.f1261AA, pdfDictionary);
        }
        createAnnotation.put(PdfName.f1260A, indirectReference);
    ...
    public static PdfAnnotation createText(PdfWriter pdfWriter, Rectangle rectangle, String str, String str2, boolean z, String str3) {
        ...
        if (str != null) {
            createAnnotation.put(PdfName.f1362T, new PdfString(str, PdfObject.TEXT_UNICODE));
        }
        if (str2 != null) {
    ...
    protected static PdfAnnotation createLink(PdfWriter pdfWriter, Rectangle rectangle, PdfName pdfName) {
        ...
        if (!pdfName.equals(HIGHLIGHT_INVERT)) {
            createAnnotation.put(PdfName.f1304H, pdfName);
        }
        return createAnnotation;
    }
    ...
    public static PdfAnnotation createLink(PdfWriter pdfWriter, Rectangle rectangle, PdfName pdfName, PdfAction pdfAction) {
        ...
        createLink.putEx(PdfName.f1260A, pdfAction);
        return createLink;
    }
    ...
    public static PdfAnnotation createLine(PdfWriter pdfWriter, Rectangle rectangle, String str, float f, float f2, float f3, float f4) {
        ...
        createAnnotation.put(PdfName.f1321L, pdfArray);
        return createAnnotation;
    }
    ...
    public static PdfAnnotation createFileAttachment(PdfWriter pdfWriter, Rectangle rectangle, String str, PdfFileSpecification pdfFileSpecification) throws IOException {
        ...
        createAnnotation.put(PdfName.f1302FS, pdfFileSpecification.getReference());
        return createAnnotation;
    }
    ...
    public void setDefaultAppearanceString(PdfContentByte pdfContentByte) {
        ...
        put(PdfName.f1283DA, new PdfString(byteArray));
    }

    public void setFlags(int i) {
        if (i == 0) {
            remove(PdfName.f1295F);
        } else {
            put(PdfName.f1295F, new PdfNumber(i));
        }
    }
    ...
    public void setBorderStyle(PdfBorderDictionary pdfBorderDictionary) {
        put(PdfName.f1271BS, pdfBorderDictionary);
    }

    public void setHighlighting(PdfName pdfName) {
        if (pdfName.equals(HIGHLIGHT_INVERT)) {
            remove(PdfName.f1304H);
        } else {
    ...
    public void setAppearance(PdfName pdfName, PdfTemplate pdfTemplate) {
        PdfDictionary pdfDictionary = (PdfDictionary) get(PdfName.f1264AP);
        if (pdfDictionary == null) {
            pdfDictionary = new PdfDictionary();
        }
        pdfDictionary.put(pdfName, pdfTemplate.getIndirectReference());
        put(PdfName.f1264AP, pdfDictionary);
        if (this.form) {
    ...
    public void setAppearance(PdfName pdfName, String str, PdfTemplate pdfTemplate) {
        ...
        PdfDictionary pdfDictionary2 = (PdfDictionary) get(PdfName.f1264AP);
        ...
        put(PdfName.f1264AP, pdfDictionary2);
        if (this.form) {
            if (this.templates == null) {
                this.templates = new HashSet<>();
            }
    ...
    public void setAppearanceState(String str) {
        if (str == null) {
            remove(PdfName.f1265AS);
        } else {
            put(PdfName.f1265AS, new PdfName(str));
        }
    }

    public void setColor(BaseColor baseColor) {
        put(PdfName.f1272C, new PdfColor(baseColor));
    }

    public void setTitle(String str) {
        if (str == null) {
            remove(PdfName.f1362T);
        } else {
    ...
    public void setAdditionalActions(PdfName pdfName, PdfAction pdfAction) {
        PdfDictionary pdfDictionary;
        PdfObject pdfObject = get(PdfName.f1261AA);
        if (pdfObject == null || !pdfObject.isDictionary()) {
            pdfDictionary = new PdfDictionary();
        } else {
            pdfDictionary = (PdfDictionary) pdfObject;
        ...
        put(PdfName.f1261AA, pdfDictionary);
    }
    ...
    public void setPage(int i) {
        put(PdfName.f1338P, this.writer.getPageReference(i));
    }

    public void setPage() {
        put(PdfName.f1338P, this.writer.getCurrentPage());
    }
    ...
    public PdfDictionary getMK() {
        PdfDictionary pdfDictionary = (PdfDictionary) get(PdfName.f1324MK);
        if (pdfDictionary != null) {
            return pdfDictionary;
        }
        PdfDictionary pdfDictionary2 = new PdfDictionary();
        put(PdfName.f1324MK, pdfDictionary2);
        return pdfDictionary2;
    }

    public void setMKRotation(int i) {
        getMK().put(PdfName.f1347R, new PdfNumber(i));
    }
    ...
    public void setMKBorderColor(BaseColor baseColor) {
        if (baseColor == null) {
            getMK().remove(PdfName.f1267BC);
        } else {
            getMK().put(PdfName.f1267BC, getMKColor(baseColor));
        }
    }

    public void setMKBackgroundColor(BaseColor baseColor) {
        if (baseColor == null) {
            getMK().remove(PdfName.f1268BG);
        } else {
            getMK().put(PdfName.f1268BG, getMKColor(baseColor));
        }
    }

    public void setMKNormalCaption(String str) {
        getMK().put(PdfName.f1275CA, new PdfString(str, PdfObject.TEXT_UNICODE));
    }

    public void setMKRolloverCaption(String str) {
        getMK().put(PdfName.f1349RC, new PdfString(str, PdfObject.TEXT_UNICODE));
    }

    public void setMKAlternateCaption(String str) {
        getMK().put(PdfName.f1262AC, new PdfString(str, PdfObject.TEXT_UNICODE));
    }

    public void setMKNormalIcon(PdfTemplate pdfTemplate) {
        getMK().put(PdfName.f1313I, pdfTemplate.getIndirectReference());
    }

    public void setMKRolloverIcon(PdfTemplate pdfTemplate) {
        getMK().put(PdfName.f1351RI, pdfTemplate.getIndirectReference());
    }

    public void setMKAlternateIcon(PdfTemplate pdfTemplate) {
        getMK().put(PdfName.f1318IX, pdfTemplate.getIndirectReference());
    }

    public void setMKIconFit(PdfName pdfName, PdfName pdfName2, float f, float f2, boolean z) {
        PdfDictionary pdfDictionary = new PdfDictionary();
        if (!pdfName.equals(PdfName.f1260A)) {
            pdfDictionary.put(PdfName.f1361SW, pdfName);
        }
        if (!pdfName2.equals(PdfName.f1338P)) {
            pdfDictionary.put(PdfName.f1357S, pdfName2);
        }
        if (!(f == 0.5f && f2 == 0.5f)) {
            PdfArray pdfArray = new PdfArray((PdfObject) new PdfNumber(f));
            pdfArray.add((PdfObject) new PdfNumber(f2));
            pdfDictionary.put(PdfName.f1260A, pdfArray);
        }
        if (z) {
            pdfDictionary.put(PdfName.f1296FB, PdfBoolean.PDFTRUE);
        }
        getMK().put(PdfName.f1316IF, pdfDictionary);
    }

    public void setMKTextPosition(int i) {
        getMK().put(PdfName.f1369TP, new PdfNumber(i));
    }

    public void setLayer(PdfOCG pdfOCG) {
        put(PdfName.f1333OC, pdfOCG.getRef());
    }

    public void setName(String str) {
        put(PdfName.f1331NM, new PdfString(str));
    }
    ...
    public AccessibleElementId getId() {
        if (this.f1250id == null) {
            this.f1250id = new AccessibleElementId();
        }
        return this.f1250id;
    }

    public void setId(AccessibleElementId accessibleElementId) {
        this.f1250id = accessibleElementId;
    }
}
