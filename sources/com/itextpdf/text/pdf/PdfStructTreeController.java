...
public class PdfStructTreeController {
    ...
    private returnType copyPageMarks(PdfDictionary pdfDictionary, PdfNumber pdfNumber, int i) throws BadPdfFormatException, IOException {
        ...
        if (pdfArray == null) {
            ...
            while (true) {
                int i3 = size + i2;
                int i4 = C18201.f1401x27ed7df1[copyPageMarks((PdfDictionary) getDirectObject(pdfArray2.getPdfObject(i3)), pdfNumber, i).ordinal()];
                int i5 = 1;
                if (i4 == 1) {
    ...
    static /* synthetic */ class C18201 {
        ...
        static final /* synthetic */ int[] f1401x27ed7df1;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f1401x27ed7df1     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f1401x27ed7df1     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.PdfStructTreeController.C18201.<clinit>():void");
        }
    }
    ...
    public void attachStructTreeRootKids(PdfObject pdfObject) throws IOException, BadPdfFormatException {
        PdfObject pdfObject2 = this.structTreeRoot.get(PdfName.f1320K);
    ...
    static PdfDictionary getKDict(PdfDictionary pdfDictionary) {
        PdfDictionary asDict = pdfDictionary.getAsDict(PdfName.f1320K);
        if (asDict == null) {
            PdfArray asArray = pdfDictionary.getAsArray(PdfName.f1320K);
            if (asArray == null) {
                return null;
            }
    ...
    public void addClass(PdfObject pdfObject) throws BadPdfFormatException {
        ...
        if (directObject.isDictionary()) {
            PdfObject pdfObject2 = ((PdfDictionary) directObject).get(PdfName.f1272C);
            if (pdfObject2 != null) {
                if (pdfObject2.isArray()) {
    ...
    public void addKid(PdfDictionary pdfDictionary, PdfObject pdfObject) {
        PdfArray pdfArray;
        PdfObject pdfObject2 = pdfDictionary.get(PdfName.f1320K);
