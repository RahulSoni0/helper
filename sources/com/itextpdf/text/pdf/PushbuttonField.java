...
public class PushbuttonField extends BaseField {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:196:0x049a  */
    ...
    public com.itextpdf.text.pdf.PdfAppearance getAppearance() throws java.io.IOException, com.itextpdf.text.DocumentException {
        /*
            r32 = this;
            r0 = r32
            com.itextpdf.text.pdf.PdfAppearance r10 = r32.getBorderAppearance()
        ...
        L_0x002e:
            ...
            return r10
        L_0x0040:
            com.itextpdf.text.pdf.BaseFont r12 = r32.getRealFont()
        ...
        L_0x03f1:
            ...
            r10.clip()
            r10.newPath()
            com.itextpdf.text.pdf.PdfTemplate r3 = r0.f1405tp
    ...
    public PdfFormField getField() throws IOException, DocumentException {
        ...
        PdfTemplate pdfTemplate = this.f1405tp;
        if (pdfTemplate != null) {
            createPushButton.setMKNormalIcon(pdfTemplate);
        }
        createPushButton.setMKTextPosition(this.layout - 1);
        PdfName pdfName = PdfName.f1260A;
        int i2 = this.scaleIcon;
        if (i2 == 3) {
            pdfName = PdfName.f1266B;
        } else if (i2 == 4) {
            pdfName = PdfName.f1357S;
        } else if (i2 == 2) {
            pdfName = PdfName.f1325N;
        }
        createPushButton.setMKIconFit(pdfName, this.proportionalIcon ? PdfName.f1338P : PdfName.f1260A, this.iconHorizontalAdjustment, this.iconVerticalAdjustment, this.iconFitToBounds);
