...
public class TextMarginFinder implements RenderListener {
    ...
    public float getLlx() {
        return this.textRectangle.f1125x;
    }

    public float getLly() {
        return this.textRectangle.f1126y;
    }

    public float getUrx() {
        return this.textRectangle.f1125x + this.textRectangle.width;
    }

    public float getUry() {
        return this.textRectangle.f1126y + this.textRectangle.height;
    }
