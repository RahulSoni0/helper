...
public class ImageRenderInfo {
    ...
    /* renamed from: gs */
    private final GraphicsState f1458gs;
    ...
    public Vector getStartPoint() {
        return new Vector(0.0f, 0.0f, 1.0f).cross(this.f1458gs.ctm);
    }

    public Matrix getImageCTM() {
        return this.f1458gs.ctm;
    }

    public float getArea() {
        return this.f1458gs.ctm.getDeterminant();
    }
