...
public class PdfContentStreamProcessor {
    ...
    private void populateOperators() {
        ...
        registerContentOperator(RequestConfiguration.MAX_AD_CONTENT_RATING_G, new SetGrayStroke());
        ...
        registerContentOperator("Do", new C1825Do());
        ...
        if (this.renderListener instanceof ExtRenderListener) {
            ...
            registerContentOperator(HtmlTags.f1205S, new PaintPath(1, -1, true));
            ...
            registerContentOperator(HtmlTags.f1191B, new PaintPath(3, 1, true));
    ...
    /* renamed from: gs */
    public GraphicsState mo35234gs() {
    ...
    public void displayPdfString(PdfString pdfString) {
        TextRenderInfo textRenderInfo = new TextRenderInfo(pdfString, mo35234gs(), this.textMatrix, this.markedContentStack);
    ...
    public void paintPath(int i, int i2, boolean z) {
        ...
        ((ExtRenderListener) this.renderListener).renderPath(new PathPaintingRenderInfo(i, i2, mo35234gs()));
    }

    /* access modifiers changed from: private */
    public void modifyPath(int i, List<Float> list) {
        ((ExtRenderListener) this.renderListener).modifyPath(new PathConstructionRenderInfo(i, list, mo35234gs().getCtm()));
    }
    ...
    public void applyTextAdjust(float f) {
        this.textMatrix = new Matrix(((-f) / 1000.0f) * mo35234gs().fontSize * mo35234gs().horizontalScaling, 0.0f).multiply(this.textMatrix);
    }
    ...
    public void handleInlineImage(InlineImageInfo inlineImageInfo, PdfDictionary pdfDictionary) {
        this.renderListener.renderImage(ImageRenderInfo.createForEmbeddedImage(mo35234gs(), inlineImageInfo, pdfDictionary));
    }
    ...
    private static class TextMoveNextLine implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            ...
            arrayList2.add(1, new PdfNumber(-pdfContentStreamProcessor.mo35234gs().leading));
    ...
    private static class SetTextFont implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            ...
            pdfContentStreamProcessor.mo35234gs().font = cMapAwareDocumentFont;
            pdfContentStreamProcessor.mo35234gs().fontSize = floatValue;
        }
    }
    ...
    private static class SetTextRenderMode implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().renderMode = ((PdfNumber) arrayList.get(0)).intValue();
        }
    }
    ...
    private static class SetTextRise implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().rise = ((PdfNumber) arrayList.get(0)).floatValue();
        }
    }
    ...
    private static class SetTextLeading implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().leading = ((PdfNumber) arrayList.get(0)).floatValue();
        }
    }
    ...
    private static class SetTextHorizontalScaling implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().horizontalScaling = ((PdfNumber) arrayList.get(0)).floatValue() / 100.0f;
        }
    }
    ...
    private static class SetTextCharacterSpacing implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().characterSpacing = ((PdfNumber) arrayList.get(0)).floatValue();
        }
    }
    ...
    private static class SetTextWordSpacing implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().wordSpacing = ((PdfNumber) arrayList.get(0)).floatValue();
        }
    }
            ...
            if (asDict != null) {
                ...
                if (asDict2 != null) {
                    ...
                    if (asArray != null) {
                        ...
                        pdfContentStreamProcessor.mo35234gs().font = access$5300;
                        pdfContentStreamProcessor.mo35234gs().fontSize = floatValue;
                        return;
                    }
                    return;
    ...
    private static class SetGrayFill implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().fillColor = PdfContentStreamProcessor.getColor(1, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetGrayStroke implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().strokeColor = PdfContentStreamProcessor.getColor(1, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetRGBFill implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().fillColor = PdfContentStreamProcessor.getColor(3, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetRGBStroke implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().strokeColor = PdfContentStreamProcessor.getColor(3, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetCMYKFill implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().fillColor = PdfContentStreamProcessor.getColor(4, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetCMYKStroke implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().strokeColor = PdfContentStreamProcessor.getColor(4, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetColorSpaceFill implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().colorSpaceFill = (PdfName) arrayList.get(0);
        }
    }
    ...
    private static class SetColorSpaceStroke implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().colorSpaceStroke = (PdfName) arrayList.get(0);
        }
    }
    ...
    private static class SetColorFill implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().fillColor = PdfContentStreamProcessor.getColor(pdfContentStreamProcessor.mo35234gs().colorSpaceFill, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class SetColorStroke implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().strokeColor = PdfContentStreamProcessor.getColor(pdfContentStreamProcessor.mo35234gs().colorSpaceStroke, (List<PdfObject>) arrayList);
        }
    }
    ...
    private static class C1825Do implements ContentOperator {
        private C1825Do() {
        }
    ...
    private static class SetLineWidth implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().setLineWidth(((PdfNumber) arrayList.get(0)).floatValue());
        }
    }
    ...
    private class SetLineCap implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().setLineCapStyle(((PdfNumber) arrayList.get(0)).intValue());
        }
    }
    ...
    private class SetLineJoin implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().setLineJoinStyle(((PdfNumber) arrayList.get(0)).intValue());
        }
    }
    ...
    private class SetMiterLimit implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().setMiterLimit(((PdfNumber) arrayList.get(0)).floatValue());
        }
    }
    ...
    private class SetLineDashPattern implements ContentOperator {
        ...
        public void invoke(PdfContentStreamProcessor pdfContentStreamProcessor, PdfLiteral pdfLiteral, ArrayList<PdfObject> arrayList) {
            pdfContentStreamProcessor.mo35234gs().setLineDashPattern(new LineDashPattern((PdfArray) arrayList.get(0), ((PdfNumber) arrayList.get(1)).floatValue()));
        }
    }
        ...
        public void handleXObject(PdfContentStreamProcessor pdfContentStreamProcessor, PdfStream pdfStream, PdfIndirectReference pdfIndirectReference) {
            ...
            try {
                ...
                if (asArray != null) {
                    ...
                    pdfContentStreamProcessor.mo35234gs().ctm = matrix.multiply(pdfContentStreamProcessor.mo35234gs().ctm);
                }
    ...
    private static class ImageXObjectDoHandler implements XObjectDoHandler {
        ...
        public void handleXObject(PdfContentStreamProcessor pdfContentStreamProcessor, PdfStream pdfStream, PdfIndirectReference pdfIndirectReference) {
            pdfContentStreamProcessor.renderListener.renderImage(ImageRenderInfo.createForXObject(pdfContentStreamProcessor.mo35234gs(), pdfIndirectReference, pdfContentStreamProcessor.resources.getAsDict(PdfName.COLORSPACE)));
        }
    }
