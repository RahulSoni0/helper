...
public class TaggedPdfReaderTool {
    ...
    public void convertToXml(PdfReader pdfReader, OutputStream outputStream, String str) throws IOException {
        ...
        if (asDict != null) {
            inspectChild(asDict.getDirectObject(PdfName.f1320K));
            this.out.flush();
            this.out.close();
            return;
        }
    ...
    public void inspectChildDictionary(PdfDictionary pdfDictionary, boolean z) throws IOException {
        ...
        if (pdfDictionary != null) {
            ...
            if (asName != null) {
                ...
                PdfDictionary asDict2 = pdfDictionary.getAsDict(PdfName.f1341PG);
                if (asDict2 != null) {
                    parseTag(decodeName, pdfDictionary.getDirectObject(PdfName.f1320K), asDict2);
                }
                inspectChild(pdfDictionary.getDirectObject(PdfName.f1320K));
                this.out.print("</");
                this.out.print(fixTagName);
                this.out.println(">");
                return;
    ...
    public void parseTag(String str, PdfObject pdfObject, PdfDictionary pdfDictionary) throws IOException {
        if (pdfObject instanceof PdfNumber) {
            ...
            parseTag(str, pdfDictionary2.getDirectObject(PdfName.MCID), pdfDictionary2.getAsDict(PdfName.f1341PG));
        }
    }
}
