...
public class Paths extends ArrayList<Path> {
    ...
    static /* synthetic */ class C18311 {
        ...
        static final /* synthetic */ int[] f1473x75adf5da;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f1473x75adf5da     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.parser.clipper.Paths.C18311.<clinit>():void");
        }
    }

    public void addPolyNode(PolyNode polyNode, PolyNode.NodeType nodeType) {
        int i = C18311.f1473x75adf5da[nodeType.ordinal()];
        boolean z = true;
        if (i != 1) {
            if (i == 2) {
