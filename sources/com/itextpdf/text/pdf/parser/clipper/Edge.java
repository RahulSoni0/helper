...
class Edge {
    ...
    static long topX(Edge edge, long j) {
        ...
        double y = (double) (j - edge.getBot().getY());
        Double.isNaN(y);
    ...
    public boolean isContributing(Clipper.PolyFillType polyFillType, Clipper.PolyFillType polyFillType2, Clipper.ClipType clipType) {
        ...
        int i = C18301.f1470xe9aea078[polyFillType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (this.windCnt != -1) {
        ...
        int i2 = C18301.$SwitchMap$com$itextpdf$text$pdf$parser$clipper$Clipper$ClipType[clipType.ordinal()];
        if (i2 == 1) {
            int i3 = C18301.f1470xe9aea078[polyFillType2.ordinal()];
            if (i3 == 1 || i3 == 2) {
                if (this.windCnt2 != 0) {
                    return true;
                }
            ...
            int i4 = C18301.f1470xe9aea078[polyFillType2.ordinal()];
            if (i4 == 1 || i4 == 2) {
                if (this.windCnt2 == 0) {
                    return true;
                }
            ...
            int i5 = C18301.f1470xe9aea078[polyFillType2.ordinal()];
            if (i5 == 1 || i5 == 2) {
                if (this.windCnt2 == 0) {
                    return true;
                }
            ...
            int i6 = C18301.f1470xe9aea078[polyFillType2.ordinal()];
            if (i6 == 1 || i6 == 2) {
                if (this.windCnt2 == 0) {
                    return true;
                }
            ...
            int i7 = C18301.f1470xe9aea078[polyFillType2.ordinal()];
            if (i7 == 1 || i7 == 2) {
                if (this.windCnt2 != 0) {
                    return true;
                }
    ...
    static /* synthetic */ class C18301 {
        ...
        static final /* synthetic */ int[] f1470xe9aea078;
        ...
        static {
            ...
            L_0x0044:
                int[] r1 = f1470xe9aea078     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                int[] r0 = f1470xe9aea078     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.parser.clipper.Edge.C18301.<clinit>():void");
        }
    }
