...
public class DefaultClipper extends ClipperBase {
    ...
    private class IntersectNode {
        ...
        /* renamed from: pt */
        private Point.LongPoint f1469pt;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:62:0x00ef A[LOOP:0: B:1:0x001b->B:62:0x00ef, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x00ee A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int isPointInPolygon(com.itextpdf.text.pdf.parser.clipper.Point.LongPoint r22, com.itextpdf.text.pdf.parser.clipper.Path.OutPt r23) {
        /*
            long r0 = r22.getX()
            long r2 = r22.getY()
            com.itextpdf.text.pdf.parser.clipper.Point$LongPoint r4 = r23.getPt()
            long r4 = r4.getX()
            com.itextpdf.text.pdf.parser.clipper.Point$LongPoint r6 = r23.getPt()
            long r6 = r6.getY()
            r9 = r23
            r10 = 0
        L_0x001b:
        ...
        if (z) {
            for (int i = 0; i < size2; i++) {
                ...
                while (it.hasNext()) {
                    ...
                    Point.LongPoint longPoint3 = new Point.LongPoint(longPoint.getX() + ((Point.LongPoint) path3.get(i)).getX(), longPoint.getY() + ((Point.LongPoint) path3.get(i)).getY(), 0);
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                while (it2.hasNext()) {
                    ...
                    long x = ((Point.LongPoint) path3.get(i2)).getX() - longPoint4.getX();
                    Point.LongPoint longPoint5 = r9;
                    Point.LongPoint longPoint6 = new Point.LongPoint(x, ((Point.LongPoint) path3.get(i2)).getY() - longPoint4.getY(), 0);
    ...
    private void insertScanbeam(long j) {
        ...
        if (scanbeam2 == null) {
            ...
            scanbeam3.next = null;
            this.scanbeam.f1467y = j;
        } else if (j > scanbeam2.f1467y) {
            ...
            while (scanbeam5.next != null && j <= scanbeam5.next.f1467y) {
                scanbeam5 = scanbeam5.next;
            }
            if (j != scanbeam5.f1467y) {
    ...
    private void InsertMaxima(long j) {
        ...
        } else if (j < maxima3.f1471X) {
            maxima2.Next = this.maxima;
            maxima2.Prev = null;
            this.maxima = maxima2;
        } else {
            Path.Maxima maxima4 = this.maxima;
            while (maxima4.Next != null && j >= maxima4.Next.f1471X) {
    ...
    private void fixupOutPolyline(Path.OutRec outRec) {
        ...
        while (outPt != outPt2) {
            outPt = outPt.next;
            if (outPt.f1472pt.equals(outPt.prev.f1472pt)) {
                if (outPt == outPt2) {
                    outPt2 = outPt.prev;
                }
                Path.OutPt outPt3 = outPt.prev;
    ...
    private void insertLocalMinimaIntoAEL(long j) {
        ...
        while (this.currentLM != null && this.currentLM.f1466y == j) {
    ...
    private void intersectEdges(Edge edge, Edge edge2, Point.LongPoint longPoint) {
        ...
        if (edge.windDelta != 0 && edge2.windDelta != 0) {
            ...
            int i7 = C18292.f1468xe9aea078[polyFillType2.ordinal()];
            if (i7 == 1) {
                i = edge.windCnt;
            } else if (i7 != 2) {
            ...
            int i8 = C18292.f1468xe9aea078[polyFillType4.ordinal()];
            if (i8 == 1) {
                i2 = edge2.windCnt;
            } else if (i8 != 2) {
            ...
            if (!z || !z2) {
                if (z) {
                    ...
                    if (i2 == 0 || i2 == 1) {
                        int i9 = C18292.f1468xe9aea078[polyFillType.ordinal()];
                        if (i9 == 1) {
                            i3 = edge.windCnt2;
                        } else if (i9 != 2) {
                        ...
                        int i10 = C18292.f1468xe9aea078[polyFillType3.ordinal()];
                        if (i10 == 1) {
                            i4 = edge2.windCnt2;
                        } else if (i10 != 2) {
                        ...
                        if (edge.polyTyp != edge2.polyTyp) {
                            ...
                            int i11 = C18292.$SwitchMap$com$itextpdf$text$pdf$parser$clipper$Clipper$ClipType[this.clipType.ordinal()];
                            if (i11 != 1) {
                                if (i11 != 2) {
                                    if (i11 != 3) {
                                        if (i11 == 4) {
    ...
    static /* synthetic */ class C18292 {
        ...
        static final /* synthetic */ int[] f1468xe9aea078;
        ...
        static {
            ...
            L_0x0044:
                int[] r1 = f1468xe9aea078     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.parser.clipper.DefaultClipper.C18292.<clinit>():void");
        }
    }
    ...
    private void intersectPoint(Edge edge, Edge edge2, Point.LongPoint[] longPointArr) {
        ...
        if (edge.getDelta().getX() == 0) {
            ...
            if (edge2.isHorizontal()) {
                ...
                Double.isNaN(y);
                double d2 = y - (x / d);
                double x2 = (double) longPoint.getX();
                double d3 = edge2.deltaX;
                Double.isNaN(x2);
                longPoint.setY(Long.valueOf(Math.round((x2 / d3) + d2)));
            }
            ...
            if (edge.isHorizontal()) {
                ...
                double y2 = (double) edge.getBot().getY();
                double x3 = (double) edge.getBot().getX();
                double d4 = edge.deltaX;
                Double.isNaN(x3);
                Double.isNaN(y2);
                double d5 = y2 - (x3 / d4);
                double x4 = (double) longPoint.getX();
                double d6 = edge.deltaX;
                Double.isNaN(x4);
                longPoint.setY(Long.valueOf(Math.round((x4 / d6) + d5)));
            }
        } else {
            double x5 = (double) edge.getBot().getX();
            double y3 = (double) edge.getBot().getY();
            double d7 = edge.deltaX;
            Double.isNaN(y3);
            Double.isNaN(x5);
            double d8 = x5 - (y3 * d7);
            double x6 = (double) edge2.getBot().getX();
            double y4 = (double) edge2.getBot().getY();
            double d9 = edge2.deltaX;
            Double.isNaN(y4);
            Double.isNaN(x6);
            double d10 = x6 - (y4 * d9);
            double d11 = (d10 - d8) / (edge.deltaX - edge2.deltaX);
            longPoint.setY(Long.valueOf(Math.round(d11)));
            if (Math.abs(edge.deltaX) < Math.abs(edge2.deltaX)) {
                longPoint.setX(Long.valueOf(Math.round((edge.deltaX * d11) + d8)));
            } else {
                longPoint.setX(Long.valueOf(Math.round((edge2.deltaX * d11) + d10)));
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0078, code lost:
        if (r1.f1471X >= r7.getBot().getX()) goto L_0x00a0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x009e, code lost:
        if (r1.f1471X <= r7.getTop().getX()) goto L_0x00a0;
     */
    ...
    public void reset() {
        ...
        for (ClipperBase.LocalMinima localMinima = this.minimaList; localMinima != null; localMinima = localMinima.next) {
            insertScanbeam(localMinima.f1466y);
        }
    }
