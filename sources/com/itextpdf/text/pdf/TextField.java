...
public class TextField extends BaseField {
            ...
            if (f4 == 0.0f) {
                ...
                if (f4 > 4.0f) {
                    ...
                    while (f4 > 4.0f) {
                        ...
                        if ((columnText.mo32522go(true) & 2) == 0) {
                            break;
                        }
                        f4 -= max2;
                    }
    ...
    public PdfFormField getChoiceField(boolean z) throws IOException, DocumentException {
        ...
        if (this.fieldName != null) {
            ...
            if (strArr2.length > 0) {
                if (strArr != null) {
                    ...
                    writeMultipleValues(pdfFormField, (String[][]) null);
                }
            }
            if ((this.options & 1) != 0) {
        ...
        if (z) {
            ...
            if (this.topFirst > 0) {
                pdfFormField.put(PdfName.f1366TI, new PdfNumber(this.topFirst));
            }
        } else {
    ...
    private void writeMultipleValues(PdfFormField pdfFormField, String[][] strArr) {
        ...
        pdfFormField.put(PdfName.f1379V, pdfArray2);
        pdfFormField.put(PdfName.f1313I, pdfArray);
    }
