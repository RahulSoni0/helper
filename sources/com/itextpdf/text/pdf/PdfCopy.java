...
public class PdfCopy extends PdfWriter {
    ...
    static {
        ...
        hashSet.add(PdfName.f1331NM);
        hashSet.add(PdfName.f1323M);
        hashSet.add(PdfName.f1295F);
        hashSet.add(PdfName.f1271BS);
        hashSet.add(PdfName.BORDER);
        hashSet.add(PdfName.f1264AP);
        hashSet.add(PdfName.f1265AS);
        hashSet.add(PdfName.f1272C);
        hashSet.add(PdfName.f1260A);
        hashSet.add(PdfName.STRUCTPARENT);
        hashSet.add(PdfName.f1333OC);
        hashSet.add(PdfName.f1304H);
        hashSet.add(PdfName.f1324MK);
        hashSet.add(PdfName.f1283DA);
        hashSet.add(PdfName.f1346Q);
        hashSet.add(PdfName.f1338P);
        hashSet.add(PdfName.TYPE);
        hashSet.add(pdfName);
        hashSet2.add(PdfName.f1261AA);
        hashSet2.add(PdfName.f1303FT);
        hashSet2.add(PdfName.f1372TU);
        hashSet2.add(PdfName.f1368TM);
        hashSet2.add(PdfName.f1298FF);
        hashSet2.add(PdfName.f1379V);
        hashSet2.add(PdfName.f1291DV);
        hashSet2.add(PdfName.f1290DS);
        hashSet2.add(PdfName.f1356RV);
        hashSet2.add(PdfName.OPT);
        hashSet2.add(PdfName.MAXLEN);
        hashSet2.add(PdfName.f1366TI);
        hashSet2.add(PdfName.f1313I);
        hashSet2.add(PdfName.LOCK);
        hashSet2.add(PdfName.f1360SV);
    }
    ...
    public void fixStructureTreeRoot(HashSet<RefKey> hashSet, HashSet<PdfName> hashSet2) {
        ...
        PdfArray asArray = this.structureTreeRoot.getAsArray(PdfName.f1320K);
        if (asArray != null) {
            int i = 0;
    ...
    public PdfIndirectReference copyIndirect(PRIndirectReference pRIndirectReference, boolean z, boolean z2) throws IOException, BadPdfFormatException {
        ...
        if (z && z2 && (pdfObjectRelease2 instanceof PdfDictionary) && ((PdfDictionary) pdfObjectRelease2).contains(PdfName.f1341PG)) {
            return null;
        }
    ...
    public PdfDictionary copyDictionary(PdfDictionary pdfDictionary, boolean z, boolean z2) throws IOException, BadPdfFormatException {
        ...
        if (z) {
            if (!z2 || !pdfDictionary.contains(PdfName.f1341PG)) {
                this.structTreeController.addRole(pdfDictionary.getAsName(PdfName.f1357S));
        ...
        for (PdfName next : pdfDictionary.getKeys()) {
            ...
            if (pdfStructTreeController2 == null || pdfStructTreeController2.reader == null || (!next.equals(PdfName.STRUCTPARENTS) && !next.equals(PdfName.STRUCTPARENT))) {
                ...
                } else if (!next.equals(PdfName.f1266B) && !next.equals(PdfName.PARENT)) {
    ...
    public void fixTaggedStructure() throws IOException {
        ...
        while (true) {
            ...
            if (pdfIndirectReference4 != null) {
                ...
                if (pdfObject2.isDictionary()) {
                    ...
                    if (!this.pageReferences.contains(pdfDictionary.get(PdfName.f1341PG)) && ((kDict = PdfStructTreeController.getKDict(pdfDictionary)) == null || !this.pageReferences.contains(kDict.get(PdfName.f1341PG)))) {
                        z = false;
                    } else {
                        z = true;
                    }
                    ...
                    for (int i3 = 0; i3 < pdfArray.size(); i3++) {
                        ...
                        if (!pdfIndirectReference6.equals(pdfIndirectReference3)) {
                            ...
                            if (pdfIndirectObject.object.isDictionary()) {
                                ...
                                PdfIndirectReference pdfIndirectReference7 = (PdfIndirectReference) pdfDictionary2.get(PdfName.f1341PG);
                                if (pdfIndirectReference7 != null && !this.pageReferences.contains(pdfIndirectReference7) && !pdfIndirectReference7.equals(pdfIndirectReference5)) {
                                    pdfDictionary2.put(PdfName.f1341PG, pdfIndirectReference5);
                                    PdfArray asArray = pdfDictionary2.getAsArray(PdfName.f1320K);
        ...
        for (Map.Entry next : this.indirectObjects.entrySet()) {
            ...
            } else if (((PdfIndirectObject) next.getValue()).object.isDictionary() && (pdfObject = ((PdfDictionary) ((PdfIndirectObject) next.getValue()).object).get(PdfName.f1320K)) != null && pdfObject.isArray()) {
    ...
    private boolean containsInactivePg(PdfDictionary pdfDictionary, HashSet<RefKey> hashSet) {
        PdfObject pdfObject = pdfDictionary.get(PdfName.f1341PG);
    ...
    private ArrayList<PdfIndirectReference> findActiveParents(HashSet<RefKey> hashSet) {
        ...
        for (int i = 0; i < arrayList2.size(); i++) {
            ...
            if (pdfIndirectObject != null && pdfIndirectObject.object.isDictionary() && (pdfObject = ((PdfDictionary) pdfIndirectObject.object).get(PdfName.f1338P)) != null && pdfObject.type() == 0) {
    ...
    private void fixPgKey(ArrayList<PdfIndirectReference> arrayList, HashSet<RefKey> hashSet) {
        ...
        while (it.hasNext()) {
            ...
            if (pdfIndirectObject != null && pdfIndirectObject.object.isDictionary() && (pdfObject = pdfDictionary.get(PdfName.f1341PG)) != null && !hashSet.contains(new RefKey((PdfIndirectReference) pdfObject)) && (asArray = pdfDictionary.getAsArray(PdfName.f1320K)) != null) {
                int i = 0;
                while (true) {
                    if (i >= asArray.size()) {
                        break;
                    ...
                    if (pdfObject3.type() == 0) {
                        ...
                        if (pdfIndirectObject2 != null && pdfIndirectObject2.object.isDictionary() && (pdfObject2 = ((PdfDictionary) pdfIndirectObject2.object).get(PdfName.f1341PG)) != null && hashSet.contains(new RefKey((PdfIndirectReference) pdfObject2))) {
                            (pdfDictionary = (PdfDictionary) pdfIndirectObject.object).put(PdfName.f1341PG, pdfObject2);
                            break;
                        }
                    } else {
                        asArray.remove(i);
    ...
    private void findActivesFromDict(PdfDictionary pdfDictionary, ArrayList<PdfIndirectReference> arrayList, HashSet<RefKey> hashSet, HashSet<PdfName> hashSet2) {
        if (!containsInactivePg(pdfDictionary, hashSet)) {
            for (PdfName next : pdfDictionary.getKeys()) {
                ...
                if (!next.equals(PdfName.f1338P)) {
                    if (!next.equals(PdfName.f1272C)) {
    ...
    private void updateCalculationOrder(PdfReader pdfReader) {
        ...
        if (asDict != null && (asArray = asDict.getAsArray(PdfName.f1280CO)) != null && asArray.size() != 0) {
            AcroFields acroFields = pdfReader.getAcroFields();
    ...
    private static String getCOName(PdfReader pdfReader, PRIndirectReference pRIndirectReference) {
        ...
        while (pRIndirectReference != null && (pdfObject = PdfReader.getPdfObject((PdfObject) pRIndirectReference)) != null && pdfObject.type() == 6) {
            PdfDictionary pdfDictionary = (PdfDictionary) pdfObject;
            PdfString asString = pdfDictionary.getAsString(PdfName.f1362T);
            if (asString != null) {
            ...
            while (true) {
                ...
                if (stringTokenizer.hasMoreTokens()) {
                    ...
                    if (obj == null) {
                        ...
                        if (PdfName.SIG.equals(merged.get(PdfName.f1303FT))) {
                    ...
                    PdfName pdfName = (PdfName) pdfDictionary2.get(PdfName.f1303FT);
                    PdfName pdfName2 = (PdfName) merged.get(PdfName.f1303FT);
                    if (pdfName != null && pdfName.equals(pdfName2)) {
                        PdfObject pdfObject = pdfDictionary2.get(PdfName.f1298FF);
                        int intValue = (pdfObject == null || !pdfObject.isNumber()) ? 0 : ((PdfNumber) pdfObject).intValue();
                        PdfObject pdfObject2 = merged.get(PdfName.f1298FF);
                        ...
                        } else if (pdfName.equals(PdfName.f1278CH) && ((intValue ^ i) & 131072) != 0) {
                            return;
                        }
    ...
    private void createWidgets(ArrayList<Object> arrayList, AcroFields.Item item) {
        for (int i = 0; i < item.size(); i++) {
            ...
            PdfObject pdfObject = merged.get(PdfName.f1289DR);
            if (pdfObject != null) {
    ...
    private void createAcroForms() throws IOException, BadPdfFormatException {
        ...
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.f1289DR, propagate(this.resources));
        if (this.needAppearances) {
            pdfDictionary.put(PdfName.NEEDAPPEARANCES, PdfBoolean.PDFTRUE);
        }
        pdfDictionary.put(PdfName.f1283DA, new PdfString("/Helv 0 Tf 0 g "));
        ...
        if (pdfArray.size() > 0) {
            pdfDictionary.put(PdfName.f1280CO, pdfArray);
        }
    ...
    private PdfArray branchForm(HashMap<String, Object> hashMap, PdfIndirectReference pdfIndirectReference, String str) throws IOException, BadPdfFormatException {
        ...
        while (it3.hasNext()) {
            ...
            pdfDictionary.put(PdfName.f1362T, new PdfString(str2, PdfObject.TEXT_UNICODE));
                ...
                if (arrayList.size() == 3) {
                    ...
                    while (i2 < arrayList.size()) {
                        ...
                        if (isTextField(pdfDictionary2)) {
                            PdfString asString = pdfDictionary2.getAsString(PdfName.f1379V);
                            PdfObject directObject = pdfDictionary3.getDirectObject(PdfName.f1264AP);
                                ...
                                if (!this.mergedTextFields.containsKey(arrayList)) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            ((PdfDictionary) directObject).put(PdfName.f1325N, textField.getAppearance().getIndirectReference());
                            ...
                            if (isCheckButton(pdfDictionary2)) {
                                PdfName asName = pdfDictionary2.getAsName(PdfName.f1379V);
                                PdfName asName2 = pdfDictionary3.getAsName(PdfName.f1265AS);
                                if (!(asName == null || asName2 == null)) {
                                    pdfDictionary3.put(PdfName.f1265AS, asName);
                                }
                            } else if (isRadioButton(pdfDictionary2)) {
                                PdfName asName3 = pdfDictionary2.getAsName(PdfName.f1379V);
                                PdfName asName4 = pdfDictionary3.getAsName(PdfName.f1265AS);
                                if (!(asName3 == null || asName4 == null || asName4.equals(getOffStateName(pdfDictionary3)))) {
                                    if (!this.mergedRadioButtons.contains(arrayList)) {
                                        ...
                                        pdfDictionary3.put(PdfName.f1265AS, asName3);
                                    } else {
                                        pdfDictionary3.put(PdfName.f1265AS, getOffStateName(pdfDictionary3));
                                    }
                                }
                            }
                        }
    ...
    private void addFieldResources(PdfDictionary pdfDictionary) throws IOException {
        if (this.fieldArray != null) {
            ...
            pdfDictionary2.put(PdfName.f1283DA, new PdfString("/Helv 0 Tf 0 g "));
            if (!this.fieldTemplates.isEmpty()) {
                PdfDictionary pdfDictionary3 = new PdfDictionary();
                pdfDictionary2.put(PdfName.f1289DR, pdfDictionary3);
    ...
    public void freeReader(PdfReader pdfReader) throws IOException {
        if (!this.mergeFields) {
            PdfArray asArray = pdfReader.trailer.getAsArray(PdfName.f1315ID);
            if (asArray != null) {
    ...
    static Integer getFlags(PdfDictionary pdfDictionary) {
        PdfNumber asNumber;
        if (PdfName.BTN.equals(pdfDictionary.getAsName(PdfName.f1303FT)) && (asNumber = pdfDictionary.getAsNumber(PdfName.f1298FF)) != null) {
    ...
    static boolean isTextField(PdfDictionary pdfDictionary) {
        return PdfName.f1374TX.equals(pdfDictionary.getAsName(PdfName.f1303FT));
    }
