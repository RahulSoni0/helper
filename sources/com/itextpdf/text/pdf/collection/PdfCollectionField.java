...
public class PdfCollectionField extends PdfDictionary {
    ...
    public PdfCollectionField(String str, int i) {
        ...
        put(PdfName.f1325N, new PdfString(str, PdfObject.TEXT_UNICODE));
        this.fieldType = i;
        switch (i) {
            case 1:
                put(PdfName.SUBTYPE, PdfName.f1282D);
                return;
            case 2:
                put(PdfName.SUBTYPE, PdfName.f1325N);
                return;
            case 3:
                put(PdfName.SUBTYPE, PdfName.f1295F);
                return;
            case 4:
            ...
            case 7:
                ...
                return;
            default:
                put(PdfName.SUBTYPE, PdfName.f1357S);
                return;
        }
    }

    public void setOrder(int i) {
        put(PdfName.f1332O, new PdfNumber(i));
    }
    ...
    public void setEditable(boolean z) {
        put(PdfName.f1293E, new PdfBoolean(z));
    }
    ...
    public PdfObject getValue(String str) {
        ...
        throw new IllegalArgumentException(MessageLocalization.getComposedMessage("1.is.not.an.acceptable.value.for.the.field.2", str, get(PdfName.f1325N).toString()));
    }
}
