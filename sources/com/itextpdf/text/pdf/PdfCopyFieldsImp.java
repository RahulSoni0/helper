...
class PdfCopyFieldsImp extends PdfWriter {
    ...
    static {
        ...
        hashMap.put(PdfName.f1331NM, 1);
        hashMap.put(PdfName.f1323M, 1);
        hashMap.put(PdfName.f1295F, 1);
        hashMap.put(PdfName.f1271BS, 1);
        hashMap.put(PdfName.BORDER, 1);
        hashMap.put(PdfName.f1264AP, 1);
        hashMap.put(PdfName.f1265AS, 1);
        hashMap.put(PdfName.f1272C, 1);
        hashMap.put(PdfName.f1260A, 1);
        hashMap.put(PdfName.STRUCTPARENT, 1);
        hashMap.put(PdfName.f1333OC, 1);
        hashMap.put(PdfName.f1304H, 1);
        hashMap.put(PdfName.f1324MK, 1);
        hashMap.put(PdfName.f1283DA, 1);
        hashMap.put(PdfName.f1346Q, 1);
        hashMap.put(PdfName.f1338P, 1);
        hashMap2.put(PdfName.f1261AA, 1);
        hashMap2.put(PdfName.f1303FT, 1);
        hashMap2.put(PdfName.f1372TU, 1);
        hashMap2.put(PdfName.f1368TM, 1);
        hashMap2.put(PdfName.f1298FF, 1);
        hashMap2.put(PdfName.f1379V, 1);
        hashMap2.put(PdfName.f1291DV, 1);
        hashMap2.put(PdfName.f1290DS, 1);
        hashMap2.put(PdfName.f1356RV, 1);
        hashMap2.put(PdfName.OPT, 1);
        hashMap2.put(PdfName.MAXLEN, 1);
        hashMap2.put(PdfName.f1366TI, 1);
        hashMap2.put(PdfName.f1313I, 1);
        hashMap2.put(PdfName.LOCK, 1);
        hashMap2.put(PdfName.f1360SV, 1);
    }
        ...
        for (Map.Entry next : hashMap.entrySet()) {
            ...
            if (value instanceof HashMap) {
                ...
                if (arrayList.size() == 3) {
                    ...
                    PdfName asName = pdfDictionary3.getAsName(PdfName.f1379V);
                    ...
                    while (i2 < arrayList.size()) {
                        ...
                        if (PdfCopy.isCheckButton(pdfDictionary3)) {
                            PdfName asName2 = pdfDictionary5.getAsName(PdfName.f1265AS);
                            if (!(asName == null || asName2 == null)) {
                                pdfDictionary5.put(PdfName.f1265AS, asName);
                            }
                        } else if (PdfCopy.isRadioButton(pdfDictionary3)) {
                            PdfName asName3 = pdfDictionary5.getAsName(PdfName.f1265AS);
                            if (!(asName == null || asName3 == null || asName3.equals(getOffStateName(pdfDictionary5)))) {
                                if (!this.mergedRadioButtons.contains(arrayList)) {
                                    ...
                                    pdfDictionary5.put(PdfName.f1265AS, getOffStateName(pdfDictionary5));
                                }
                            }
                        }
    ...
    public void createAcroForms() throws IOException {
        if (!this.fieldTree.isEmpty()) {
            ...
            pdfDictionary.put(PdfName.f1289DR, this.resources);
            ...
            this.form.put(PdfName.f1283DA, new PdfString("/Helv 0 Tf 0 g "));
            ...
            if (pdfArray.size() > 0) {
                this.form.put(PdfName.f1280CO, pdfArray);
            }
        }
    }
