...
public class PdfBorderDictionary extends PdfDictionary {
    ...
    public PdfBorderDictionary(float f, int i, PdfDashPattern pdfDashPattern) {
        put(PdfName.f1383W, new PdfNumber(f));
        if (i == 0) {
            put(PdfName.f1357S, PdfName.f1357S);
        } else if (i == 1) {
            if (pdfDashPattern != null) {
                put(PdfName.f1282D, pdfDashPattern);
            }
            put(PdfName.f1357S, PdfName.f1282D);
        } else if (i == 2) {
            put(PdfName.f1357S, PdfName.f1266B);
        } else if (i == 3) {
            put(PdfName.f1357S, PdfName.f1313I);
        } else if (i == 4) {
            put(PdfName.f1357S, PdfName.f1375U);
        } else {
