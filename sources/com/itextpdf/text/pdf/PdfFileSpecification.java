...
public class PdfFileSpecification extends PdfDictionary {
    ...
    public static PdfFileSpecification url(PdfWriter pdfWriter, String str) {
        ...
        pdfFileSpecification.put(PdfName.f1302FS, PdfName.URL);
        pdfFileSpecification.put(PdfName.f1295F, new PdfString(str));
    ...
    public static com.itextpdf.text.pdf.PdfFileSpecification fileEmbedded(com.itextpdf.text.pdf.PdfWriter r4, java.lang.String r5, java.lang.String r6, byte[] r7, java.lang.String r8, com.itextpdf.text.pdf.PdfDictionary r9, int r10) throws java.io.IOException {
        /*
            ...
            r0.<init>()
            r0.writer = r4
            com.itextpdf.text.pdf.PdfName r1 = com.itextpdf.text.pdf.PdfName.f1295F
        ...
        L_0x002e:
            ...
            goto L_0x0067
        L_0x004f:
            java.io.InputStream r6 = com.itextpdf.text.p015io.StreamUtil.getResourceStream(r5)     // Catch:{ all -> 0x0107 }
        ...
        L_0x00ef:
            ...
            r4.<init>()
            com.itextpdf.text.pdf.PdfName r5 = com.itextpdf.text.pdf.PdfName.f1295F
            r4.put(r5, r8)
            com.itextpdf.text.pdf.PdfName r5 = com.itextpdf.text.pdf.PdfName.f1377UF
            r4.put(r5, r8)
            com.itextpdf.text.pdf.PdfName r5 = com.itextpdf.text.pdf.PdfName.f1294EF
            r0.put(r5, r4)
            return r0
        L_0x0104:
            r4 = move-exception
    ...
    public void setMultiByteFileName(byte[] bArr) {
        put(PdfName.f1295F, new PdfString(bArr).setHexWriting(true));
    }

    public void setUnicodeFileName(String str, boolean z) {
        put(PdfName.f1377UF, new PdfString(str, z ? PdfObject.TEXT_UNICODE : PdfObject.TEXT_PDFDOCENCODING));
    }

    public void setVolatile(boolean z) {
        put(PdfName.f1379V, new PdfBoolean(z));
    }
    ...
    public void addCollectionItem(PdfCollectionItem pdfCollectionItem) {
        put(PdfName.f1279CI, pdfCollectionItem);
    }
