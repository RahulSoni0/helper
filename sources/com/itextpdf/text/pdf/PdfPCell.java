...
public class PdfPCell extends Rectangle implements IAccessibleElement {
    ...
    /* renamed from: id */
    protected AccessibleElementId f1395id;
    private Image image;
    ...
    public PdfPCell() {
        ...
        this.role = PdfName.f1364TD;
        this.accessibleAttributes = null;
        this.f1395id = new AccessibleElementId();
        this.headers = null;
    ...
    public void setId(AccessibleElementId accessibleElementId) {
        this.f1395id = accessibleElementId;
    }
