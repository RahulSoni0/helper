                ...
                if (i != 3) {
                    if (i == 4) {
                        ...
                        if (pdfDictionary != null) {
                            PdfObject pdfObject2 = pdfDictionary.get(PdfName.f1270BM);
                            if (pdfObject2 == null || PdfGState.BM_NORMAL.equals(pdfObject2) || PdfGState.BM_COMPATIBLE.equals(pdfObject2)) {
                                PdfObject pdfObject3 = pdfDictionary.get(PdfName.f1275CA);
                                if (pdfObject3 != null) {
                                ...
                                PdfObject pdfObject4 = pdfDictionary.get(PdfName.f1392ca);
                                if (pdfObject4 != null) {
