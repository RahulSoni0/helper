...
public class GlyphPositioningTableReader extends OpenTypeFontTableReader {
    ...
    public void readSubTable(int i, int i2) throws IOException {
        if (i == 1) {
            ...
            printStream.println("The lookupType " + i + " is not yet supported by " + "GlyphPositioningTableReader");
        }
    }

    private void readLookUpType_1(int i) throws IOException {
        this.f1448rf.seek((long) i);
        short readShort = this.f1448rf.readShort();
        if (readShort == 1) {
            LOG.debug("Reading `Look Up Type 1, Format 1` ....");
            short readShort2 = this.f1448rf.readShort();
            short readShort3 = this.f1448rf.readShort();
            if ((readShort3 & 1) == 1) {
                short readShort4 = this.f1448rf.readShort();
                Logger logger = LOG;
                logger.debug("xPlacement=" + readShort4);
            }
            if ((readShort3 & 2) == 2) {
                short readShort5 = this.f1448rf.readShort();
                Logger logger2 = LOG;
        ...
        PrintStream printStream = System.err;
        printStream.println("The PosFormat " + readShort + " for `LookupType 1` is not yet supported by " + "GlyphPositioningTableReader");
    }
    ...
    private void readLookUpType_4(int i) throws IOException {
        ...
        if (readShort == 1) {
            ...
            short readShort4 = this.f1448rf.readShort();
            short readShort5 = this.f1448rf.readShort();
            short readShort6 = this.f1448rf.readShort();
        ...
        PrintStream printStream = System.err;
        printStream.println("The posFormat " + readShort + " is not supported by " + "GlyphPositioningTableReader");
    }
    ...
    private void readLookUpType_8(int i) throws IOException {
        ...
        PrintStream printStream = System.err;
        printStream.println("The posFormat " + readShort + " for `Look Up Type 8` is not supported by " + "GlyphPositioningTableReader");
    }
    ...
    private void readChainingContextPositioningFormat_3(int i) throws IOException {
        ...
        for (int i2 = 0; i2 < readShort; i2++) {
            arrayList.add(Integer.valueOf(this.f1448rf.readShort()));
        }
        short readShort2 = this.f1448rf.readShort();
        Logger logger2 = LOG;
        ...
        for (int i3 = 0; i3 < readShort2; i3++) {
            arrayList2.add(Integer.valueOf(this.f1448rf.readShort()));
        }
        short readShort3 = this.f1448rf.readShort();
        Logger logger3 = LOG;
        ...
        for (int i4 = 0; i4 < readShort3; i4++) {
            arrayList3.add(Integer.valueOf(this.f1448rf.readShort()));
        }
        short readShort4 = this.f1448rf.readShort();
        Logger logger4 = LOG;
    ...
    private MarkRecord readMarkRecord() throws IOException {
        return new MarkRecord(this.f1448rf.readShort(), this.f1448rf.readShort());
    }
    ...
    private void readBaseArrayTable(int i, int i2) throws IOException {
        ...
        for (int i3 = 0; i3 < readShort; i3++) {
            for (int i4 = 0; i4 < i2; i4++) {
                hashSet.add(Integer.valueOf(this.f1448rf.readShort()));
            }
        }
