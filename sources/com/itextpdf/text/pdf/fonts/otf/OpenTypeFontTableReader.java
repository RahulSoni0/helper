...
public abstract class OpenTypeFontTableReader {
    ...
    /* renamed from: rf */
    protected final RandomAccessFileOrArray f1448rf;
    ...
    public OpenTypeFontTableReader(RandomAccessFileOrArray randomAccessFileOrArray, int i) throws IOException {
        this.f1448rf = randomAccessFileOrArray;
    ...
    private void readRangeRecord(List<Integer> list) throws IOException {
        ...
        for (int readShort2 = this.f1448rf.readShort(); readShort2 <= readShort; readShort2++) {
    ...
    private void readScriptRecord(int i, Map<String, Integer> map) throws IOException {
        map.put(this.f1448rf.readString(4, "utf-8"), Integer.valueOf(i + this.f1448rf.readShort()));
    }
    ...
    private void readLangSysRecord(Map<String, Integer> map) throws IOException {
        map.put(this.f1448rf.readString(4, "utf-8"), Integer.valueOf(this.f1448rf.readShort()));
    }
    ...
    private void readLangSysTable(int i) throws IOException {
        ...
        for (int i2 = 0; i2 < readShort3; i2++) {
            arrayList.add(Short.valueOf(this.f1448rf.readShort()));
        }
        Logger logger2 = LOG;
    ...
    private void readFeatureListTable(int i) throws IOException {
        ...
        for (int i2 = 0; i2 < readShort; i2++) {
            linkedHashMap.put(this.f1448rf.readString(4, "utf-8"), Short.valueOf(this.f1448rf.readShort()));
        }
        for (String str : linkedHashMap.keySet()) {
            Logger logger2 = LOG;
    ...
    private TableHeader readHeader() throws IOException {
        this.f1448rf.seek((long) this.tableLocation);
        return new TableHeader(this.f1448rf.readInt(), this.f1448rf.readUnsignedShort(), this.f1448rf.readUnsignedShort(), this.f1448rf.readUnsignedShort());
    }
}
