...
public class TtfUnicodeWriter {
    ...
    public void writeFont(com.itextpdf.text.pdf.TrueTypeFontUnicode r12, com.itextpdf.text.pdf.PdfIndirectReference r13, java.lang.Object[] r14, byte[] r15) throws com.itextpdf.text.DocumentException, java.io.IOException {
        ...
        L_0x002a:
            ...
            r4.<init>((byte[]) r2)
            r3.<init>(r4, r14)
            java.lang.String[] r4 = r3.getNames()     // Catch:{ Exception -> 0x003f }
            r4 = r4[r15]     // Catch:{ Exception -> 0x003f }
            byte[] r2 = r3.Process(r4)     // Catch:{ Exception -> 0x003f }
            goto L_0x0063
        L_0x003f:
            r0 = move-exception
        ...
        L_0x0080:
            ...
            goto L_0x00a9
        L_0x0085:
            com.itextpdf.text.pdf.RandomAccessFileOrArray r2 = r12.f1413rf
            monitor-enter(r2)
            com.itextpdf.text.pdf.TrueTypeFontSubSet r10 = new com.itextpdf.text.pdf.TrueTypeFontSubSet     // Catch:{ all -> 0x0100 }
            java.lang.String r4 = r12.fileName     // Catch:{ all -> 0x0100 }
            com.itextpdf.text.pdf.RandomAccessFileOrArray r5 = new com.itextpdf.text.pdf.RandomAccessFileOrArray     // Catch:{ all -> 0x0100 }
            com.itextpdf.text.pdf.RandomAccessFileOrArray r3 = r12.f1413rf     // Catch:{ all -> 0x0100 }
            r5.<init>((com.itextpdf.text.pdf.RandomAccessFileOrArray) r3)     // Catch:{ all -> 0x0100 }
            java.util.HashSet r6 = new java.util.HashSet     // Catch:{ all -> 0x0100 }
            java.util.Set r14 = r14.keySet()     // Catch:{ all -> 0x0100 }
            r6.<init>(r14)     // Catch:{ all -> 0x0100 }
            int r7 = r12.directoryOffset     // Catch:{ all -> 0x0100 }
            r8 = 1
            r9 = 0
            r3 = r10
            r3.<init>(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0100 }
            byte[] r14 = r10.process()     // Catch:{ all -> 0x0100 }
