...
public class StandardDecryption {
    ...
    /* renamed from: iv */
    private byte[] f1407iv = new byte[16];
    private int ivptr;
    private byte[] key;
    ...
    public byte[] update(byte[] bArr, int i, int i2) {
        if (!this.aes) {
            ...
            int min = Math.min(this.f1407iv.length - this.ivptr, i2);
            System.arraycopy(bArr, i, this.f1407iv, this.ivptr, min);
            int i3 = i + min;
            int i4 = i2 - min;
            int i5 = this.ivptr + min;
            this.ivptr = i5;
            byte[] bArr3 = this.f1407iv;
            if (i5 != bArr3.length) {
                return null;
            }
