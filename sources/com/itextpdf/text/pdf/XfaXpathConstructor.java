...
public class XfaXpathConstructor implements XpathConstructor {
    ...
    public XfaXpathConstructor(XdpPackage xdpPackage) {
        ...
        this.XFDF = "xfdf";
        this.XMPMETA = XMPConst.TAG_XMPMETA;
        switch (C18211.$SwitchMap$com$itextpdf$text$pdf$XfaXpathConstructor$XdpPackage[xdpPackage.ordinal()]) {
            case 1:
                break;
            case 2:
                str = "connectionSet";
    ...
    static /* synthetic */ class C18211 {
        ...
        static {
            ...
            L_0x0084:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.XfaXpathConstructor.C18211.<clinit>():void");
        }
    }
