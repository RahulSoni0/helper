...
public class PdfPTable implements LargeElement, Spaceable, IAccessibleElement {
    ...
    /* renamed from: id */
    protected AccessibleElementId f1397id;
    ...
    protected PdfPTable() {
        ...
        this.f1397id = new AccessibleElementId();
        this.header = null;
        this.body = null;
        this.footer = null;
    }
    ...
    public void copyFormat(PdfPTable pdfPTable) {
        ...
        this.f1397id = pdfPTable.f1397id;
    ...
    public void addCell(PdfPTable pdfPTable) {
        ...
        addCell(this.defaultCell).f1395id = new AccessibleElementId();
    ...
    public void setId(AccessibleElementId accessibleElementId) {
        this.f1397id = accessibleElementId;
    }
