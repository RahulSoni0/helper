...
class TrueTypeFontUnicode extends TrueTypeFont implements Comparator<int[]> {
    ...
    private static final byte[] rotbits = {ByteCompanionObject.MIN_VALUE, 64, DocWriter.SPACE, BidiOrder.f1242S, 8, 4, 2, 1};
    ...
    public PdfDictionary getCIDFontType2(PdfIndirectReference pdfIndirectReference, String str, Object[] objArr) {
        ...
        if (!this.vertical) {
            pdfDictionary.put(PdfName.f1292DW, new PdfNumber(1000));
            ...
            if (stringBuffer.length() > 1) {
                stringBuffer.append("]]");
                pdfDictionary.put(PdfName.f1383W, new PdfLiteral(stringBuffer.toString()));
            }
        }
    ...
    private void readGsubTable() throws IOException {
        if (this.tables.get("GSUB") != null) {
            ...
            GlyphSubstitutionTableReader glyphSubstitutionTableReader = new GlyphSubstitutionTableReader(this.f1413rf, ((int[]) this.tables.get("GSUB"))[0], hashMap, this.glyphWidthsByIndex);
            try {
