    ...
    private void resolveNeutralTypes(int i, int i2, byte b, byte b2, byte b3) {
        ...
        while (i3 < i2) {
            ...
            if (b5 == 17 || b5 == 18 || b5 == 15 || b5 == 16) {
                int findRunLimit = findRunLimit(i3, i2, new byte[]{f1233B, f1242S, f1243WS, 18});
                byte b6 = 3;
                if (i3 == i) {
                    b4 = b2;
                } else {
