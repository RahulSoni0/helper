...
public class PdfLayer extends PdfDictionary implements PdfOCG {
    ...
    public void setLanguage(String str, boolean z) {
        ...
        if (z) {
            pdfDictionary.put(PdfName.PREFERRED, PdfName.f1335ON);
        }
    ...
    public void setExport(boolean z) {
        PdfDictionary usage = getUsage();
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.EXPORTSTATE, z ? PdfName.f1335ON : PdfName.OFF);
    ...
    public void setPrint(String str, boolean z) {
        ...
        pdfDictionary.put(PdfName.PRINTSTATE, z ? PdfName.f1335ON : PdfName.OFF);
    ...
    public void setView(boolean z) {
        PdfDictionary usage = getUsage();
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.VIEWSTATE, z ? PdfName.f1335ON : PdfName.OFF);
