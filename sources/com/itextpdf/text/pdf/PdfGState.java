...
public class PdfGState extends PdfDictionary {
    ...
    public void setOverPrintStroking(boolean z) {
        put(PdfName.f1336OP, z ? PdfBoolean.PDFTRUE : PdfBoolean.PDFFALSE);
    }

    public void setOverPrintNonStroking(boolean z) {
        put(PdfName.f1393op, z ? PdfBoolean.PDFTRUE : PdfBoolean.PDFFALSE);
    }
    ...
    public void setStrokeOpacity(float f) {
        put(PdfName.f1275CA, new PdfNumber(f));
    }

    public void setFillOpacity(float f) {
        put(PdfName.f1392ca, new PdfNumber(f));
    }
    ...
    public void setTextKnockout(boolean z) {
        put(PdfName.f1367TK, z ? PdfBoolean.PDFTRUE : PdfBoolean.PDFFALSE);
    }

    public void setBlendMode(PdfName pdfName) {
        put(PdfName.f1270BM, pdfName);
    }

    public void setRenderingIntent(PdfName pdfName) {
        put(PdfName.f1351RI, pdfName);
    }
