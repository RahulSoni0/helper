...
public final class SimpleBookmark implements SimpleXMLDocHandler {
    ...
    private static List<HashMap<String, Object>> bookmarkDepth(PdfReader pdfReader, PdfDictionary pdfDictionary, IntHashtable intHashtable, boolean z) {
        ...
        while (pdfDictionary2 != null) {
            ...
            PdfArray pdfArray = (PdfArray) PdfReader.getPdfObjectRelease(pdfDictionary2.get(PdfName.f1272C));
            ...
            PdfNumber pdfNumber = (PdfNumber) PdfReader.getPdfObjectRelease(pdfDictionary2.get(PdfName.f1295F));
            if (pdfNumber != null) {
            ...
            try {
                ...
                if (pdfObjectRelease != null) {
                    ...
                    PdfDictionary pdfDictionary3 = (PdfDictionary) PdfReader.getPdfObjectRelease(pdfDictionary2.get(PdfName.f1260A));
                    if (pdfDictionary3 != null) {
                        if (PdfName.GOTO.equals(PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1357S)))) {
                            PdfObject pdfObjectRelease2 = PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1282D));
                            if (pdfObjectRelease2 != null) {
                                mapGotoBookmark(hashMap, pdfObjectRelease2, intHashtable2);
                            }
                        } else if (PdfName.URI.equals(PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1357S)))) {
                        ...
                        } else if (PdfName.JAVASCRIPT.equals(PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1357S)))) {
                            hashMap.put("Action", "JS");
                            hashMap.put("Code", PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1319JS)).toString());
                        } else if (PdfName.GOTOR.equals(PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1357S)))) {
                            PdfObject pdfObjectRelease3 = PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1282D));
                            ...
                            PdfObject pdfObjectRelease4 = PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1295F));
                            if (pdfObjectRelease4 != null) {
                                if (pdfObjectRelease4.isString()) {
                                    ...
                                    PdfObject pdfObject = PdfReader.getPdfObject(((PdfDictionary) pdfObjectRelease4).get(PdfName.f1295F));
                        ...
                        } else if (PdfName.LAUNCH.equals(PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1357S)))) {
                            hashMap.put("Action", "Launch");
                            PdfObject pdfObjectRelease6 = PdfReader.getPdfObjectRelease(pdfDictionary3.get(PdfName.f1295F));
                            ...
                            if (pdfObjectRelease6 != null) {
                                if (pdfObjectRelease6.isString()) {
                                    ...
                                    PdfObject pdfObjectRelease7 = PdfReader.getPdfObjectRelease(((PdfDictionary) pdfObjectRelease6).get(PdfName.f1295F));
    ...
    static void createOutlineAction(PdfDictionary pdfDictionary, HashMap<String, Object> hashMap, PdfWriter pdfWriter, boolean z) {
        ...
        try {
            ...
            if ("GoTo".equals(str2)) {
                ...
                if (str5 != null) {
                    pdfDictionary3.put(PdfName.f1282D, new PdfString(str5, (String) null));
                } else {
                    String str6 = (String) hashMap2.get("NamedN");
                    if (str6 != null) {
                        pdfDictionary3.put(PdfName.f1282D, new PdfName(str6));
                    } else {
                        ...
                        if (str7 != null) {
                            ...
                            pdfDictionary3.put(PdfName.f1282D, pdfArray2);
                        }
                    }
                }
                String str8 = (String) hashMap2.get("File");
                if (pdfDictionary3.size() > 0 && str8 != null) {
                    pdfDictionary3.put(PdfName.f1357S, PdfName.GOTOR);
                    pdfDictionary3.put(PdfName.f1295F, new PdfString(str8));
                    ...
                    pdfDictionary2.put(PdfName.f1260A, pdfDictionary3);
                }
            } else if ("URI".equals(str2)) {
                String str10 = (String) hashMap2.get("URI");
                if (str10 != null) {
                    PdfDictionary pdfDictionary4 = new PdfDictionary();
                    pdfDictionary4.put(PdfName.f1357S, PdfName.URI);
                    pdfDictionary4.put(PdfName.URI, new PdfString(str10));
                    pdfDictionary2.put(PdfName.f1260A, pdfDictionary4);
                }
            } else if ("JS".equals(str2)) {
                String str11 = (String) hashMap2.get("Code");
                if (str11 != null) {
                    pdfDictionary2.put(PdfName.f1260A, PdfAction.javaScript(str11, pdfWriter2));
                }
            } else if ("Launch".equals(str2) && (str = (String) hashMap2.get("File")) != null) {
                PdfDictionary pdfDictionary5 = new PdfDictionary();
                pdfDictionary5.put(PdfName.f1357S, PdfName.LAUNCH);
                pdfDictionary5.put(PdfName.f1295F, new PdfString(str));
                pdfDictionary2.put(PdfName.f1260A, pdfDictionary5);
            }
        } catch (Exception unused) {
        }
    }
        ...
        while (listIterator.hasNext()) {
            ...
            if (str != null) {
                try {
                    ...
                    pdfDictionary.put(PdfName.f1272C, pdfArray);
                } catch (Exception unused) {
                }
            }
            ...
            if (str2 != null) {
                ...
                if (i5 != 0) {
                    pdfDictionary.put(PdfName.f1295F, new PdfNumber(i5));
                }
            }
