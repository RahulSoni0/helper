...
public class PRAcroForm extends PdfDictionary {
    ...
    public static class FieldInformation {
        ...
        public String getWidgetName() {
            PdfObject pdfObject = this.info.get(PdfName.f1331NM);
            if (pdfObject != null) {
    ...
    public void iterateFields(PdfArray pdfArray, PRIndirectReference pRIndirectReference, String str) {
        ...
        while (listIterator.hasNext()) {
            ...
            PdfString pdfString = (PdfString) pdfDictionary.get(PdfName.f1362T);
            ...
            if (pdfArray2 != null) {
                ...
                pdfDictionary2.put(PdfName.f1362T, new PdfString(str2));
    ...
    public PdfDictionary mergeAttrib(PdfDictionary pdfDictionary, PdfDictionary pdfDictionary2) {
        ...
        for (PdfName next : pdfDictionary2.getKeys()) {
            if (next.equals(PdfName.f1289DR) || next.equals(PdfName.f1283DA) || next.equals(PdfName.f1346Q) || next.equals(PdfName.f1298FF) || next.equals(PdfName.f1291DV) || next.equals(PdfName.f1379V) || next.equals(PdfName.f1303FT) || next.equals(PdfName.f1331NM) || next.equals(PdfName.f1295F)) {
