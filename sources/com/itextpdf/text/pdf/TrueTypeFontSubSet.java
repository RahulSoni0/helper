...
class TrueTypeFontSubSet {
    ...
    /* renamed from: rf */
    protected RandomAccessFileOrArray f1414rf;
    ...
    TrueTypeFontSubSet(String str, RandomAccessFileOrArray randomAccessFileOrArray, HashSet<Integer> hashSet, int i, boolean z, boolean z2) {
        this.fileName = str;
        this.f1414rf = randomAccessFileOrArray;
        ...
        for (String str3 : strArr) {
            ...
            if (iArr3 != null) {
                if (str3.equals("glyf")) {
                    ...
                    this.f1414rf.seek((long) iArr3[1]);
                    this.f1414rf.readFully(this.outFont, this.fontPtr, iArr3[2]);
    ...
    public void createTableDirectory() throws IOException, DocumentException {
        ...
        this.f1414rf.seek((long) this.directoryOffset);
        if (this.f1414rf.readInt() == 65536) {
            int readUnsignedShort = this.f1414rf.readUnsignedShort();
            this.f1414rf.skipBytes(6);
            for (int i = 0; i < readUnsignedShort; i++) {
                this.tableDirectory.put(readStandardString(4), new int[]{this.f1414rf.readInt(), this.f1414rf.readInt(), this.f1414rf.readInt()});
            }
            return;
        }
    ...
    public void readLoca() throws IOException, DocumentException {
        ...
        int i = 0;
        if (iArr != null) {
            this.f1414rf.seek((long) (iArr[1] + 51));
            this.locaShortTable = this.f1414rf.readUnsignedShort() == 0;
            int[] iArr2 = this.tableDirectory.get("loca");
            if (iArr2 != null) {
                this.f1414rf.seek((long) iArr2[1]);
                if (this.locaShortTable) {
                    int i2 = iArr2[2] / 2;
                    this.locaTable = new int[i2];
                    while (i < i2) {
                        this.locaTable[i] = this.f1414rf.readUnsignedShort() * 2;
                        i++;
                    }
                    return;
                }
                ...
                while (i < i3) {
                    this.locaTable[i] = this.f1414rf.readInt();
                    i++;
                }
                return;
            }
        ...
        while (true) {
            ...
            if (i < iArr3.length) {
                ...
                if (i7 < size && iArr[i7] == i) {
                    ...
                    int i9 = iArr4[i + 1] - i8;
                    if (i9 > 0) {
                        this.f1414rf.seek((long) (this.tableGlyphOffset + i8));
                        this.f1414rf.readFully(this.newGlyfTable, i6, i9);
                        i6 += i9;
                    }
                }
                i++;
    ...
    public void checkGlyphComposite(int i) throws IOException {
        ...
        int i2 = iArr[i];
        if (i2 != iArr[i + 1]) {
            this.f1414rf.seek((long) (this.tableGlyphOffset + i2));
            if (this.f1414rf.readShort() < 0) {
                this.f1414rf.skipBytes(8);
                while (true) {
                    int readUnsignedShort = this.f1414rf.readUnsignedShort();
                    Integer valueOf = Integer.valueOf(this.f1414rf.readUnsignedShort());
