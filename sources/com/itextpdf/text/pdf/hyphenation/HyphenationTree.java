...
public class HyphenationTree extends TernaryTree implements PatternConsumer {
    ...
    public String unpackValues(int i) {
        ...
        while (b != 0) {
            ...
            char c = (char) (b & BidiOrder.f1233B);
            if (c == 0) {
                break;
            }
    ...
    public void searchPatterns(char[] cArr, int i, byte[] bArr) {
        ...
        char c2 = this.root;
        int i2 = i;
        while (c2 > 0 && c2 < this.f1455sc.length) {
            int i3 = 0;
            if (this.f1455sc[c2] != 65535) {
                int i4 = c - this.f1455sc[c2];
                if (i4 == 0) {
                    if (c != 0) {
                        i2++;
                        c = cArr[i2];
                        ...
                        char c3 = c2;
                        while (true) {
                            if (c3 <= 0 || c3 >= this.f1455sc.length || this.f1455sc[c3] == 65535) {
                                break;
                            } else if (this.f1455sc[c3] == 0) {
                                byte[] values = getValues(this.f1451eq[c3]);
                    ...
                    c2 = i4 < 0 ? this.f1454lo[c2] : this.f1452hi[c2];
                }
            } else if (hstrcmp(cArr, i2, this.f1453kv.getArray(), this.f1454lo[c2]) == 0) {
                byte[] values2 = getValues(this.f1451eq[c2]);
