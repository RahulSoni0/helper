...
public class BarcodeDatamatrix {
    ...
    private void draw(byte[] bArr, int i, DmParams dmParams) {
        int i2;
        int i3 = ((dmParams.width + (this.f1223ws * 2)) + 7) / 8;
        ...
        while (true) {
            ...
            while (i6 < dmParams.width + this.f1223ws) {
                setBit(i6, i4, i3);
                i6 += 2;
            }
        ...
        while (true) {
            ...
            while (i2 < dmParams.width + this.f1223ws) {
                setBit(i2, i7, i3);
                i2++;
            }
        ...
        while (true) {
            ...
            int i11 = this.f1223ws;
            if (i2 >= i10 + i11) {
                break;
            }
            while (i11 < dmParams.height + this.f1223ws) {
                setBit(i2, i11, i3);
                i11++;
            }
        ...
        int i13 = this.f1223ws;
        while (true) {
            i12 += i13;
            int i14 = dmParams.width;
            int i15 = this.f1223ws;
            if (i12 >= i14 + i15) {
                break;
            }
            for (int i16 = i15 + 1; i16 < dmParams.height + this.f1223ws; i16 += 2) {
                setBit(i12, i16, i3);
            }
    ...
    public int generate(byte[] bArr, int i, int i2) {
        ...
        if (this.height == 0 || this.width == 0) {
            ...
            while (true) {
                dmParamsArr = dmSizes;
                if (i7 >= dmParamsArr.length || (dmParamsArr[i7].dataSize >= i3 && (!this.forceSquareSize || dmParamsArr[i7].width == dmParamsArr[i7].height))) {
        ...
        this.image = new byte[((((dmParams.width + (this.f1223ws * 2)) + 7) / 8) * (dmParams.height + (this.f1223ws * 2)))];
    ...
    static class ReedSolomon {
        private static final int[] alog = {1, 2, 4, 8, 16, 32, 64, 128, 45, 90, 180, 69, 138, 57, 114, 228, 229, 231, 227, 235, 251, 219, 155, 27, 54, 108, 216, 157, 23, 46, 92, 184, 93, 186, 89, 178, 73, 146, 9, 18, 36, 72, 144, 13, 26, 52, 104, 208, 141, 55, 110, 220, 149, 7, 14, 28, 56, 112, 224, Jpeg.M_APPD, MetaDo.META_CREATEPALETTE, 195, 171, 123, 246, 193, 175, 115, 230, 225, 239, 243, 203, 187, 91, 182, 65, 130, 41, 82, 164, 101, XMPError.BADRDF, 185, 95, 190, 81, 162, 105, 210, 137, 63, 126, 252, 213, 135, 35, 70, 140, 53, 106, 212, 133, 39, 78, 156, 21, 42, 84, 168, 125, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 217, 159, 19, 38, 76, 152, 29, 58, 116, 232, 253, 215, 131, 43, 86, 172, 117, 234, 249, 223, 147, 11, 22, 44, 88, 176, 77, 154, 25, 50, 100, 200, 189, 87, 174, 113, Jpeg.M_APP2, 233, 255, 211, 139, 59, 118, 236, 245, 199, 163, 107, 214, 129, 47, 94, 188, 85, 170, 121, 242, 201, 191, 83, 166, 97, 194, 169, WorkQueueKt.MASK, TIFFConstants.TIFFTAG_SUBFILETYPE, 209, 143, 51, 102, 204, 181, 71, 142, 49, 98, 196, 165, 103, 206, 177, 79, 158, 17, 34, 68, 136, 61, 122, 244, 197, 167, 99, 198, 161, 111, 222, 145, 15, 30, 60, 120, 240, 205, 183, 67, 134, 33, 66, 132, 37, 74, 148, 5, 10, 20, 40, 80, 160, 109, 218, 153, 31, 62, 124, 248, 221, 151, 3, 6, 12, 24, 48, 96, 192, 173, 119, Jpeg.M_APPE, 241, 207, 179, 75, 150, 1};
        private static final int[] log = {0, 255, 1, 240, 2, 225, 241, 53, 3, 38, Jpeg.M_APP2, 133, 242, 43, 54, 210, 4, 195, 39, 114, 227, 106, 134, 28, 243, 140, 44, 23, 55, 118, 211, 234, 5, 219, 196, 96, 40, 222, 115, 103, 228, 78, 107, 125, 135, 8, 29, 162, 244, 186, 141, 180, 45, 99, 24, 49, 56, 13, 119, 153, 212, 199, 235, 91, 6, 76, 220, 217, 197, 11, 97, 184, 41, 36, 223, 253, 116, 138, 104, 193, 229, 86, 79, 171, 108, 165, 126, 145, 136, 34, 9, 74, 30, 32, 163, 84, 245, 173, 187, 204, 142, 81, 181, 190, 46, 88, 100, 159, 25, 231, 50, 207, 57, 147, 14, 67, 120, 128, 154, 248, 213, 167, 200, 63, 236, 110, 92, 176, 7, 161, 77, 124, 221, 102, 218, 95, 198, 90, 12, 152, 98, 48, 185, 179, 42, 209, 37, 132, 224, 52, TIFFConstants.TIFFTAG_SUBFILETYPE, 239, 117, 233, 139, 22, 105, 27, 194, 113, 230, 206, 87, 158, 80, 189, 172, 203, 109, 175, 166, 62, WorkQueueKt.MASK, MetaDo.META_CREATEPALETTE, 146, 66, 137, 192, 35, 252, 10, 183, 75, 216, 31, 83, 33, 73, 164, 144, 85, 170, 246, 65, 174, 61, 188, XMPError.BADRDF, 205, 157, 143, 169, 82, 72, 182, 215, 191, 251, 47, 178, 89, 151, 101, 94, 160, 123, 26, 112, 232, 21, 51, Jpeg.M_APPE, 208, 131, 58, 69, 148, 18, 15, 16, 68, 17, 121, 149, 129, 19, 155, 59, 249, 70, 214, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 168, 71, 201, 156, 64, 60, Jpeg.M_APPD, 130, 111, 20, 93, 122, 177, 150};
        ...
        private static final int[] poly36 = {245, WorkQueueKt.MASK, 242, 218, 130, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 162, 181, 102, 120, 84, 179, 220, 251, 80, 182, 229, 18, 2, 4, 68, 33, 101, 137, 95, 119, 115, 44, 175, 184, 59, 25, 225, 98, 81, 112};
        private static final int[] poly42 = {77, 193, 137, 31, 19, 38, 22, 153, MetaDo.META_CREATEPALETTE, 105, 122, 2, 245, 133, 242, 8, 175, 95, 100, 9, 167, 105, 214, 111, 57, 121, 21, 1, 253, 57, 54, 101, 248, XMPError.BADRDF, 69, 50, 150, 177, Jpeg.M_APP2, 5, 9, 5};
        private static final int[] poly48 = {245, 132, 172, 223, 96, 32, 117, 22, Jpeg.M_APPE, 133, Jpeg.M_APPE, 231, 205, 188, Jpeg.M_APPD, 87, 191, 106, 16, 147, 118, 23, 37, 90, 170, 205, 131, 88, 120, 100, 66, 138, 186, 240, 82, 44, 176, 87, 187, 147, 160, 175, 69, 213, 92, 253, 225, 19};
        private static final int[] poly5 = {228, 48, 15, 111, 62};
        private static final int[] poly56 = {175, 9, 223, Jpeg.M_APPE, 12, 17, 220, 208, 100, 29, 175, 170, 230, 192, 215, 235, 150, 159, 36, 223, 38, 200, 132, 54, 228, 146, 218, 234, 117, 203, 29, 232, 144, Jpeg.M_APPE, 22, 150, 201, 117, 62, 207, 164, 13, 137, 245, WorkQueueKt.MASK, 67, MetaDo.META_CREATEPALETTE, 28, 155, 43, 203, 107, 233, 53, 143, 46};
        private static final int[] poly62 = {242, 93, 169, 50, 144, 210, 39, 118, XMPError.BADRDF, 188, 201, 189, 143, 108, 196, 37, 185, 112, 134, 230, 245, 63, 197, 190, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 106, 185, 221, 175, 64, 114, 71, 161, 44, 147, 6, 27, 218, 51, 63, 87, 10, 40, 130, 188, 17, 163, 31, 176, 170, 4, 107, 232, 7, 94, 166, 224, 124, 86, 47, 11, 204};
        private static final int[] poly68 = {220, 228, 173, 89, 251, 149, 159, 56, 89, 33, 147, 244, 154, 36, 73, WorkQueueKt.MASK, 213, 136, 248, 180, 234, 197, 158, 177, 68, 122, 93, 213, 15, 160, 227, 236, 66, 139, 153, 185, XMPError.BADRDF, 167, 179, 25, 220, 232, 96, 210, 231, 136, 223, 239, 181, 241, 59, 52, 172, 25, 49, 232, 211, 189, 64, 54, 108, 153, 132, 63, 96, 103, 82, 186};
