...
import com.itextpdf.text.p015io.TempFileCache;
...
public class PdfDocument extends Document {
    ...
    static class PdfCatalog extends PdfDictionary {
        ...
        public void setAdditionalActions(PdfDictionary pdfDictionary) {
            try {
                put(PdfName.f1261AA, this.writer.addToBody(pdfDictionary).getIndirectReference());
            } catch (Exception e) {
                throw new ExceptionConverter(e);
            }
        }
    ...
    public boolean add(com.itextpdf.text.Element r13) throws com.itextpdf.text.DocumentException {
        /*
            ...
            return r1
        L_0x000c:
            int r0 = r13.type()     // Catch:{ Exception -> 0x05ff }
            r2 = 37
            if (r0 == r2) goto L_0x0017
            r12.flushFloatingElements()     // Catch:{ Exception -> 0x05ff }
        L_0x0017:
            int r0 = r13.type()     // Catch:{ Exception -> 0x05ff }
            r2 = 23
            r3 = 1
            if (r0 == r2) goto L_0x05dc
            r2 = 50
        ...
        L_0x003e:
            goto L_0x0048
        L_0x003f:
            com.itextpdf.text.pdf.PdfBody r13 = (com.itextpdf.text.pdf.PdfBody) r13     // Catch:{ Exception -> 0x05ff }
            r12.body = r13     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r0 = r12.graphics     // Catch:{ Exception -> 0x05ff }
            r0.rectangle(r13)     // Catch:{ Exception -> 0x05ff }
        L_0x0048:
            return r1
        L_0x0049:
            r12.ensureNewLine()     // Catch:{ Exception -> 0x05ff }
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            r0 = r13
            com.itextpdf.text.pdf.PdfDiv r0 = (com.itextpdf.text.pdf.PdfDiv) r0     // Catch:{ Exception -> 0x05ff }
            r12.addDiv(r0)     // Catch:{ Exception -> 0x05ff }
            r12.pageEmpty = r1     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x0059:
            com.itextpdf.text.pdf.PdfWriter r0 = r12.writer     // Catch:{ Exception -> 0x05ff }
            boolean r0 = isTagged(r0)     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x0075
            r0 = r13
            com.itextpdf.text.Image r0 = (com.itextpdf.text.Image) r0     // Catch:{ Exception -> 0x05ff }
            boolean r0 = r0.isImgTemplate()     // Catch:{ Exception -> 0x05ff }
            if (r0 != 0) goto L_0x0075
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r0 = r12.text     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Image r1 = (com.itextpdf.text.Image) r1     // Catch:{ Exception -> 0x05ff }
            r0.openMCBlock(r1)     // Catch:{ Exception -> 0x05ff }
        L_0x0075:
            r0 = r13
            com.itextpdf.text.Image r0 = (com.itextpdf.text.Image) r0     // Catch:{ Exception -> 0x05ff }
            r12.add((com.itextpdf.text.Image) r0)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r0 = r12.writer     // Catch:{ Exception -> 0x05ff }
            boolean r0 = isTagged(r0)     // Catch:{ Exception -> 0x05ff }
            ...
            r1 = r13
            com.itextpdf.text.Image r1 = (com.itextpdf.text.Image) r1     // Catch:{ Exception -> 0x05ff }
            r0.closeMCBlock(r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x0099:
            r0 = r13
            com.itextpdf.text.Anchor r0 = (com.itextpdf.text.Anchor) r0     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r0.getReference()     // Catch:{ Exception -> 0x05ff }
            float r0 = r0.getLeading()     // Catch:{ Exception -> 0x05ff }
            r12.leading = r0     // Catch:{ Exception -> 0x05ff }
            r12.pushLeading()     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x00b2
            com.itextpdf.text.pdf.PdfAction r0 = new com.itextpdf.text.pdf.PdfAction     // Catch:{ Exception -> 0x05ff }
            r0.<init>((java.lang.String) r1)     // Catch:{ Exception -> 0x05ff }
            r12.anchorAction = r0     // Catch:{ Exception -> 0x05ff }
        L_0x00b2:
            r13.process(r12)     // Catch:{ Exception -> 0x05ff }
            r0 = 0
            r12.anchorAction = r0     // Catch:{ Exception -> 0x05ff }
            r12.popLeading()     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x00bd:
            r0 = r13
            com.itextpdf.text.ListItem r0 = (com.itextpdf.text.ListItem) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r1 = r12.writer     // Catch:{ Exception -> 0x05ff }
            boolean r1 = isTagged(r1)     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x00d0
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r1 = r12.text     // Catch:{ Exception -> 0x05ff }
            r1.openMCBlock(r0)     // Catch:{ Exception -> 0x05ff }
        L_0x00d0:
            float r1 = r0.getSpacingBefore()     // Catch:{ Exception -> 0x05ff }
            float r2 = r12.leading     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Font r4 = r0.getFont()     // Catch:{ Exception -> 0x05ff }
            r12.addSpacing(r1, r2, r4)     // Catch:{ Exception -> 0x05ff }
            int r1 = r0.getAlignment()     // Catch:{ Exception -> 0x05ff }
            r12.alignment = r1     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r2 = r1.listIndentLeft     // Catch:{ Exception -> 0x05ff }
            float r4 = r0.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r2 = r2 + r4
            r1.listIndentLeft = r2     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r2 = r1.indentRight     // Catch:{ Exception -> 0x05ff }
            float r4 = r0.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r2 = r2 + r4
            r1.indentRight = r2     // Catch:{ Exception -> 0x05ff }
            float r1 = r0.getTotalLeading()     // Catch:{ Exception -> 0x05ff }
            r12.leading = r1     // Catch:{ Exception -> 0x05ff }
            r12.pushLeading()     // Catch:{ Exception -> 0x05ff }
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfLine r1 = r12.line     // Catch:{ Exception -> 0x05ff }
            r1.setListItem(r0)     // Catch:{ Exception -> 0x05ff }
            r13.process(r12)     // Catch:{ Exception -> 0x05ff }
            float r1 = r0.getSpacingAfter()     // Catch:{ Exception -> 0x05ff }
            float r2 = r0.getTotalLeading()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Font r4 = r0.getFont()     // Catch:{ Exception -> 0x05ff }
            r12.addSpacing(r1, r2, r4, r3)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfLine r1 = r12.line     // Catch:{ Exception -> 0x05ff }
            boolean r1 = r1.hasToBeJustified()     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x0129
            com.itextpdf.text.pdf.PdfLine r1 = r12.line     // Catch:{ Exception -> 0x05ff }
            r1.resetAlignment()     // Catch:{ Exception -> 0x05ff }
        L_0x0129:
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r2 = r1.listIndentLeft     // Catch:{ Exception -> 0x05ff }
            ...
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r1 = r12.text     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.ListBody r2 = r0.getListBody()     // Catch:{ Exception -> 0x05ff }
            r1.closeMCBlock(r2)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r1 = r12.text     // Catch:{ Exception -> 0x05ff }
            r1.closeMCBlock(r0)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x0160:
            r0 = r13
            com.itextpdf.text.List r0 = (com.itextpdf.text.List) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r1 = r12.writer     // Catch:{ Exception -> 0x05ff }
            boolean r1 = isTagged(r1)     // Catch:{ Exception -> 0x05ff }
            ...
            r1.openMCBlock(r0)     // Catch:{ Exception -> 0x05ff }
        L_0x0173:
            boolean r1 = r0.isAlignindent()     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x017c
            r0.normalizeIndentation()     // Catch:{ Exception -> 0x05ff }
        L_0x017c:
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r2 = r1.listIndentLeft     // Catch:{ Exception -> 0x05ff }
            float r4 = r0.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
        ...
        L_0x01c0:
            r0 = r13
            com.itextpdf.text.Section r0 = (com.itextpdf.text.Section) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r2 = r12.writer     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfPageEvent r2 = r2.getPageEvent()     // Catch:{ Exception -> 0x05ff }
            boolean r4 = r0.isNotAddedYet()     // Catch:{ Exception -> 0x05ff }
            if (r4 == 0) goto L_0x01d7
            com.itextpdf.text.Paragraph r4 = r0.getTitle()     // Catch:{ Exception -> 0x05ff }
            if (r4 == 0) goto L_0x01d7
            r10 = 1
            goto L_0x01d8
        L_0x01d7:
            r10 = 0
        L_0x01d8:
            boolean r4 = r0.isTriggerNewPage()     // Catch:{ Exception -> 0x05ff }
            if (r4 == 0) goto L_0x01e1
            r12.newPage()     // Catch:{ Exception -> 0x05ff }
        L_0x01e1:
            if (r10 == 0) goto L_0x022c
            float r4 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r5 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r4 = r4 - r5
            com.itextpdf.text.Rectangle r5 = r12.pageSize     // Catch:{ Exception -> 0x05ff }
            int r5 = r5.getRotation()     // Catch:{ Exception -> 0x05ff }
            r6 = 90
        ...
        L_0x01f8:
            com.itextpdf.text.Rectangle r5 = r12.pageSize     // Catch:{ Exception -> 0x05ff }
            float r5 = r5.getHeight()     // Catch:{ Exception -> 0x05ff }
            float r4 = r5 - r4
        L_0x0200:
            com.itextpdf.text.pdf.PdfDestination r5 = new com.itextpdf.text.pdf.PdfDestination     // Catch:{ Exception -> 0x05ff }
            r6 = 2
            r5.<init>(r6, r4)     // Catch:{ Exception -> 0x05ff }
        L_0x0206:
            com.itextpdf.text.pdf.PdfOutline r4 = r12.currentOutline     // Catch:{ Exception -> 0x05ff }
            int r4 = r4.level()     // Catch:{ Exception -> 0x05ff }
            int r6 = r0.getDepth()     // Catch:{ Exception -> 0x05ff }
            if (r4 < r6) goto L_0x021b
            com.itextpdf.text.pdf.PdfOutline r4 = r12.currentOutline     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfOutline r4 = r4.parent()     // Catch:{ Exception -> 0x05ff }
            r12.currentOutline = r4     // Catch:{ Exception -> 0x05ff }
            goto L_0x0206
        L_0x021b:
            com.itextpdf.text.pdf.PdfOutline r4 = new com.itextpdf.text.pdf.PdfOutline     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfOutline r6 = r12.currentOutline     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Paragraph r7 = r0.getBookmarkTitle()     // Catch:{ Exception -> 0x05ff }
            boolean r8 = r0.isBookmarkOpen()     // Catch:{ Exception -> 0x05ff }
            r4.<init>((com.itextpdf.text.pdf.PdfOutline) r6, (com.itextpdf.text.pdf.PdfDestination) r5, (com.itextpdf.text.Paragraph) r7, (boolean) r8)     // Catch:{ Exception -> 0x05ff }
            r12.currentOutline = r4     // Catch:{ Exception -> 0x05ff }
        L_0x022c:
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r4 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r5 = r4.sectionIndentLeft     // Catch:{ Exception -> 0x05ff }
            float r6 = r0.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r5 = r5 + r6
            r4.sectionIndentLeft = r5     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r4 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r5 = r4.sectionIndentRight     // Catch:{ Exception -> 0x05ff }
            float r6 = r0.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r5 = r5 + r6
            r4.sectionIndentRight = r5     // Catch:{ Exception -> 0x05ff }
            boolean r4 = r0.isNotAddedYet()     // Catch:{ Exception -> 0x05ff }
            r11 = 16
            if (r4 == 0) goto L_0x027d
            if (r2 == 0) goto L_0x027d
            int r4 = r13.type()     // Catch:{ Exception -> 0x05ff }
            if (r4 != r11) goto L_0x0266
            com.itextpdf.text.pdf.PdfWriter r4 = r12.writer     // Catch:{ Exception -> 0x05ff }
            float r5 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r5 = r5 - r6
            com.itextpdf.text.Paragraph r6 = r0.getTitle()     // Catch:{ Exception -> 0x05ff }
            r2.onChapter(r4, r12, r5, r6)     // Catch:{ Exception -> 0x05ff }
            goto L_0x027d
        L_0x0266:
            com.itextpdf.text.pdf.PdfWriter r5 = r12.writer     // Catch:{ Exception -> 0x05ff }
            float r4 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r7 = r4 - r6
            int r8 = r0.getDepth()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Paragraph r9 = r0.getTitle()     // Catch:{ Exception -> 0x05ff }
            r4 = r2
            r6 = r12
            r4.onSection(r5, r6, r7, r8, r9)     // Catch:{ Exception -> 0x05ff }
        L_0x027d:
            if (r10 == 0) goto L_0x028a
            r12.isSectionTitle = r3     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Paragraph r4 = r0.getTitle()     // Catch:{ Exception -> 0x05ff }
            r12.add((com.itextpdf.text.Element) r4)     // Catch:{ Exception -> 0x05ff }
            r12.isSectionTitle = r1     // Catch:{ Exception -> 0x05ff }
        L_0x028a:
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r4 = r1.sectionIndentLeft     // Catch:{ Exception -> 0x05ff }
            float r5 = r0.getIndentation()     // Catch:{ Exception -> 0x05ff }
            float r4 = r4 + r5
            r1.sectionIndentLeft = r4     // Catch:{ Exception -> 0x05ff }
            r13.process(r12)     // Catch:{ Exception -> 0x05ff }
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r4 = r1.sectionIndentLeft     // Catch:{ Exception -> 0x05ff }
            float r5 = r0.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r6 = r0.getIndentation()     // Catch:{ Exception -> 0x05ff }
            float r5 = r5 + r6
            float r4 = r4 - r5
            r1.sectionIndentLeft = r4     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r4 = r1.sectionIndentRight     // Catch:{ Exception -> 0x05ff }
            float r5 = r0.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r4 = r4 - r5
            r1.sectionIndentRight = r4     // Catch:{ Exception -> 0x05ff }
            boolean r0 = r0.isComplete()     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x05f8
            if (r2 == 0) goto L_0x05f8
            int r0 = r13.type()     // Catch:{ Exception -> 0x05ff }
            if (r0 != r11) goto L_0x02d2
            com.itextpdf.text.pdf.PdfWriter r0 = r12.writer     // Catch:{ Exception -> 0x05ff }
            float r1 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r4 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r1 = r1 - r4
            r2.onChapterEnd(r0, r12, r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x02d2:
            com.itextpdf.text.pdf.PdfWriter r0 = r12.writer     // Catch:{ Exception -> 0x05ff }
            float r1 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r4 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r1 = r1 - r4
            r2.onSectionEnd(r0, r12, r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x02e0:
            com.itextpdf.text.TabSettings r0 = r12.tabSettings     // Catch:{ Exception -> 0x05ff }
            r2 = r13
            com.itextpdf.text.Phrase r2 = (com.itextpdf.text.Phrase) r2     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.TabSettings r2 = r2.getTabSettings()     // Catch:{ Exception -> 0x05ff }
            if (r2 == 0) goto L_0x02f4
            r2 = r13
            com.itextpdf.text.Phrase r2 = (com.itextpdf.text.Phrase) r2     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.TabSettings r2 = r2.getTabSettings()     // Catch:{ Exception -> 0x05ff }
            r12.tabSettings = r2     // Catch:{ Exception -> 0x05ff }
        L_0x02f4:
            r2 = r13
            com.itextpdf.text.Paragraph r2 = (com.itextpdf.text.Paragraph) r2     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r5 = r12.writer     // Catch:{ Exception -> 0x05ff }
            boolean r5 = isTagged(r5)     // Catch:{ Exception -> 0x05ff }
            if (r5 == 0) goto L_0x0307
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r5 = r12.text     // Catch:{ Exception -> 0x05ff }
            r5.openMCBlock(r2)     // Catch:{ Exception -> 0x05ff }
        L_0x0307:
            float r5 = r2.getSpacingBefore()     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.leading     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Font r7 = r2.getFont()     // Catch:{ Exception -> 0x05ff }
            r12.addSpacing(r5, r6, r7)     // Catch:{ Exception -> 0x05ff }
            int r5 = r2.getAlignment()     // Catch:{ Exception -> 0x05ff }
            r12.alignment = r5     // Catch:{ Exception -> 0x05ff }
            float r5 = r2.getTotalLeading()     // Catch:{ Exception -> 0x05ff }
            r12.leading = r5     // Catch:{ Exception -> 0x05ff }
            r12.pushLeading()     // Catch:{ Exception -> 0x05ff }
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            float r5 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.calculateLineHeight()     // Catch:{ Exception -> 0x05ff }
            float r5 = r5 + r6
            float r6 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r7 = r12.indentBottom()     // Catch:{ Exception -> 0x05ff }
            float r6 = r6 - r7
            int r5 = (r5 > r6 ? 1 : (r5 == r6 ? 0 : -1))
            if (r5 <= 0) goto L_0x033d
            r12.newPage()     // Catch:{ Exception -> 0x05ff }
        L_0x033d:
            com.itextpdf.text.pdf.PdfDocument$Indentation r5 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r6 = r5.indentLeft     // Catch:{ Exception -> 0x05ff }
            float r7 = r2.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r6 = r6 + r7
            r5.indentLeft = r6     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r5 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r6 = r5.indentRight     // Catch:{ Exception -> 0x05ff }
            float r7 = r2.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r6 = r6 + r7
            r5.indentRight = r6     // Catch:{ Exception -> 0x05ff }
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r5 = r12.writer     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfPageEvent r5 = r5.getPageEvent()     // Catch:{ Exception -> 0x05ff }
            if (r5 == 0) goto L_0x036e
            boolean r6 = r12.isSectionTitle     // Catch:{ Exception -> 0x05ff }
            if (r6 != 0) goto L_0x036e
            com.itextpdf.text.pdf.PdfWriter r6 = r12.writer     // Catch:{ Exception -> 0x05ff }
            float r7 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r8 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r7 = r7 - r8
            r5.onParagraph(r6, r12, r7)     // Catch:{ Exception -> 0x05ff }
        L_0x036e:
            boolean r6 = r2.getKeepTogether()     // Catch:{ Exception -> 0x05ff }
            if (r6 == 0) goto L_0x03c9
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfPTable r6 = new com.itextpdf.text.pdf.PdfPTable     // Catch:{ Exception -> 0x05ff }
            r6.<init>((int) r3)     // Catch:{ Exception -> 0x05ff }
            boolean r7 = r2.getKeepTogether()     // Catch:{ Exception -> 0x05ff }
            r6.setKeepTogether(r7)     // Catch:{ Exception -> 0x05ff }
            r7 = 1120403456(0x42c80000, float:100.0)
            r6.setWidthPercentage(r7)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfPCell r7 = new com.itextpdf.text.pdf.PdfPCell     // Catch:{ Exception -> 0x05ff }
            r7.<init>()     // Catch:{ Exception -> 0x05ff }
            r7.addElement(r2)     // Catch:{ Exception -> 0x05ff }
            r7.setBorder(r1)     // Catch:{ Exception -> 0x05ff }
            r7.setPadding(r4)     // Catch:{ Exception -> 0x05ff }
            r6.addCell((com.itextpdf.text.pdf.PdfPCell) r7)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r4 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r7 = r4.indentLeft     // Catch:{ Exception -> 0x05ff }
            float r8 = r2.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r7 = r7 - r8
            r4.indentLeft = r7     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r4 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r7 = r4.indentRight     // Catch:{ Exception -> 0x05ff }
            float r8 = r2.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r7 = r7 - r8
            r4.indentRight = r7     // Catch:{ Exception -> 0x05ff }
            r12.add((com.itextpdf.text.Element) r6)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r4 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r6 = r4.indentLeft     // Catch:{ Exception -> 0x05ff }
            float r7 = r2.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r6 = r6 + r7
            r4.indentLeft = r6     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r4 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r6 = r4.indentRight     // Catch:{ Exception -> 0x05ff }
            float r7 = r2.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r6 = r6 + r7
            r4.indentRight = r6     // Catch:{ Exception -> 0x05ff }
            goto L_0x03f7
        L_0x03c9:
            com.itextpdf.text.pdf.PdfLine r4 = r12.line     // Catch:{ Exception -> 0x05ff }
            float r6 = r2.getFirstLineIndent()     // Catch:{ Exception -> 0x05ff }
            r4.setExtraIndent(r6)     // Catch:{ Exception -> 0x05ff }
            float r4 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            r13.process(r12)     // Catch:{ Exception -> 0x05ff }
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            ...
            java.util.ArrayList<com.itextpdf.text.pdf.PdfLine> r4 = r12.lines     // Catch:{ Exception -> 0x05ff }
            int r4 = r4.size()     // Catch:{ Exception -> 0x05ff }
            if (r4 <= 0) goto L_0x03f7
        L_0x03e8:
            float r4 = r2.getSpacingAfter()     // Catch:{ Exception -> 0x05ff }
            float r6 = r2.getTotalLeading()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Font r7 = r2.getFont()     // Catch:{ Exception -> 0x05ff }
            r12.addSpacing(r4, r6, r7, r3)     // Catch:{ Exception -> 0x05ff }
        L_0x03f7:
            if (r5 == 0) goto L_0x0409
            boolean r4 = r12.isSectionTitle     // Catch:{ Exception -> 0x05ff }
            if (r4 != 0) goto L_0x0409
            com.itextpdf.text.pdf.PdfWriter r4 = r12.writer     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r7 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r6 = r6 - r7
            r5.onParagraphEnd(r4, r12, r6)     // Catch:{ Exception -> 0x05ff }
        L_0x0409:
            r12.alignment = r1     // Catch:{ Exception -> 0x05ff }
            java.util.ArrayList<com.itextpdf.text.Element> r1 = r12.floatingElements     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x0418
            int r1 = r1.size()     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x0418
            r12.flushFloatingElements()     // Catch:{ Exception -> 0x05ff }
        L_0x0418:
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r4 = r1.indentLeft     // Catch:{ Exception -> 0x05ff }
            float r5 = r2.getIndentationLeft()     // Catch:{ Exception -> 0x05ff }
            float r4 = r4 - r5
            r1.indentLeft = r4     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfDocument$Indentation r1 = r12.indentation     // Catch:{ Exception -> 0x05ff }
            float r4 = r1.indentRight     // Catch:{ Exception -> 0x05ff }
            float r5 = r2.getIndentationRight()     // Catch:{ Exception -> 0x05ff }
            float r4 = r4 - r5
            r1.indentRight = r4     // Catch:{ Exception -> 0x05ff }
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            r12.tabSettings = r0     // Catch:{ Exception -> 0x05ff }
            r12.popLeading()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfWriter r0 = r12.writer     // Catch:{ Exception -> 0x05ff }
            boolean r0 = isTagged(r0)     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x05f8
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r0 = r12.text     // Catch:{ Exception -> 0x05ff }
            r0.closeMCBlock(r2)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x0448:
            com.itextpdf.text.TabSettings r0 = r12.tabSettings     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Phrase r1 = (com.itextpdf.text.Phrase) r1     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.TabSettings r1 = r1.getTabSettings()     // Catch:{ Exception -> 0x05ff }
            if (r1 == 0) goto L_0x045c
            r1 = r13
            com.itextpdf.text.Phrase r1 = (com.itextpdf.text.Phrase) r1     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.TabSettings r1 = r1.getTabSettings()     // Catch:{ Exception -> 0x05ff }
            r12.tabSettings = r1     // Catch:{ Exception -> 0x05ff }
        L_0x045c:
            r1 = r13
            com.itextpdf.text.Phrase r1 = (com.itextpdf.text.Phrase) r1     // Catch:{ Exception -> 0x05ff }
            float r1 = r1.getTotalLeading()     // Catch:{ Exception -> 0x05ff }
            r12.leading = r1     // Catch:{ Exception -> 0x05ff }
            r12.pushLeading()     // Catch:{ Exception -> 0x05ff }
            r13.process(r12)     // Catch:{ Exception -> 0x05ff }
            r12.tabSettings = r0     // Catch:{ Exception -> 0x05ff }
            ...
            goto L_0x05f8
        L_0x0472:
            com.itextpdf.text.pdf.PdfLine r0 = r12.line     // Catch:{ Exception -> 0x05ff }
            if (r0 != 0) goto L_0x0479
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
        L_0x0479:
            com.itextpdf.text.pdf.PdfChunk r0 = new com.itextpdf.text.pdf.PdfChunk     // Catch:{ Exception -> 0x05ff }
            r2 = r13
            com.itextpdf.text.Chunk r2 = (com.itextpdf.text.Chunk) r2     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfAction r4 = r12.anchorAction     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.TabSettings r5 = r12.tabSettings     // Catch:{ Exception -> 0x05ff }
            r0.<init>(r2, r4, r5)     // Catch:{ Exception -> 0x05ff }
        L_0x0485:
            com.itextpdf.text.pdf.PdfLine r2 = r12.line     // Catch:{ Exception -> 0x05ff }
            float r4 = r12.leading     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfChunk r2 = r2.add(r0, r4)     // Catch:{ Exception -> 0x05ff }
            if (r2 == 0) goto L_0x049d
            r12.carriageReturn()     // Catch:{ Exception -> 0x05ff }
            boolean r0 = r0.isNewlineSplit()     // Catch:{ Exception -> 0x05ff }
            if (r0 != 0) goto L_0x049b
            r2.trimFirstSpace()     // Catch:{ Exception -> 0x05ff }
        L_0x049b:
            r0 = r2
            goto L_0x0485
        L_0x049d:
            ...
            boolean r0 = r0.isAttribute(r1)     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x05f8
            r12.newPage()     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04ac:
            r0 = r13
            com.itextpdf.text.Meta r0 = (com.itextpdf.text.Meta) r0     // Catch:{ Exception -> 0x05ff }
            java.lang.String r0 = r0.getContent()     // Catch:{ Exception -> 0x05ff }
            r12.setLanguage(r0)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04b8:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Meta r1 = (com.itextpdf.text.Meta) r1     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r1.getContent()     // Catch:{ Exception -> 0x05ff }
            r0.addCreator(r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04c6:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r0.addCreationDate()     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04cd:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r0.addProducer()     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04d4:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Meta r1 = (com.itextpdf.text.Meta) r1     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r1.getContent()     // Catch:{ Exception -> 0x05ff }
            r0.addAuthor(r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04e2:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Meta r1 = (com.itextpdf.text.Meta) r1     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r1.getContent()     // Catch:{ Exception -> 0x05ff }
            r0.addKeywords(r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04f0:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Meta r1 = (com.itextpdf.text.Meta) r1     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r1.getContent()     // Catch:{ Exception -> 0x05ff }
            r0.addSubject(r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x04fe:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Meta r1 = (com.itextpdf.text.Meta) r1     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r1.getContent()     // Catch:{ Exception -> 0x05ff }
            r0.addTitle(r1)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x050c:
            com.itextpdf.text.pdf.PdfDocument$PdfInfo r0 = r12.info     // Catch:{ Exception -> 0x05ff }
            r1 = r13
            com.itextpdf.text.Meta r1 = (com.itextpdf.text.Meta) r1     // Catch:{ Exception -> 0x05ff }
            java.lang.String r1 = r1.getName()     // Catch:{ Exception -> 0x05ff }
            r2 = r13
            com.itextpdf.text.Meta r2 = (com.itextpdf.text.Meta) r2     // Catch:{ Exception -> 0x05ff }
            java.lang.String r2 = r2.getContent()     // Catch:{ Exception -> 0x05ff }
            r0.addkey(r1, r2)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x0521:
            r0 = r13
            com.itextpdf.text.Rectangle r0 = (com.itextpdf.text.Rectangle) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r2 = r12.graphics     // Catch:{ Exception -> 0x05ff }
            r2.rectangle(r0)     // Catch:{ Exception -> 0x05ff }
            r12.pageEmpty = r1     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x052d:
            com.itextpdf.text.pdf.PdfLine r0 = r12.line     // Catch:{ Exception -> 0x05ff }
        ...
        L_0x0534:
            r0 = r13
            com.itextpdf.text.Annotation r0 = (com.itextpdf.text.Annotation) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.Rectangle r2 = new com.itextpdf.text.Rectangle     // Catch:{ Exception -> 0x05ff }
            r2.<init>(r4, r4)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfLine r4 = r12.line     // Catch:{ Exception -> 0x05ff }
            if (r4 == 0) goto L_0x057d
            com.itextpdf.text.Rectangle r2 = new com.itextpdf.text.Rectangle     // Catch:{ Exception -> 0x05ff }
            float r4 = r12.indentRight()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfLine r5 = r12.line     // Catch:{ Exception -> 0x05ff }
            float r5 = r5.widthLeft()     // Catch:{ Exception -> 0x05ff }
            float r4 = r4 - r5
            float r4 = r0.llx(r4)     // Catch:{ Exception -> 0x05ff }
            float r5 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r5 = r5 - r6
            r6 = 1101004800(0x41a00000, float:20.0)
            float r5 = r5 - r6
            float r5 = r0.ury(r5)     // Catch:{ Exception -> 0x05ff }
            float r7 = r12.indentRight()     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfLine r8 = r12.line     // Catch:{ Exception -> 0x05ff }
            float r8 = r8.widthLeft()     // Catch:{ Exception -> 0x05ff }
            float r7 = r7 - r8
            float r7 = r7 + r6
            float r6 = r0.urx(r7)     // Catch:{ Exception -> 0x05ff }
            float r7 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r8 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r7 = r7 - r8
            float r7 = r0.lly(r7)     // Catch:{ Exception -> 0x05ff }
            r2.<init>(r4, r5, r6, r7)     // Catch:{ Exception -> 0x05ff }
        L_0x057d:
            com.itextpdf.text.pdf.PdfWriter r4 = r12.writer     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfAnnotation r0 = com.itextpdf.text.pdf.internal.PdfAnnotationsImp.convertAnnotation(r4, r0, r2)     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.internal.PdfAnnotationsImp r2 = r12.annotationsImp     // Catch:{ Exception -> 0x05ff }
            r2.addPlainAnnotation(r0)     // Catch:{ Exception -> 0x05ff }
            r12.pageEmpty = r1     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x058b:
            com.itextpdf.text.pdf.PdfWriter r0 = r12.writer     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x05f8
            r1 = r13
            com.itextpdf.text.api.WriterOperation r1 = (com.itextpdf.text.api.WriterOperation) r1     // Catch:{ Exception -> 0x05ff }
            r1.write(r0, r12)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x0596:
            r0 = r13
            com.itextpdf.text.pdf.draw.DrawInterface r0 = (com.itextpdf.text.pdf.draw.DrawInterface) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.pdf.PdfContentByte r5 = r12.graphics     // Catch:{ Exception -> 0x05ff }
            float r6 = r12.indentLeft()     // Catch:{ Exception -> 0x05ff }
            float r7 = r12.indentBottom()     // Catch:{ Exception -> 0x05ff }
            float r8 = r12.indentRight()     // Catch:{ Exception -> 0x05ff }
            float r9 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r2 = r12.indentTop()     // Catch:{ Exception -> 0x05ff }
            float r10 = r12.currentHeight     // Catch:{ Exception -> 0x05ff }
            float r2 = r2 - r10
            java.util.Stack<java.lang.Float> r10 = r12.leadingStack     // Catch:{ Exception -> 0x05ff }
            int r10 = r10.size()     // Catch:{ Exception -> 0x05ff }
            if (r10 <= 0) goto L_0x05bc
            float r4 = r12.leading     // Catch:{ Exception -> 0x05ff }
        L_0x05bc:
            float r10 = r2 - r4
            r4 = r0
            r4.draw(r5, r6, r7, r8, r9, r10)     // Catch:{ Exception -> 0x05ff }
            r12.pageEmpty = r1     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x05c5:
            boolean r0 = r13 instanceof com.itextpdf.text.MarkedSection     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x05d5
            r0 = r13
            com.itextpdf.text.MarkedSection r0 = (com.itextpdf.text.MarkedSection) r0     // Catch:{ Exception -> 0x05ff }
            com.itextpdf.text.MarkedObject r0 = r0.getTitle()     // Catch:{ Exception -> 0x05ff }
            if (r0 == 0) goto L_0x05d5
            r0.process(r12)     // Catch:{ Exception -> 0x05ff }
        L_0x05d5:
            r0 = r13
            com.itextpdf.text.MarkedObject r0 = (com.itextpdf.text.MarkedObject) r0     // Catch:{ Exception -> 0x05ff }
            r0.process(r12)     // Catch:{ Exception -> 0x05ff }
            goto L_0x05f8
        L_0x05dc:
            r0 = r13
            com.itextpdf.text.pdf.PdfPTable r0 = (com.itextpdf.text.pdf.PdfPTable) r0     // Catch:{ Exception -> 0x05ff }
            int r2 = r0.size()     // Catch:{ Exception -> 0x05ff }
            int r4 = r0.getHeaderRows()     // Catch:{ Exception -> 0x05ff }
            if (r2 > r4) goto L_0x05ea
            goto L_0x05f8
        L_0x05ea:
            r12.ensureNewLine()     // Catch:{ Exception -> 0x05ff }
            r12.flushLines()     // Catch:{ Exception -> 0x05ff }
            r12.addPTable(r0)     // Catch:{ Exception -> 0x05ff }
            r12.pageEmpty = r1     // Catch:{ Exception -> 0x05ff }
            r12.newLine()     // Catch:{ Exception -> 0x05ff }
        L_0x05f8:
            int r13 = r13.type()     // Catch:{ Exception -> 0x05ff }
            r12.lastElementType = r13     // Catch:{ Exception -> 0x05ff }
            return r3
        L_0x05ff:
            r13 = move-exception
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:55:0x015a A[Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }] */
    /* JADX WARNING: Removed duplicated region for block: B:56:0x0165 A[Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }] */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x017a A[Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.util.ArrayList<com.itextpdf.text.pdf.interfaces.IAccessibleElement> endPage() {
        /*
            ...
            return r3
        L_0x000c:
            r11.flushFloatingElements()     // Catch:{ DocumentException -> 0x01a5 }
            r2 = -1
            ...
            r2.onEndPage(r4, r11)
        L_0x001f:
            r11.flushLines()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.Rectangle r2 = r11.pageSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            int r2 = r2.getRotation()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r4 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r4 = r4.isPdfIso()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r4 == 0) goto L_0x0086
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r4 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r4 = r4.containsKey(r1)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            java.lang.String r5 = "trim"
            if (r4 == 0) goto L_0x0052
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r4 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r4 = r4.containsKey(r5)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r4 != 0) goto L_0x0043
            goto L_0x0052
        L_0x0043:
            com.itextpdf.text.pdf.PdfXConformanceException r0 = new com.itextpdf.text.pdf.PdfXConformanceException     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            java.lang.String r1 = "only.one.of.artbox.or.trimbox.can.exist.in.the.page"
            r2 = 0
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (java.lang.Object[]) r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.<init>(r1)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            throw r0     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x0052:
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r4 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r1 = r4.containsKey(r1)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r1 != 0) goto L_0x0086
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r1 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r1 = r1.containsKey(r5)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r1 != 0) goto L_0x0086
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r1 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r1 = r1.containsKey(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r1 == 0) goto L_0x0074
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r1 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            java.lang.Object r0 = r1.get(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.put(r5, r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            goto L_0x0086
        L_0x0074:
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r0 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfRectangle r1 = new com.itextpdf.text.pdf.PdfRectangle     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.Rectangle r4 = r11.pageSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.Rectangle r6 = r11.pageSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            int r6 = r6.getRotation()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.<init>((com.itextpdf.text.Rectangle) r4, (int) r6)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.put(r5, r1)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x0086:
            com.itextpdf.text.pdf.PageResources r0 = r11.pageResources     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r1 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfDictionary r1 = r1.getDefaultColorspace()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.addDefaultColorDiff(r1)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r0 = r0.isRgbTransparencyBlending()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r0 == 0) goto L_0x00aa
            com.itextpdf.text.pdf.PdfDictionary r0 = new com.itextpdf.text.pdf.PdfDictionary     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.<init>()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfName r1 = com.itextpdf.text.pdf.PdfName.f1281CS     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfName r4 = com.itextpdf.text.pdf.PdfName.DEVICERGB     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.put(r1, r4)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PageResources r1 = r11.pageResources     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.addDefaultColorDiff(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x00aa:
            com.itextpdf.text.pdf.PageResources r0 = r11.pageResources     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfDictionary r0 = r0.getResources()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfPage r1 = new com.itextpdf.text.pdf.PdfPage     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfRectangle r4 = new com.itextpdf.text.pdf.PdfRectangle     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.Rectangle r5 = r11.pageSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r4.<init>((com.itextpdf.text.Rectangle) r5, (int) r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            java.util.HashMap<java.lang.String, com.itextpdf.text.pdf.PdfRectangle> r5 = r11.thisBoxSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.<init>(r4, r5, r0, r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r0 = isTagged(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r0 == 0) goto L_0x00ce
            com.itextpdf.text.pdf.PdfName r0 = com.itextpdf.text.pdf.PdfName.TABS     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfName r2 = com.itextpdf.text.pdf.PdfName.f1357S     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.put(r0, r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            goto L_0x00d9
        L_0x00ce:
            com.itextpdf.text.pdf.PdfName r0 = com.itextpdf.text.pdf.PdfName.TABS     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r2 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfName r2 = r2.getTabs()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.put(r0, r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x00d9:
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfDictionary r0 = r0.getPageDictEntries()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.putAll(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.resetPageDictEntries()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfDictionary r0 = r11.pageAA     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r0 == 0) goto L_0x00fe
            com.itextpdf.text.pdf.PdfName r0 = com.itextpdf.text.pdf.PdfName.f1261AA     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r2 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfDictionary r4 = r11.pageAA     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfIndirectObject r2 = r2.addToBody(r4)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfIndirectReference r2 = r2.getIndirectReference()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.put(r0, r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r11.pageAA = r3     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x00fe:
            com.itextpdf.text.pdf.internal.PdfAnnotationsImp r0 = r11.annotationsImp     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r0 = r0.hasUnusedAnnotations()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r0 == 0) goto L_0x011b
            com.itextpdf.text.pdf.internal.PdfAnnotationsImp r0 = r11.annotationsImp     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r2 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.Rectangle r4 = r11.pageSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfArray r0 = r0.rotateAnnotations(r2, r4)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            int r2 = r0.size()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r2 == 0) goto L_0x011b
            com.itextpdf.text.pdf.PdfName r2 = com.itextpdf.text.pdf.PdfName.ANNOTS     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.put(r2, r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x011b:
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r0 = isTagged(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r0 == 0) goto L_0x0137
            com.itextpdf.text.pdf.PdfName r0 = com.itextpdf.text.pdf.PdfName.STRUCTPARENTS     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfNumber r2 = new com.itextpdf.text.pdf.PdfNumber     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r4 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfIndirectReference r4 = r4.getCurrentPage()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            int r4 = r11.getStructParentIndex(r4)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r2.<init>((int) r4)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.put(r0, r2)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x0137:
            com.itextpdf.text.pdf.PdfContentByte r0 = r11.text     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            int r0 = r0.size()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            int r2 = r11.textEmptySize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            ...
            goto L_0x014d
        L_0x014a:
            r11.text = r3     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            goto L_0x0152
        L_0x014d:
            com.itextpdf.text.pdf.PdfContentByte r0 = r11.text     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r0.endText()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x0152:
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r0 = isTagged(r0)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r0 == 0) goto L_0x0165
            com.itextpdf.text.pdf.PdfWriter r0 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfContentByte r0 = r0.getDirectContent()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            java.util.ArrayList r0 = r0.saveMCBlocks()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            goto L_0x0166
        L_0x0165:
            r0 = r3
        L_0x0166:
            com.itextpdf.text.pdf.PdfWriter r2 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfContents r10 = new com.itextpdf.text.pdf.PdfContents     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r4 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfContentByte r5 = r4.getDirectContentUnder()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfContentByte r6 = r11.graphics     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r4 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            boolean r4 = isTagged(r4)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            if (r4 != 0) goto L_0x017c
            com.itextpdf.text.pdf.PdfContentByte r3 = r11.text     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
        L_0x017c:
            r7 = r3
            com.itextpdf.text.pdf.PdfWriter r3 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfContentByte r8 = r3.getDirectContent()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.Rectangle r9 = r11.pageSize     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r4 = r10
            r4.<init>(r5, r6, r7, r8, r9)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r2.add((com.itextpdf.text.pdf.PdfPage) r1, (com.itextpdf.text.pdf.PdfContents) r10)     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.internal.PdfAnnotationsImp r1 = r11.annotationsImp     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.resetAnnotations()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            com.itextpdf.text.pdf.PdfWriter r1 = r11.writer     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            r1.resetContent()     // Catch:{ DocumentException -> 0x019e, IOException -> 0x0197 }
            return r0
        L_0x0197:
            r0 = move-exception
    ...
    /* JADX WARNING: Removed duplicated region for block: B:285:0x0813  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:323:0x0918  */
    /* JADX WARNING: Removed duplicated region for block: B:325:0x091e  */
    /* JADX WARNING: Removed duplicated region for block: B:328:0x0927  */
    /* JADX WARNING: Removed duplicated region for block: B:333:0x093b  */
    /* JADX WARNING: Removed duplicated region for block: B:334:0x093e  */
    /* JADX WARNING: Removed duplicated region for block: B:336:0x0947  */
    /* JADX WARNING: Removed duplicated region for block: B:350:0x0993  */
    /* JADX WARNING: Removed duplicated region for block: B:355:0x09a5  */
    ...
    public float writeLineToContent(com.itextpdf.text.pdf.PdfLine r61, com.itextpdf.text.pdf.PdfContentByte r62, com.itextpdf.text.pdf.PdfContentByte r63, java.lang.Object[] r64, float r65) throws com.itextpdf.text.DocumentException {
        ...
        L_0x076b:
            ...
            r8 = r43
            int r5 = r5.compareTo((com.itextpdf.text.pdf.PdfFont) r8)
        ...
        L_0x07f7:
            ...
            r2.setTextRise((float) r8)
        L_0x07fe:
            boolean r13 = r9.isImage()
            ...
            goto L_0x090a
        L_0x0813:
            boolean r13 = r9.isHorizontalSeparator()
            r16 = 1148846080(0x447a0000, float:1000.0)
            if (r13 == 0) goto L_0x0834
            com.itextpdf.text.pdf.PdfTextArray r13 = new com.itextpdf.text.pdf.PdfTextArray
            r13.<init>()
            r0 = r55
            float r14 = -r0
            float r14 = r14 * r16
            ...
            float r14 = r14 / r11
            r13.add((float) r14)
            r2.showText((com.itextpdf.text.pdf.PdfTextArray) r13)
            goto L_0x0857
        L_0x0834:
            r0 = r55
            boolean r3 = r9.isTab()
            ...
            float r13 = r13 / r11
            r3.add((float) r13)
            r2.showText((com.itextpdf.text.pdf.PdfTextArray) r3)
        L_0x0857:
            r23 = r0
            r16 = r1
            r18 = r5
        ...
        L_0x088d:
            ...
            r2.showText((java.lang.String) r14)
            r16 = r1
            r18 = r5
            goto L_0x0861
        L_0x08a3:
        ...
        L_0x08d2:
            ...
            r1.add((java.lang.String) r0)
            r2.showText((com.itextpdf.text.pdf.PdfTextArray) r1)
            goto L_0x0861
        L_0x08e0:
            r23 = r0
            r16 = r1
        ...
        L_0x0901:
            ...
            r2.showText((java.lang.String) r0)
            goto L_0x0861
        L_0x090a:
            int r1 = (r8 > r0 ? 1 : (r8 == r0 ? 0 : -1))
            if (r1 == 0) goto L_0x0911
            r2.setTextRise((float) r0)
        L_0x0911:
    ...
    public void addJavaScript(PdfAction pdfAction) {
        if (pdfAction.get(PdfName.f1319JS) != null) {
            try {
