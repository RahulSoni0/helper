...
public class BarcodeEANSUPP extends Barcode {
    ...
    public Rectangle getBarcodeSize() {
        ...
        barcodeSize.setRight(barcodeSize.getWidth() + this.supp.getBarcodeSize().getWidth() + this.f1218n);
        return barcodeSize;
    }
    ...
    public Rectangle placeBarcode(PdfContentByte pdfContentByte, BaseColor baseColor, BaseColor baseColor2) {
        ...
        pdfContentByte.saveState();
        pdfContentByte.concatCTM(1.0f, 0.0f, 0.0f, 1.0f, barcodeSize.getWidth() + this.f1218n, barcodeSize.getHeight() - this.ean.getBarHeight());
