...
public class GifImage {
    ...
    /* renamed from: ih */
    protected int f1416ih;

    /* renamed from: in */
    protected DataInputStream f1417in;
    protected boolean interlace;

    /* renamed from: iw */
    protected int f1418iw;

    /* renamed from: ix */
    protected int f1419ix;

    /* renamed from: iy */
    protected int f1420iy;
    ...
    public int[] getFramePosition(int i) {
        ...
        return new int[]{gifFrame.f1421ix, gifFrame.f1422iy};
    }
    ...
    public void process(InputStream inputStream) throws IOException {
        this.f1417in = new DataInputStream(new BufferedInputStream(inputStream));
        readHeader();
        readContents();
    ...
    public void readHeader() throws IOException {
        ...
        for (int i = 0; i < 6; i++) {
            sb.append((char) this.f1417in.read());
        }
    ...
    public void readLSD() throws IOException {
        ...
        int read = this.f1417in.read();
        this.gctFlag = (read & 128) != 0;
        this.m_gbpc = (read & 7) + 1;
        this.bgIndex = this.f1417in.read();
        this.pixelAspect = this.f1417in.read();
    }

    /* access modifiers changed from: protected */
    public int readShort() throws IOException {
        return this.f1417in.read() | (this.f1417in.read() << 8);
    }
    ...
    public int readBlock() throws IOException {
        ...
        int read2 = this.f1417in.read(this.block, 0, read);
    ...
    public byte[] readColorTable(int i) throws IOException {
        ...
        this.f1417in.readFully(bArr, 0, (1 << i) * 3);
        return bArr;
    }
    ...
    public void readImage() throws IOException {
        this.f1419ix = readShort();
        this.f1420iy = readShort();
        this.f1418iw = readShort();
        this.f1416ih = readShort();
        int read = this.f1417in.read();
        ...
        try {
            ImgRaw imgRaw = new ImgRaw(this.f1418iw, this.f1416ih, 1, this.m_bpc, this.m_out);
            ...
            gifFrame.f1421ix = this.f1419ix;
            gifFrame.f1422iy = this.f1420iy;
    ...
    public void setPixel(int i, int i2, int i3) {
        int i4 = this.m_bpc;
        if (i4 == 8) {
            this.m_out[i + (this.f1418iw * i2)] = (byte) i3;
            return;
        }
    ...
    public void readGraphicControlExt() throws IOException {
        ...
        this.transIndex = this.f1417in.read();
        this.f1417in.read();
    }
