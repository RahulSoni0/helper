...
public class PngImage {
    ...
    public void readPng() throws IOException {
        ...
        while (true) {
            ...
            if (i >= iArr.length) {
                ...
                while (true) {
                    int i3 = getInt(this.f1425is);
                    String string = getString(this.f1425is);
                    if (i3 >= 0 && checkMarker(string)) {
                        if (IDAT.equals(string)) {
                            while (i3 != 0) {
                                int read = this.f1425is.read(bArr, 0, Math.min(i3, i2));
                                if (read >= 0) {
                            ...
                            if (i4 != 0) {
                                if (i4 != 2) {
                                    if (i4 == 3 && i3 > 0) {
                                        ...
                                        for (int i5 = 0; i5 < i3; i5++) {
                                            this.trans[i5] = (byte) this.f1425is.read();
                                        }
                                        i3 = 0;
                                    }
                                } else if (i3 >= 6) {
                                    i3 -= 6;
                                    int word = getWord(this.f1425is);
                                    int word2 = getWord(this.f1425is);
                                    int word3 = getWord(this.f1425is);
                                    if (this.bitDepth == 16) {
                                ...
                                i3 -= 2;
                                int word4 = getWord(this.f1425is);
                                if (this.bitDepth == 16) {
                            ...
                            Utilities.skip(this.f1425is, i3);
                        } else if (IHDR.equals(string)) {
                            this.width = getInt(this.f1425is);
                            this.height = getInt(this.f1425is);
                            this.bitDepth = this.f1425is.read();
                            this.colorType = this.f1425is.read();
                            this.compressionMethod = this.f1425is.read();
                            this.filterMethod = this.f1425is.read();
                            this.interlaceMethod = this.f1425is.read();
                        } else {
                            boolean z = true;
                            if (PLTE.equals(string)) {
                                if (this.colorType == 3) {
                                    ...
                                    while (true) {
                                        ...
                                        byteBuffer.append_i(this.f1425is.read());
                                        i3 = i6;
                                    }
                                ...
                                int i7 = getInt(this.f1425is);
                                int i8 = getInt(this.f1425is);
                                if (this.f1425is.read() == 1) {
                                ...
                                this.f1429xW = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1433yW = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1428xR = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1432yR = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1427xG = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1431yG = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1426xB = ((float) getInt(this.f1425is)) / 100000.0f;
                                this.f1430yB = ((float) getInt(this.f1425is)) / 100000.0f;
                                if (Math.abs(this.f1429xW) < 1.0E-4f || Math.abs(this.f1433yW) < 1.0E-4f || Math.abs(this.f1428xR) < 1.0E-4f || Math.abs(this.f1432yR) < 1.0E-4f || Math.abs(this.f1427xG) < 1.0E-4f || Math.abs(this.f1431yG) < 1.0E-4f || Math.abs(this.f1426xB) < 1.0E-4f || Math.abs(this.f1430yB) < 1.0E-4f) {
                                    z = false;
                                }
                                this.hasCHRM = z;
                            } else if (sRGB.equals(string)) {
                                this.intent = intents[this.f1425is.read()];
                                this.gamma = 2.2f;
                                this.f1429xW = 0.3127f;
                                this.f1433yW = 0.329f;
                                this.f1428xR = 0.64f;
                                this.f1432yR = 0.33f;
                                this.f1427xG = 0.3f;
                                ...
                                do {
                                    i3--;
                                } while (this.f1425is.read() != 0);
                                this.f1425is.read();
                                int i10 = i3 - 1;
                                byte[] bArr2 = new byte[i10];
                                int i11 = 0;
                                while (i10 > 0) {
                                    int read2 = this.f1425is.read(bArr2, i11, i10);
                                    if (read2 >= 0) {
                                        i11 += read2;
                                        i10 -= read2;
                                    } else {
    ...
    public com.itextpdf.text.pdf.PdfObject getColorspace() {
        ...
        L_0x008f:
            ...
            float r9 = r0.f1428xR
            float r10 = r9 - r6
            float r11 = r0.f1431yG
            float r10 = r10 * r11
            float r7 = r7 - r10
            float r10 = r9 - r5
            float r12 = r0.f1430yB
            float r10 = r10 * r12
            float r7 = r7 + r10
            float r7 = r7 * r4
            float r10 = r5 - r6
            float r10 = r10 * r4
            float r13 = r0.f1429xW
            float r14 = r13 - r6
            float r14 = r14 * r11
            float r10 = r10 - r14
            float r14 = r13 - r5
