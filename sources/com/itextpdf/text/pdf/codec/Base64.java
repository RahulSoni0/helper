...
public class Base64 {
    ...
    static {
        ...
        byte[] bArr2 = new byte[WorkQueueKt.MASK];
        // fill-array-data instruction
        bArr2[0] = -9;
        bArr2[1] = -9;
        bArr2[2] = -9;
        ...
        byte[] bArr3 = new byte[WorkQueueKt.MASK];
        // fill-array-data instruction
        bArr3[0] = -9;
        bArr3[1] = -9;
        bArr3[2] = -9;
    ...
    public static int decode4to3(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        int i4 = i + 2;
        if (bArr[i4] == 61) {
            bArr2[i2] = (byte) ((((decodabet[bArr[i + 1]] & 255) << BidiOrder.f1235CS) | ((decodabet[bArr[i]] & 255) << 18)) >>> 16);
            return 1;
        }
        int i5 = i + 3;
        if (bArr[i5] == 61) {
            int i6 = (decodabet[bArr[i + 1]] & 255) << BidiOrder.f1235CS;
        ...
        try {
            byte b = ((decodabet[bArr[i]] & 255) << 18) | ((decodabet[bArr[i + 1]] & 255) << BidiOrder.f1235CS) | ((decodabet[bArr[i4]] & 255) << 6) | (decodabet[bArr[i5]] & 255);
            bArr2[i2] = (byte) (b >> BidiOrder.f1242S);
            bArr2[i2 + 1] = (byte) (b >> 8);
            bArr2[i2 + 2] = (byte) b;
            return 3;
    ...
    public static java.lang.String encodeFromFile(java.lang.String r7) {
        ...
        L_0x0048:
            r3 = r0
        L_0x0049:
            java.io.PrintStream r1 = java.lang.System.err     // Catch:{ all -> 0x0063 }
            ...
            r2.append(r7)     // Catch:{ all -> 0x0063 }
            java.lang.String r7 = r2.toString()     // Catch:{ all -> 0x0063 }
            r1.println(r7)     // Catch:{ all -> 0x0063 }
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int i) throws IOException {
            if (this.suspendEncoding) {
                ...
                if (i3 >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f1415b4, this.buffer, this.bufferLength, this.options));
                ...
                if (bArr2[i5] > -5) {
                    ...
                    if (i7 >= this.bufferLength) {
                        this.out.write(this.f1415b4, 0, Base64.decode4to3(bArr3, 0, this.f1415b4, 0, this.options));
                        this.position = 0;
                    }
                } else if (bArr2[i5] != -5) {
        ...
        public void flushBase64() throws IOException {
            ...
            if (this.encode) {
                this.out.write(Base64.encode3to4(this.f1415b4, this.buffer, this.position, this.options));
                this.position = 0;
                return;
            }
