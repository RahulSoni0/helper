...
public class JBIG2SegmentReader {
    ...
    /* renamed from: ra */
    private RandomAccessFileOrArray f1423ra;
    ...
    public static class JBIG2Page {
        ...
        /* renamed from: sr */
        private final JBIG2SegmentReader f1424sr;

        public JBIG2Page(int i, JBIG2SegmentReader jBIG2SegmentReader) {
            this.page = i;
            this.f1424sr = jBIG2SegmentReader;
        }
    ...
    public JBIG2SegmentReader(RandomAccessFileOrArray randomAccessFileOrArray) throws IOException {
        this.f1423ra = randomAccessFileOrArray;
    }
    ...
    public void read() throws IOException {
        ...
        if (!this.read) {
            ...
            if (this.sequential) {
                ...
                } while (this.f1423ra.getFilePointer() < this.f1423ra.length());
                return;
            }
            do {
    ...
    public void readSegment(JBIG2Segment jBIG2Segment) throws IOException {
        int filePointer = (int) this.f1423ra.getFilePointer();
        if (jBIG2Segment.dataLength != 4294967295L) {
            byte[] bArr = new byte[((int) jBIG2Segment.dataLength)];
            this.f1423ra.read(bArr);
            jBIG2Segment.data = bArr;
            if (jBIG2Segment.type == 48) {
                int filePointer2 = (int) this.f1423ra.getFilePointer();
                this.f1423ra.seek((long) filePointer);
                int readInt = this.f1423ra.readInt();
                int readInt2 = this.f1423ra.readInt();
                this.f1423ra.seek((long) filePointer2);
    ...
    public JBIG2Segment readHeader() throws IOException {
        ...
        for (int i8 = 1; i8 <= i2; i8++) {
            if (readInt <= 256) {
                iArr[i8] = this.f1423ra.read();
            } else if (readInt <= 65536) {
                iArr[i8] = this.f1423ra.readUnsignedShort();
            } else {
                iArr[i8] = (int) this.f1423ra.readUnsignedInt();
            }
        }
        jBIG2Segment.referredToSegmentNumbers = iArr;
        int filePointer2 = ((int) this.f1423ra.getFilePointer()) - filePointer;
        if (z) {
            i = this.f1423ra.readInt();
        } else {
            i = this.f1423ra.read();
        }
        if (i >= 0) {
            ...
            jBIG2Segment.dataLength = this.f1423ra.readUnsignedInt();
            int filePointer3 = (int) this.f1423ra.getFilePointer();
            this.f1423ra.seek((long) filePointer);
    ...
    public void readFileHeader() throws IOException {
        ...
        if ((read2 & 252) != 0) {
            ...
            this.number_of_pages = this.f1423ra.readInt();
        }
    }
