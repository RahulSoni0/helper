...
public class TiffImage {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:103:0x01cd A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:150:0x031b A[SYNTHETIC, Splitter:B:150:0x031b] */
    /* JADX WARNING: Removed duplicated region for block: B:159:0x033a A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:31:0x007e A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0084 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:35:0x009b A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00a6 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x00b1 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:43:0x00b7 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00ba A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:62:0x0107 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:63:0x010e A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:68:0x0124 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x0126 A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:72:0x012c A[Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    /* JADX WARNING: Removed duplicated region for block: B:98:0x018a A[ADDED_TO_REGION, Catch:{ RuntimeException -> 0x0276, InvalidImageException -> 0x0233, Exception -> 0x034d }] */
    ...
    public static com.itextpdf.text.Image getTiffImage(com.itextpdf.text.pdf.RandomAccessFileOrArray r46, boolean r47, int r48, boolean r49) {
        ...
        L_0x0188:
            ...
            r20 = r22
            r21 = r0
            com.itextpdf.text.Image r0 = com.itextpdf.text.Image.getInstance((int) r16, (int) r17, (boolean) r18, (int) r19, (int) r20, (byte[]) r21)     // Catch:{ Exception -> 0x034d }
            r2 = 1
        ...
        L_0x0233:
            ...
            goto L_0x0230
        L_0x0238:
            r6.fax4Encode(r3, r5)     // Catch:{ Exception -> 0x034d }
            r4 = r6
            goto L_0x0267
        L_0x023d:
            throw r6     // Catch:{ Exception -> 0x034d }
        L_0x023e:
            r4 = r49
            r34 = 0
            r31 = r6
        ...
        L_0x0264:
            r4.fax4Encode(r3, r5)     // Catch:{ Exception -> 0x034d }
        L_0x0267:
            r30 = r9
            r31 = r10
            r10 = r26
        ...
        L_0x0276:
            ...
            r2 = 0
            r3 = r10[r2]     // Catch:{ Exception -> 0x034d }
            int r0 = (int) r3     // Catch:{ Exception -> 0x034d }
            byte[] r0 = new byte[r0]     // Catch:{ Exception -> 0x034d }
            r2 = r9[r2]     // Catch:{ Exception -> 0x034d }
            r11.seek(r2)     // Catch:{ Exception -> 0x034d }
            r11.readFully(r0)     // Catch:{ Exception -> 0x034d }
            r18 = 0
            r16 = r13
            r17 = r43
            r19 = r15
            ...
            com.itextpdf.text.Image r0 = com.itextpdf.text.Image.getInstance((int) r16, (int) r17, (boolean) r18, (int) r19, (int) r20, (byte[]) r21)     // Catch:{ Exception -> 0x034d }
            r1 = 1
            r0.setInverted(r1)     // Catch:{ Exception -> 0x034d }
            r1 = r41
            r2 = r42
            r0.setDpi(r1, r2)     // Catch:{ Exception -> 0x034d }
            r1 = r40
            r0.setXYRatio(r1)     // Catch:{ Exception -> 0x034d }
            r1 = 5
            r0.setOriginalType(r1)     // Catch:{ Exception -> 0x034d }
            r1 = 0
            int r1 = (r26 > r1 ? 1 : (r26 == r1 ? 0 : -1))
            if (r1 == 0) goto L_0x02b7
            r1 = r26
            r0.setInitialRotation(r1)     // Catch:{ Exception -> 0x034d }
        L_0x02b7:
            return r0
        L_0x02b8:
            throw r38     // Catch:{ Exception -> 0x034d }
        L_0x02b9:
            throw r38     // Catch:{ Exception -> 0x034d }
        L_0x02ba:
            r4 = r49
            ...
            r11 = 0
        L_0x02cb:
            r6.decode1D(r3, r14, r11, r5)     // Catch:{ Exception -> 0x034d }
            r4.fax4Encode(r3, r5)     // Catch:{ Exception -> 0x034d }
        L_0x02d1:
            int r1 = r1 - r8
            int r12 = r12 + 1
        ...
        L_0x02ed:
            ...
            r9 = r40
            r2 = r41
            byte[] r21 = r4.close()     // Catch:{ Exception -> 0x034d }
            r18 = 0
            ...
            com.itextpdf.text.Image r0 = com.itextpdf.text.Image.getInstance((int) r16, (int) r17, (boolean) r18, (int) r19, (int) r20, (byte[]) r21)     // Catch:{ Exception -> 0x034d }
        L_0x030a:
            r0.setDpi(r2, r7)     // Catch:{ Exception -> 0x034d }
            r0.setXYRatio(r9)     // Catch:{ Exception -> 0x034d }
            r1 = 34675(0x8773, float:4.859E-41)
            r2 = r23
            boolean r3 = r2.isTagPresent(r1)     // Catch:{ Exception -> 0x034d }
        ...
        L_0x0331:
            ...
            r0.setInitialRotation(r10)     // Catch:{ Exception -> 0x034d }
        L_0x033d:
            return r0
        L_0x033e:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ Exception -> 0x034d }
            java.lang.String r1 = "tiles.are.not.supported"
            r2 = 0
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ Exception -> 0x034d }
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (java.lang.Object[]) r2)     // Catch:{ Exception -> 0x034d }
            r0.<init>(r1)     // Catch:{ Exception -> 0x034d }
            throw r0     // Catch:{ Exception -> 0x034d }
        L_0x034d:
            r0 = move-exception
    ...
    /* JADX WARNING: Removed duplicated region for block: B:100:0x0190 A[Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:116:0x01c3 A[Catch:{ Exception -> 0x04f2 }] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:126:0x01f1 A[ADDED_TO_REGION, Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:135:0x0218 A[Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:136:0x0224 A[Catch:{ Exception -> 0x04f2 }] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:235:0x0433 A[Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:252:0x04cb A[Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:255:0x04d3 A[Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:257:0x04da A[Catch:{ Exception -> 0x04f2 }] */
    ...
    protected static com.itextpdf.text.Image getTiffImageColor(com.itextpdf.text.pdf.codec.TIFFDirectory r39, com.itextpdf.text.pdf.RandomAccessFileOrArray r40) {
        ...
        L_0x0026:
            ...
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (int) r3)     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x004a:
            ...
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (int) r11)     // Catch:{ Exception -> 0x04f2 }
            r0.<init>(r1)     // Catch:{ Exception -> 0x04f2 }
            throw r0     // Catch:{ Exception -> 0x04f2 }
        L_0x0056:
        ...
        L_0x0095:
            ...
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (java.lang.Object[]) r2)     // Catch:{ Exception -> 0x04f2 }
            r0.<init>(r1)     // Catch:{ Exception -> 0x04f2 }
            throw r0     // Catch:{ Exception -> 0x04f2 }
        L_0x00a3:
        ...
        L_0x00d4:
            ...
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (int) r5)     // Catch:{ Exception -> 0x04f2 }
            r0.<init>(r1)     // Catch:{ Exception -> 0x04f2 }
            throw r0     // Catch:{ Exception -> 0x04f2 }
        L_0x00e0:
        ...
        L_0x01b3:
            ...
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (int) r15)     // Catch:{ Exception -> 0x04f2 }
            r0.<init>(r1)     // Catch:{ Exception -> 0x04f2 }
            throw r0     // Catch:{ Exception -> 0x04f2 }
        L_0x01bf:
            r15 = r27
        ...
        L_0x0252:
            ...
            r1.<init>((byte[]) r7)     // Catch:{ Exception -> 0x04f2 }
            goto L_0x02e7
        L_0x026c:
        ...
        L_0x02ee:
            ...
            int r2 = r9.length     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r1 = com.itextpdf.text.error_messages.MessageLocalization.getComposedMessage((java.lang.String) r1, (int) r2)     // Catch:{ Exception -> 0x04f2 }
            r0.<init>(r1)     // Catch:{ Exception -> 0x04f2 }
            throw r0     // Catch:{ Exception -> 0x04f2 }
        L_0x02fb:
            r7 = 0
        ...
        L_0x03d6:
            ...
            r19 = r0
            r20 = r32
            com.itextpdf.text.Image r2 = com.itextpdf.text.Image.getInstance((int) r19, (int) r20, (boolean) r21, (int) r22, (int) r23, (byte[]) r24)     // Catch:{ Exception -> 0x04f2 }
            goto L_0x03fd
        L_0x03e3:
        ...
        L_0x03fd:
            ...
            com.itextpdf.text.pdf.ICC_Profile r3 = com.itextpdf.text.pdf.ICC_Profile.getInstance((byte[]) r3)     // Catch:{ RuntimeException -> 0x042b }
            int r6 = r6 - r14
        ...
        L_0x042b:
            ...
            boolean r3 = r4.isTagPresent(r3)     // Catch:{ Exception -> 0x04f2 }
            if (r3 == 0) goto L_0x04c5
            r3 = 320(0x140, float:4.48E-43)
            com.itextpdf.text.pdf.codec.TIFFField r3 = r4.getField(r3)     // Catch:{ Exception -> 0x04f2 }
            char[] r3 = r3.getAsChars()     // Catch:{ Exception -> 0x04f2 }
            int r4 = r3.length     // Catch:{ Exception -> 0x04f2 }
            byte[] r5 = new byte[r4]     // Catch:{ Exception -> 0x04f2 }
            int r6 = r3.length     // Catch:{ Exception -> 0x04f2 }
            r7 = 3
            int r6 = r6 / r7
            int r7 = r6 * 2
            r8 = 0
        L_0x0446:
            ...
            int r9 = r8 * 3
            char r10 = r3[r8]     // Catch:{ Exception -> 0x04f2 }
            r11 = 8
            int r10 = r10 >>> r11
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            r5[r9] = r10     // Catch:{ Exception -> 0x04f2 }
            int r10 = r9 + 1
            int r12 = r8 + r6
            char r12 = r3[r12]     // Catch:{ Exception -> 0x04f2 }
            int r12 = r12 >>> r11
            byte r12 = (byte) r12     // Catch:{ Exception -> 0x04f2 }
            r5[r10] = r12     // Catch:{ Exception -> 0x04f2 }
            int r9 = r9 + 2
            int r10 = r8 + r7
            char r10 = r3[r10]     // Catch:{ Exception -> 0x04f2 }
            int r10 = r10 >>> r11
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            r5[r9] = r10     // Catch:{ Exception -> 0x04f2 }
            int r8 = r8 + 1
        ...
        L_0x046a:
            ...
            byte r9 = r5[r8]     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x0479:
            ...
            int r8 = r4 * 3
            char r9 = r3[r4]     // Catch:{ Exception -> 0x04f2 }
            byte r9 = (byte) r9     // Catch:{ Exception -> 0x04f2 }
            r5[r8] = r9     // Catch:{ Exception -> 0x04f2 }
            int r9 = r8 + 1
            int r10 = r4 + r6
            char r10 = r3[r10]     // Catch:{ Exception -> 0x04f2 }
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            ...
            int r8 = r8 + 2
            int r9 = r4 + r7
            char r9 = r3[r9]     // Catch:{ Exception -> 0x04f2 }
            byte r9 = (byte) r9     // Catch:{ Exception -> 0x04f2 }
            r5[r8] = r9     // Catch:{ Exception -> 0x04f2 }
            int r4 = r4 + 1
            goto L_0x0479
        L_0x0497:
            com.itextpdf.text.pdf.PdfArray r3 = new com.itextpdf.text.pdf.PdfArray     // Catch:{ Exception -> 0x04f2 }
            r3.<init>()     // Catch:{ Exception -> 0x04f2 }
            com.itextpdf.text.pdf.PdfName r4 = com.itextpdf.text.pdf.PdfName.INDEXED     // Catch:{ Exception -> 0x04f2 }
            r3.add((com.itextpdf.text.pdf.PdfObject) r4)     // Catch:{ Exception -> 0x04f2 }
            com.itextpdf.text.pdf.PdfName r4 = com.itextpdf.text.pdf.PdfName.DEVICERGB     // Catch:{ Exception -> 0x04f2 }
            r3.add((com.itextpdf.text.pdf.PdfObject) r4)     // Catch:{ Exception -> 0x04f2 }
            com.itextpdf.text.pdf.PdfNumber r4 = new com.itextpdf.text.pdf.PdfNumber     // Catch:{ Exception -> 0x04f2 }
            r7 = 1
            int r6 = r6 - r7
            r4.<init>((int) r6)     // Catch:{ Exception -> 0x04f2 }
            r3.add((com.itextpdf.text.pdf.PdfObject) r4)     // Catch:{ Exception -> 0x04f2 }
            com.itextpdf.text.pdf.PdfString r4 = new com.itextpdf.text.pdf.PdfString     // Catch:{ Exception -> 0x04f2 }
            r4.<init>((byte[]) r5)     // Catch:{ Exception -> 0x04f2 }
            r3.add((com.itextpdf.text.pdf.PdfObject) r4)     // Catch:{ Exception -> 0x04f2 }
            com.itextpdf.text.pdf.PdfDictionary r4 = new com.itextpdf.text.pdf.PdfDictionary     // Catch:{ Exception -> 0x04f2 }
            r4.<init>()     // Catch:{ Exception -> 0x04f2 }
            com.itextpdf.text.pdf.PdfName r5 = com.itextpdf.text.pdf.PdfName.COLORSPACE     // Catch:{ Exception -> 0x04f2 }
            r4.put(r5, r3)     // Catch:{ Exception -> 0x04f2 }
            r2.setAdditional(r4)     // Catch:{ Exception -> 0x04f2 }
        L_0x04c5:
            r3 = 5
            r2.setOriginalType(r3)     // Catch:{ Exception -> 0x04f2 }
        L_0x04c9:
            if (r1 != 0) goto L_0x04cf
            r1 = 1
            r2.setInverted(r1)     // Catch:{ Exception -> 0x04f2 }
        L_0x04cf:
            int r1 = (r28 > r16 ? 1 : (r28 == r16 ? 0 : -1))
            if (r1 == 0) goto L_0x04d8
            r13 = r28
            r2.setInitialRotation(r13)     // Catch:{ Exception -> 0x04f2 }
        L_0x04d8:
            if (r14 <= 0) goto L_0x04f1
            r35.close()     // Catch:{ Exception -> 0x04f2 }
            byte[] r1 = r31.toByteArray()     // Catch:{ Exception -> 0x04f2 }
            r3 = r32
            r4 = 1
            com.itextpdf.text.Image r0 = com.itextpdf.text.Image.getInstance(r0, r3, r4, r15, r1)     // Catch:{ Exception -> 0x04f2 }
            r0.makeMask()     // Catch:{ Exception -> 0x04f2 }
            r0.setDeflated(r4)     // Catch:{ Exception -> 0x04f2 }
            r2.setImageMask(r0)     // Catch:{ Exception -> 0x04f2 }
        L_0x04f1:
            return r2
        L_0x04f2:
            r0 = move-exception
