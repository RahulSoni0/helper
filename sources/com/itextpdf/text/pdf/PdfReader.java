...
public class PdfReader implements PdfViewerPreferences {
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (!this.encrypted && (pdfObject = this.trailer.get(PdfName.ENCRYPT)) != null && !pdfObject.toString().equals("null")) {
            ...
            PdfDictionary asDict2 = pdfDictionary.getAsDict(PdfName.f1277CF);
            if (asDict2 == null || (asDict = asDict2.getAsDict(PdfName.STDCF)) == null || (asName = asDict.getAsName(PdfName.AUTHEVENT)) == null || asName.compareTo(PdfName.EFOPEN) != 0 || this.ownerPasswordUsed) {
                PdfArray asArray = this.trailer.getAsArray(PdfName.f1315ID);
                if (asArray != null) {
                ...
                if (pdfObjectRelease.equals(PdfName.STANDARD)) {
                    String pdfObject3 = pdfDictionary.get(PdfName.f1375U).toString();
                    this.strings.remove(pdfDictionary.get(PdfName.f1375U));
                    byte[] iSOBytes = DocWriter.getISOBytes(pdfObject3);
                    String pdfObject4 = pdfDictionary.get(PdfName.f1332O).toString();
                    this.strings.remove(pdfDictionary.get(PdfName.f1332O));
                    byte[] iSOBytes2 = DocWriter.getISOBytes(pdfObject4);
                    if (pdfDictionary.contains(PdfName.f1334OE)) {
                        this.strings.remove(pdfDictionary.get(PdfName.f1334OE));
                    }
                    if (pdfDictionary.contains(PdfName.f1376UE)) {
                        this.strings.remove(pdfDictionary.get(PdfName.f1376UE));
                    }
                    if (pdfDictionary.contains(PdfName.PERMS)) {
                        this.strings.remove(pdfDictionary.get(PdfName.PERMS));
                    }
                    PdfObject pdfObject5 = pdfDictionary.get(PdfName.f1338P);
                    if (pdfObject5.isNumber()) {
                        byte[] bArr6 = iSOBytes;
                        this.pValue = ((PdfNumber) pdfObject5).longValue();
                        PdfObject pdfObject6 = pdfDictionary.get(PdfName.f1347R);
                        if (pdfObject6.isNumber()) {
                            ...
                            if (intValue == 2) {
                                ...
                                PdfDictionary pdfDictionary2 = (PdfDictionary) pdfDictionary.get(PdfName.f1277CF);
                                if (pdfDictionary2 != null) {
                                    PdfDictionary pdfDictionary3 = (PdfDictionary) pdfDictionary2.get(PdfName.STDCF);
                                    if (pdfDictionary3 != null) {
                                        if (PdfName.f1380V2.equals(pdfDictionary3.get(PdfName.CFM))) {
                                            i4 = 1;
                    ...
                    PdfObject pdfObject10 = pdfDictionary.get(PdfName.f1379V);
                    if (pdfObject10.isNumber()) {
                        ...
                        if (intValue3 == 1) {
                            ...
                            PdfDictionary pdfDictionary4 = (PdfDictionary) pdfDictionary.get(PdfName.f1277CF);
                            if (pdfDictionary4 != null) {
                                PdfDictionary pdfDictionary5 = (PdfDictionary) pdfDictionary4.get(PdfName.DEFAULTCRYPTFILTER);
                                if (pdfDictionary5 != null) {
                                    if (PdfName.f1380V2.equals(pdfDictionary5.get(PdfName.CFM))) {
                                        i3 = 1;
                ...
                if (pdfObjectRelease.equals(PdfName.STANDARD)) {
                    if (this.rValue == 5) {
                        ...
                        int i9 = this.rValue;
                        int i10 = 32;
                        if (!equalsArray(bArr7, bArr8, (i9 == 3 || i9 == 4) ? 16 : 32)) {
                            ...
                            if (!equalsArray(bArr7, bArr9, i10)) {
                ...
                for (int i12 = 0; i12 < this.strings.size(); i12++) {
                    this.strings.get(i12).decrypt(this);
                }
    ...
    public void readPages() throws IOException {
        ...
        if (asDict != null) {
            ...
            this.pageRefs = new PageRefs(this, (C18181) null);
            return;
        }
    ...
    public com.itextpdf.text.pdf.PdfObject readOneObjStm(com.itextpdf.text.pdf.PRStream r8, int r9) throws java.io.IOException {
        /*
            ...
            r3.<init>((com.itextpdf.text.p015io.RandomAccessSource) r8)
            r2.<init>(r3)
            r7.tokens = r2
            r8 = 1
            int r9 = r9 + r8
    ...
    public double dumpPerc() {
        ...
        double d = (double) i;
        Double.isNaN(d);
        double size = (double) this.xrefObj.size();
        Double.isNaN(size);
    ...
    public void readObjStm(PRStream pRStream, IntHashtable intHashtable) throws IOException {
        ...
        if (pRStream != null) {
            ...
            int intValue2 = pRStream.getAsNumber(PdfName.f1325N).intValue();
    ...
    public boolean readXRefStream(long j) throws IOException {
        ...
        PdfArray pdfArray2 = (PdfArray) pRStream.get(PdfName.f1383W);
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:34:0x00e7 A[LOOP:1: B:34:0x00e7->B:72:0x00e7, LOOP_START] */
    ...
    public com.itextpdf.text.pdf.PdfObject readPRObject() throws java.io.IOException {
        /*
            ...
            int[] r1 = com.itextpdf.text.pdf.PdfReader.C18181.$SwitchMap$com$itextpdf$text$pdf$PRTokeniser$TokenType
            int r2 = r0.ordinal()
            r1 = r1[r2]
            r2 = 0
            r3 = 1
    ...
    static /* synthetic */ class C18181 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.pdf.PdfReader.C18181.<clinit>():void");
        }
    }
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.itextpdf.text.pdf.RandomAccessFileOrArray, byte[]] */
    ...
    public static byte[] decodeBytes(byte[] bArr, PdfDictionary pdfDictionary, Map<PdfName, FilterHandlers.FilterHandler> map) throws IOException {
        ...
        if (pdfObjectRelease2 == null || (!pdfObjectRelease2.isDictionary() && !pdfObjectRelease2.isArray())) {
            pdfObjectRelease2 = getPdfObjectRelease(pdfDictionary.get(PdfName.f1288DP));
        }
    ...
    private static PdfArray getNameArray(PdfObject pdfObject) {
        ...
        if (!pdfObjectRelease.isDictionary() || (pdfObjectRelease2 = getPdfObjectRelease(((PdfDictionary) pdfObjectRelease).get(PdfName.f1282D))) == null || !pdfObjectRelease2.isArray()) {
            return null;
        }
    ...
    private boolean convertNamedDestination(PdfObject pdfObject, HashMap<Object, PdfObject> hashMap) {
        ...
        releaseLastXrefPartial();
        if (pdfObject3 == null || !pdfObject3.isDictionary() || (pdfObject2 = getPdfObject(((PdfDictionary) pdfObject3).get(PdfName.f1260A))) == null) {
            return false;
        }
        int i2 = this.lastXrefPartial;
        releaseLastXrefPartial();
        PdfDictionary pdfDictionary = (PdfDictionary) pdfObject2;
        if (!PdfName.GOTOR.equals((PdfName) getPdfObjectRelease(pdfDictionary.get(PdfName.f1357S))) || (pdfObjectRelease = getPdfObjectRelease(pdfDictionary.get(PdfName.f1282D))) == null) {
            return false;
        }
        ...
        pdfDictionary.remove(PdfName.f1295F);
        pdfDictionary.remove(PdfName.NEWWINDOW);
        pdfDictionary.put(PdfName.f1357S, PdfName.GOTO);
    ...
    private boolean replaceNamedDestination(com.itextpdf.text.pdf.PdfObject r9, java.util.HashMap<java.lang.Object, com.itextpdf.text.pdf.PdfObject> r10) {
        ...
        L_0x0035:
            ...
            return r4
        L_0x0046:
            com.itextpdf.text.pdf.PdfName r2 = com.itextpdf.text.pdf.PdfName.f1260A
            ...
            com.itextpdf.text.pdf.PdfName r6 = com.itextpdf.text.pdf.PdfName.f1357S
            ...
            com.itextpdf.text.pdf.PdfName r6 = com.itextpdf.text.pdf.PdfName.f1282D
            com.itextpdf.text.pdf.PdfObject r6 = r5.get(r6)
            com.itextpdf.text.pdf.PdfObject r6 = getPdfObjectRelease((com.itextpdf.text.pdf.PdfObject) r6)
    ...
    public String getJavaScript(RandomAccessFileOrArray randomAccessFileOrArray) throws IOException {
        ...
        for (String str : strArr) {
            ...
            if (!(pdfDictionary3 == null || (pdfObjectRelease = getPdfObjectRelease(pdfDictionary3.get(PdfName.f1319JS))) == null)) {
    ...
    static class PageRefs {
        ...
        /* synthetic */ PageRefs(PdfReader pdfReader, C18181 r2) throws IOException {
            this(pdfReader);
        }
    ...
    public boolean hasUsageRights() {
        ...
        if (asDict.contains(PdfName.f1378UR) || asDict.contains(PdfName.UR3)) {
            return true;
        }
        return false;
    }
    ...
    public int getCertificationLevel() {
        ...
        if (asDict4 == null || (asDict = asDict4.getAsDict(PdfName.DOCMDP)) == null || (asArray = asDict.getAsArray(PdfName.REFERENCE)) == null || asArray.size() == 0 || (asDict2 = asArray.getAsDict(0)) == null || (asDict3 = asDict2.getAsDict(PdfName.TRANSFORMPARAMS)) == null || (asNumber = asDict3.getAsNumber(PdfName.f1338P)) == null) {
            return 0;
        }
