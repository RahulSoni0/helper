...
public abstract class DocWriter implements DocListener {
    ...
    /* renamed from: GT */
    public static final byte f1152GT = 62;

    /* renamed from: LT */
    public static final byte f1153LT = 60;
    ...
    /* renamed from: os */
    protected OutputStreamCounter f1154os;
    ...
    protected DocWriter(Document document2, OutputStream outputStream) {
        ...
        this.f1154os = new OutputStreamCounter(new BufferedOutputStream(outputStream));
    }
    ...
    public void write(String str) throws IOException {
        this.f1154os.write(getISOBytes(str));
    }

    /* access modifiers changed from: protected */
    public void addTabs(int i) throws IOException {
        this.f1154os.write(10);
        for (int i2 = 0; i2 < i; i2++) {
            this.f1154os.write(9);
        }
    }

    /* access modifiers changed from: protected */
    public void write(String str, String str2) throws IOException {
        this.f1154os.write(32);
        write(str);
        this.f1154os.write(61);
        this.f1154os.write(34);
        write(str2);
        this.f1154os.write(34);
    }
    ...
    public void writeEnd(String str) throws IOException {
        this.f1154os.write(60);
        this.f1154os.write(47);
        write(str);
        this.f1154os.write(62);
    }
