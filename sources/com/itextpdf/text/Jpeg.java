...
public class Jpeg extends Image {
    ...
    public static final int[] UNSUPPORTED_MARKERS = {195, 197, 198, 199, 200, 201, XMPError.BADRDF, 203, 205, 206, 207};
    ...
    private void processParameters() throws com.itextpdf.text.BadElementException, java.io.IOException {
        /*
            ...
            r0 = 1
            r1.originalType = r0
            byte[] r3 = r1.rawData     // Catch:{ all -> 0x02f1 }
            if (r3 != 0) goto L_0x001e
            java.net.URL r3 = r1.url     // Catch:{ all -> 0x02f1 }
            java.io.InputStream r3 = r3.openStream()     // Catch:{ all -> 0x02f1 }
        ...
        L_0x001a:
            ...
            goto L_0x02f3
        L_0x001e:
            java.io.ByteArrayInputStream r3 = new java.io.ByteArrayInputStream     // Catch:{ all -> 0x02f1 }
            byte[] r4 = r1.rawData     // Catch:{ all -> 0x02f1 }
            r3.<init>(r4)     // Catch:{ all -> 0x02f1 }
