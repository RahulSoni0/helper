...
public class WebColors extends HashMap<String, int[]> {
    ...
    static {
        ...
        webColors.put("aquamarine", new int[]{WorkQueueKt.MASK, 255, 212, 255});
        ...
        webColors.put("blueviolet", new int[]{138, 43, Jpeg.M_APP2, 255});
        ...
        webColors.put("chartreuse", new int[]{WorkQueueKt.MASK, 255, 0, 255});
        webColors.put("chocolate", new int[]{210, 105, 30, 255});
        webColors.put("coral", new int[]{255, WorkQueueKt.MASK, 80, 255});
        webColors.put("cornflowerblue", new int[]{100, 149, Jpeg.M_APPD, 255});
        ...
        webColors.put("lightgreen", new int[]{144, Jpeg.M_APPE, 144, 255});
        ...
        webColors.put("mediumslateblue", new int[]{123, 104, Jpeg.M_APPE, 255});
        ...
        webColors.put("palegoldenrod", new int[]{Jpeg.M_APPE, 232, 170, 255});
        webColors.put("palegreen", new int[]{152, 251, 152, 255});
        webColors.put("paleturquoise", new int[]{175, Jpeg.M_APPE, Jpeg.M_APPE, 255});
        ...
        webColors.put("seashell", new int[]{255, 245, Jpeg.M_APPE, 255});
        ...
        webColors.put("springgreen", new int[]{0, 255, WorkQueueKt.MASK, 255});
        ...
        webColors.put("violet", new int[]{Jpeg.M_APPE, 130, Jpeg.M_APPE, 255});
    ...
    public static BaseColor getRGBColor(String str) {
        ...
        if (lowerCase.startsWith("#") || missingHashColorFormat) {
            ...
            if (stringTokenizer2.hasMoreElements()) {
                double parseFloat = (double) (Float.parseFloat(stringTokenizer2.nextToken()) * 255.0f);
