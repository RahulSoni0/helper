...
public class TabStop {
    ...
    public float getPosition(float f, float f2, float f3) {
        ...
        float f6 = f2 - f;
        int i = C17941.$SwitchMap$com$itextpdf$text$TabStop$Alignment[this.alignment.ordinal()];
        if (i == 1) {
            f4 = this.position;
            if (f + f6 >= f4) {
                return f;
    ...
    static /* synthetic */ class C17941 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.TabStop.C17941.<clinit>():void");
        }
    }
}
