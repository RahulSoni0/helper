...
public class Chunk implements Element, IAccessibleElement {
    ...
    /* renamed from: id */
    private AccessibleElementId f1151id;
    ...
    public AccessibleElementId getId() {
        if (this.f1151id == null) {
            this.f1151id = new AccessibleElementId();
        }
        return this.f1151id;
    }

    public void setId(AccessibleElementId accessibleElementId) {
        this.f1151id = accessibleElementId;
    }

    public String getTextExpansion() {
        PdfObject accessibleAttribute = getAccessibleAttribute(PdfName.f1293E);
    ...
    public void setTextExpansion(String str) {
        setAccessibleAttribute(PdfName.f1293E, new PdfString(str));
    }
}
