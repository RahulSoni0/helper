...
public class Font implements Comparable<Font> {
    ...
    static /* synthetic */ class C17931 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.itextpdf.text.Font.C17931.<clinit>():void");
        }
    }

    public String getFamilyname() {
        int i = C17931.$SwitchMap$com$itextpdf$text$Font$FontFamily[getFamily().ordinal()];
        if (i == 1) {
            return "Courier";
        }
        if (i == 2) {
    ...
    public com.itextpdf.text.pdf.BaseFont getCalculatedBaseFont(boolean r11) {
        ...
        L_0x0005:
            ...
            r0 = 0
        L_0x000c:
            int[] r1 = com.itextpdf.text.Font.C17931.$SwitchMap$com$itextpdf$text$Font$FontFamily
