...
import com.itextpdf.awt.geom.p014gl.Crossing;
...
public abstract class CubicCurve2D implements Shape, Cloneable {
    ...
    public static class Float extends CubicCurve2D {
        ...
        /* renamed from: x1 */
        public float f1081x1;

        /* renamed from: x2 */
        public float f1082x2;

        /* renamed from: y1 */
        public float f1083y1;

        /* renamed from: y2 */
        public float f1084y2;
        ...
        public double getX1() {
            return (double) this.f1081x1;
        }

        public double getY1() {
            return (double) this.f1083y1;
        }
        ...
        public double getX2() {
            return (double) this.f1082x2;
        }

        public double getY2() {
            return (double) this.f1084y2;
        }

        public Point2D getP1() {
            return new Point2D.Float(this.f1081x1, this.f1083y1);
        }
        ...
        public Rectangle2D getBounds2D() {
            float min = Math.min(Math.min(this.f1081x1, this.f1082x2), Math.min(this.ctrlx1, this.ctrlx2));
            float min2 = Math.min(Math.min(this.f1083y1, this.f1084y2), Math.min(this.ctrly1, this.ctrly2));
            return new Rectangle2D.Float(min, min2, Math.max(Math.max(this.f1081x1, this.f1082x2), Math.max(this.ctrlx1, this.ctrlx2)) - min, Math.max(Math.max(this.f1083y1, this.f1084y2), Math.max(this.ctrly1, this.ctrly2)) - min2);
        }
    }
    ...
    public static class Double extends CubicCurve2D {
        ...
        /* renamed from: x1 */
        public double f1077x1;

        /* renamed from: x2 */
        public double f1078x2;

        /* renamed from: y1 */
        public double f1079y1;

        /* renamed from: y2 */
        public double f1080y2;
        ...
        public Point2D getP1() {
            return new Point2D.Double(this.f1077x1, this.f1079y1);
        }
        ...
        public Point2D getP2() {
            return new Point2D.Double(this.f1078x2, this.f1080y2);
        }
        ...
        public Rectangle2D getBounds2D() {
            double min = Math.min(Math.min(this.f1077x1, this.f1078x2), Math.min(this.ctrlx1, this.ctrlx2));
            double min2 = Math.min(Math.min(this.f1079y1, this.f1080y2), Math.min(this.ctrly1, this.ctrly2));
            return new Rectangle2D.Double(min, min2, Math.max(Math.max(this.f1077x1, this.f1078x2), Math.max(this.ctrlx1, this.ctrlx2)) - min, Math.max(Math.max(this.f1079y1, this.f1080y2), Math.max(this.ctrly1, this.ctrly2)) - min2);
        }
    }
    ...
    class Iterator implements PathIterator {
        ...
        Iterator(CubicCurve2D cubicCurve2D, AffineTransform affineTransform) {
            this.f1085c = cubicCurve2D;
            this.f1086t = affineTransform;
        }
        ...
        public int currentSegment(double[] dArr) {
            ...
            if (!isDone()) {
                int i2 = 0;
                if (this.index == 0) {
                    dArr[0] = this.f1085c.getX1();
                    dArr[1] = this.f1085c.getY1();
                    i = 1;
                } else {
                    dArr[0] = this.f1085c.getCtrlX1();
                    dArr[1] = this.f1085c.getCtrlY1();
                    dArr[2] = this.f1085c.getCtrlX2();
                    dArr[3] = this.f1085c.getCtrlY2();
                    dArr[4] = this.f1085c.getX2();
                    dArr[5] = this.f1085c.getY2();
                    i2 = 3;
                    i = 3;
                }
                AffineTransform affineTransform = this.f1086t;
        ...
        public int currentSegment(float[] fArr) {
            ...
            if (!isDone()) {
                int i2 = 0;
                if (this.index == 0) {
                    fArr[0] = (float) this.f1085c.getX1();
                    fArr[1] = (float) this.f1085c.getY1();
                    i = 1;
                } else {
                    fArr[0] = (float) this.f1085c.getCtrlX1();
                    fArr[1] = (float) this.f1085c.getCtrlY1();
                    fArr[2] = (float) this.f1085c.getCtrlX2();
                    fArr[3] = (float) this.f1085c.getCtrlY2();
                    fArr[4] = (float) this.f1085c.getX2();
                    fArr[5] = (float) this.f1085c.getY2();
                    i2 = 3;
                    i = 3;
                }
                AffineTransform affineTransform = this.f1086t;
