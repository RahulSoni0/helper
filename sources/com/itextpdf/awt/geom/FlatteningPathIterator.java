...
public class FlatteningPathIterator implements PathIterator {
    ...
    public int getWindingRule() {
        return this.f1087p.getWindingRule();
    }

    public boolean isDone() {
        return this.bufEmpty && this.f1087p.isDone();
    }

    /* access modifiers changed from: package-private */
    public void evaluate() {
        if (this.bufEmpty) {
            this.bufType = this.f1087p.currentSegment(this.coords);
        }
        int i = this.bufType;
        boolean z = false;
        if (i == 0 || i == 1) {
            ...
            if (this.bufEmpty) {
                ...
                dArr2[i2 + 0] = this.f1088px;
                dArr2[i2 + 1] = this.f1089py;
            ...
            this.f1088px = dArr5[i6];
            this.f1089py = dArr5[i6 + 1];
            int i7 = this.bufSize;
            if (i6 == i7 - 2) {
                z = true;
            }
            ...
            if (this.bufEmpty) {
                ...
                dArr6[i8 + 0] = this.f1088px;
                dArr6[i8 + 1] = this.f1089py;
            ...
            this.f1088px = dArr9[i12];
            this.f1089py = dArr9[i12 + 1];
    ...
    public int currentSegment(float[] fArr) {
        if (!isDone()) {
            ...
            fArr[0] = (float) this.f1088px;
            fArr[1] = (float) this.f1089py;
            if (i != 0) {
                return 1;
            }
            return i;
