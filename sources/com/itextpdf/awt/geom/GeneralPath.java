...
public final class GeneralPath implements Shape, Cloneable {
    ...
    class Iterator implements PathIterator {
        ...
        Iterator(GeneralPath generalPath, AffineTransform affineTransform) {
            this.f1090p = generalPath;
            this.f1091t = affineTransform;
        }

        public int getWindingRule() {
            return this.f1090p.getWindingRule();
        }

        public boolean isDone() {
            return this.typeIndex >= this.f1090p.typeSize;
        }
        ...
        public int currentSegment(double[] dArr) {
            if (!isDone()) {
                byte b = this.f1090p.types[this.typeIndex];
                int i = GeneralPath.pointShift[b];
                for (int i2 = 0; i2 < i; i2++) {
                    dArr[i2] = (double) this.f1090p.points[this.pointIndex + i2];
                }
                AffineTransform affineTransform = this.f1091t;
        ...
        public int currentSegment(float[] fArr) {
            if (!isDone()) {
                byte b = this.f1090p.types[this.typeIndex];
                int i = GeneralPath.pointShift[b];
                System.arraycopy(this.f1090p.points, this.pointIndex, fArr, 0, i);
                AffineTransform affineTransform = this.f1091t;
                if (affineTransform != null) {
