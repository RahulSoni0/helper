...
public final class Util {
    ...
    private static String bytesToHex(byte[] bArr, char[] cArr) {
        for (int i = 0; i < bArr.length; i++) {
            ...
            cArr[i2] = cArr2[b >>> 4];
            cArr[i2 + 1] = cArr2[b & BidiOrder.f1233B];
        }
    ...
    private static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C09231.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    static /* synthetic */ class C09231 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C09231.<clinit>():void");
        }
    }
