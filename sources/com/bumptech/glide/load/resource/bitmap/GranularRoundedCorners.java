...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f117ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f117ID.getBytes(CHARSET);
