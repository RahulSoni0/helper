...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r5, r1.f109cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004f:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f109cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004f
        L_0x0068:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f109cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f107cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f107cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f107cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f107cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f107cb);
                    }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f108cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f108cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f108cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f108cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f108cb);
                        EngineJob.this.removeCallback(this.f108cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f109cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f109cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f109cb.equals(((ResourceCallbackAndExecutor) obj).f109cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f109cb.hashCode();
        }
    }
