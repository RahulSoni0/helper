...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f102ix = readShort();
        this.header.currentFrame.f103iy = readShort();
        this.header.currentFrame.f101iw = readShort();
        this.header.currentFrame.f100ih = readShort();
        int read = read();
        boolean z = false;
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                int i6 = i5 + 1;
                int i7 = i2 + 1;
                iArr[i2] = (b << BidiOrder.f1242S) | -16777216 | (b2 << 8) | (bArr[i5] & UByte.MAX_VALUE);
                i3 = i6;
                i2 = i7;
            }
