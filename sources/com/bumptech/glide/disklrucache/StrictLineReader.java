...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f97CR = 13;

    /* renamed from: LF */
    private static final byte f98LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f99in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f99in) {
            if (this.buf != null) {
                ...
                C08661 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f99in;
        byte[] bArr = this.buf;
