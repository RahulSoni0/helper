...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1240R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1240R.styleable.MaterialAutoCompleteTextView, i, C1240R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (obtainStyledAttributes.hasValue(C1240R.styleable.MaterialAutoCompleteTextView_android_inputType) && obtainStyledAttributes.getInt(C1240R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
