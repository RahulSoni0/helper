...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public View onCreateSnapshotView(Context context, Parcelable parcelable) {
        ...
        if (!(onCreateSnapshotView == null || (weakReference = capturedSharedElement) == null || this.shapeProvider == null || (view = (View) weakReference.get()) == null || (provideShape = this.shapeProvider.provideShape(view)) == null)) {
            onCreateSnapshotView.setTag(C1240R.C1243id.mtrl_motion_snapshot_view, provideShape);
        }
    ...
    public void onSharedElementStart(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty() && !list3.isEmpty()) {
            list2.get(0).setTag(C1240R.C1243id.mtrl_motion_snapshot_view, list3.get(0));
        }
    ...
    public void onSharedElementEnd(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty() && (list2.get(0).getTag(C1240R.C1243id.mtrl_motion_snapshot_view) instanceof View)) {
            list2.get(0).setTag(C1240R.C1243id.mtrl_motion_snapshot_view, (Object) null);
        }
