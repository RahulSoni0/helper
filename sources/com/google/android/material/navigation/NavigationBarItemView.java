...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.icon = (ImageView) findViewById(C1240R.C1243id.navigation_bar_item_icon_view);
        ViewGroup viewGroup = (ViewGroup) findViewById(C1240R.C1243id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C1240R.C1243id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C1240R.C1243id.navigation_bar_item_large_label_view);
        this.largeLabel = textView2;
        setBackgroundResource(getItemBackgroundResId());
        this.defaultMargin = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
        viewGroup.setTag(C1240R.C1243id.mtrl_view_tag_bottom_padding, Integer.valueOf(viewGroup.getPaddingBottom()));
        ...
        if (i != -1) {
            if (i == 0) {
                if (z) {
                    ...
                    updateViewPaddingBottom(viewGroup, ((Integer) viewGroup.getTag(C1240R.C1243id.mtrl_view_tag_bottom_padding)).intValue());
                ...
                updateViewPaddingBottom(viewGroup2, ((Integer) viewGroup2.getTag(C1240R.C1243id.mtrl_view_tag_bottom_padding)).intValue());
                if (z) {
            ...
            if (z) {
                ...
                updateViewPaddingBottom(viewGroup3, ((Integer) viewGroup3.getTag(C1240R.C1243id.mtrl_view_tag_bottom_padding)).intValue());
                this.largeLabel.setVisibility(0);
            } else {
                setViewLayoutParams(this.icon, this.defaultMargin, 17);
                updateViewPaddingBottom(this.labelGroup, 0);
            ...
            updateViewPaddingBottom(viewGroup4, ((Integer) viewGroup4.getTag(C1240R.C1243id.mtrl_view_tag_bottom_padding)).intValue());
            if (z) {
                setViewLayoutParams(this.icon, (int) (((float) this.defaultMargin) + this.shiftAmount), 49);
                setViewScaleValues(this.largeLabel, 1.0f, 1.0f, 0);
    ...
    public int getItemBackgroundResId() {
        return C1240R.C1242drawable.mtrl_navigation_bar_item_background;
    }

    /* access modifiers changed from: protected */
    public int getItemDefaultMarginResId() {
        return C1240R.dimen.mtrl_navigation_bar_item_default_margin;
    }
}
