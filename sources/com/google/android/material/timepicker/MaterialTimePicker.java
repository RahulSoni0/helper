...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1240R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C1240R.attr.materialTimePickerStyle, C1240R.style.Widget_MaterialComponents_TimePicker);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C1240R.styleable.MaterialTimePicker, C1240R.attr.materialTimePickerStyle, C1240R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = obtainStyledAttributes.getResourceId(C1240R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C1240R.styleable.MaterialTimePicker_keyboardIcon, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C1240R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView2 = (TimePickerView) viewGroup2.findViewById(C1240R.C1243id.material_timepicker_view);
        ...
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C1240R.C1243id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C1240R.C1243id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C1240R.C1243id.header_title);
        ...
        ((Button) viewGroup2.findViewById(C1240R.C1243id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) viewGroup2.findViewById(C1240R.C1243id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C1240R.string.material_timepicker_text_input_mode_description));
        }
        if (i == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C1240R.string.material_timepicker_clock_mode_description));
        }
    ...
    private int getThemeResId() {
        ...
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C1240R.attr.materialTimePickerTheme);
        if (resolve == null) {
            return 0;
        }
        return resolve.data;
