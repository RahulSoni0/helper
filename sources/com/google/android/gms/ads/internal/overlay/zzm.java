            ...
            if (((Boolean) zzaaa.zzc().zzb(zzaeq.zzcX)).booleanValue()) {
                synchronized (this.zzp) {
                    if (!this.zzd.zzaa() || this.zzs) {
                        ...
                        this.zzr = new zzf(this);
                        zzr.zza.postDelayed(this.zzr, ((Long) zzaaa.zzc().zzb(zzaeq.zzaI)).longValue());
                    }
                }
            } else {
                zzB();
    ...
    public final void zzF() {
        if (((Boolean) zzaaa.zzc().zzb(zzaeq.zzcX)).booleanValue()) {
            synchronized (this.zzp) {
                this.zzs = true;
                if (this.zzr != null) {
                    zzr.zza.removeCallbacks(this.zzr);
                    zzr.zza.post(this.zzr);
                }
            }
            return;
        }
        synchronized (this.zzo) {
            this.zzs = true;
            if (this.zzq != null) {
                zzr.zza.removeCallbacks(this.zzq);
                zzr.zza.post(this.zzq);
            }
        }
    }
                    ...
                    if (!((Boolean) zzaaa.zzc().zzb(zzaeq.zzcX)).booleanValue()) {
                        synchronized (this.zzo) {
                            if (!this.zzs && this.zzd.zzaa()) {
                                this.zzq = new zze(this);
                                zzr.zza.postDelayed(this.zzq, ((Long) zzaaa.zzc().zzb(zzaeq.zzaI)).longValue());
                                return;
                            }
                        }
                    }
