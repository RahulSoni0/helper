...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C2160zza> implements zzdq {
        ...
        public static final class C2160zza extends zzcg.zza<zza, C2160zza> implements zzdq {
            private C2160zza() {
                super(zza.zzsm);
            }

            /* synthetic */ C2160zza(zzgf zzgf) {
                this();
            }
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            WEB_STORE(65),
            WORK_STORE(132),
            WORK_STORE_APP(MetaDo.META_SETRELABS),
            EDU_STORE(15),
            MUSIC(1),
            BOOKS(2),
            VIDEO(3),
            ...
            SOCIAL_AFFINITY_GMAIL(TIFFConstants.TIFFTAG_JPEGRESTARTINTERVAL),
            ...
            BUGLE_COUNTERS(TIFFConstants.TIFFTAG_TILELENGTH),
            SOCIAL_WEB(47),
            BACKDROP(48),
            TELEMATICS(49),
            GVC_HARVESTER(51),
            ...
            WIFI_ASSISTANT(66),
            WIFI_ASSISTANT_PRIMES(TIFFConstants.TIFFTAG_BADFAXLINES),
            ...
            IOS_GSA(118),
            TAP_AND_PAY_APP(119),
            TAP_AND_PAY_APP_COUNTERS(TIFFConstants.TIFFTAG_CELLLENGTH),
            FLYDROID(120),
            CPANEL_APP(121),
            ...
            ADWORDS_MOBILE_ACX(MetaDo.META_CREATEBRUSHINDIRECT),
            LEANBACK_EVENT(134),
            ANDROID_GMAIL(135),
            SAMPLE_SHM(136),
            ...
            SDP_IOS_PRIMES(TIFFConstants.TIFFTAG_YPOSITION),
            ...
            SOCIETY_ANDROID_PRIMES(Jpeg.M_APPE),
            GMM_BRIIM_PRIMES(239),
            CW_PRIMES(242),
            CW_IOS_PRIMES(699),
            FAMILYLINK_ANDROID_PRIMES(244),
            FAMILYLINK_IOS_PRIMES(TIFFConstants.TIFFTAG_GRAYRESPONSECURVE),
            WH_PRIMES(248),
            NOVA_ANDROID_PRIMES(249),
            PHOTOS_DRAPER_ANDROID_PRIMES(253),
            GMM_PRIMES(TIFFConstants.TIFFTAG_SUBFILETYPE),
            TRANSLATE_ANDROID_PRIMES(255),
            TRANSLATE_IOS_PRIMES(256),
            FREIGHTER_ANDROID_PRIMES(259),
            CONSUMERIQ_PRIMES(MetaDo.META_SETROP2),
            GMB_ANDROID_PRIMES(263),
            CLOUDDPC_PRIMES(304),
            CLOUDDPC_ARC_PRIMES(TIFFConstants.TIFFTAG_SOFTWARE),
            ICORE(137),
            ...
            ON_THE_GO_ANDROID_PRIMES(TIFFConstants.TIFFTAG_SUBIFD),
            ...
            CRONET_FIREBALL(303),
            FIREBALL_PRIMES(TIFFConstants.TIFFTAG_FILLORDER),
            FIREBALL_IOS_PRIMES(MetaDo.META_RESIZEPALETTE),
            ...
            GOOGLE_NOW_LAUNCHER(MetaDo.META_CREATEPALETTE),
            SCOOBY_SPAM_REPORT_LOG(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION),
            IOS_GROWTH(251),
            APPS_NOTIFY(252),
            SMARTKEY_APP(TIFFConstants.TIFFTAG_DOCUMENTNAME),
            CLINICAL_STUDIES(TIFFConstants.TIFFTAG_IMAGEDESCRIPTION),
            FITNESS_ANDROID_PRIMES(TIFFConstants.TIFFTAG_MAKE),
            IMPROV_APPS(TIFFConstants.TIFFTAG_MODEL),
            FAMILYLINK(TIFFConstants.TIFFTAG_STRIPOFFSETS),
            FAMILYLINK_COUNTERS(TIFFConstants.TIFFTAG_ORIENTATION),
            SOCIETY(275),
            DIALER_ANDROID_PRIMES(TIFFConstants.TIFFTAG_SAMPLESPERPIXEL),
            YOUTUBE_DIRECTOR_APP(TIFFConstants.TIFFTAG_ROWSPERSTRIP),
            TACHYON_ANDROID_PRIMES(TIFFConstants.TIFFTAG_STRIPBYTECOUNTS),
            TACHYON_IOS_PRIMES(645),
            DRIVE_FS(TIFFConstants.TIFFTAG_MINSAMPLEVALUE),
            YT_MAIN(TIFFConstants.TIFFTAG_MAXSAMPLEVALUE),
            WING_MARKETPLACE_ANDROID_PRIMES(TIFFConstants.TIFFTAG_XRESOLUTION),
            DYNAMITE(TIFFConstants.TIFFTAG_YRESOLUTION),
            STREAMZ_DYNAMITE(778),
            CORP_ANDROID_FOOD(TIFFConstants.TIFFTAG_PLANARCONFIG),
            ANDROID_MESSAGING_PRIMES(TIFFConstants.TIFFTAG_PAGENAME),
            GPLUS_IOS_PRIMES(TIFFConstants.TIFFTAG_XPOSITION),
            CHROMECAST_ANDROID_APP_PRIMES(TIFFConstants.TIFFTAG_FREEOFFSETS),
            CAST_IOS_PRIMES(344),
            APPSTREAMING(TIFFConstants.TIFFTAG_FREEBYTECOUNTS),
            GMB_ANDROID(TIFFConstants.TIFFTAG_GRAYRESPONSEUNIT),
            VOICE_IOS_PRIMES(TIFFConstants.TIFFTAG_GROUP3OPTIONS),
            VOICE_ANDROID_PRIMES(TIFFConstants.TIFFTAG_GROUP4OPTIONS),
            PAISA(294),
            NAZDEEK_USER_ANDROID_PRIMES(TIFFConstants.TIFFTAG_ARTIST),
            NAZDEEK_CAB_ANDROID_PRIMES(TIFFConstants.TIFFTAG_HOSTCOMPUTER),
            NAZDEEK_CAFE_ANDROID_PRIMES(TIFFConstants.TIFFTAG_PREDICTOR),
            GMB_IOS(MetaDo.META_RESTOREDC),
            GMB_IOS_PRIMES(TIFFConstants.TIFFTAG_TILEBYTECOUNTS),
            SCOOBY_EVENTS(TIFFConstants.TIFFTAG_RESOLUTIONUNIT),
            SNAPSEED_IOS_PRIMES(TIFFConstants.TIFFTAG_PAGENUMBER),
            YOUTUBE_DIRECTOR_IOS_PRIMES(MetaDo.META_INVERTREGION),
            WALLPAPER_PICKER(MetaDo.META_PAINTREGION),
            WALLPAPER_PICKER_ANDROID_PRIMES(466),
            CHIME(300),
            BEACON_GCORE(301),
            ANDROID_STUDIO(MetaDo.META_SETTEXTALIGN),
            DOCS_OFFLINE(TIFFConstants.TIFFTAG_DATETIME),
            ...
            IPCONNECTIVITY(311),
            CURATOR(312),
            CURATOR_ANDROID_PRIMES(TIFFConstants.TIFFTAG_WHITEPOINT),
            FITNESS_ANDROID_WEAR_PRIMES(TIFFConstants.TIFFTAG_PRIMARYCHROMATICITIES),
            ANDROID_MIGRATE(TIFFConstants.TIFFTAG_COLORMAP),
            PAISA_USER_ANDROID_PRIMES(TIFFConstants.TIFFTAG_HALFTONEHINTS),
            PAISA_MERCHANT_ANDROID_PRIMES(322),
            CLIENT_LOGGING_PROD(TIFFConstants.TIFFTAG_CLEANFAXDATA),
            LIVE_CHANNELS_ANDROID_PRIMES(TIFFConstants.TIFFTAG_CONSECUTIVEBADFAXLINES),
            PAISA_USER_IOS_PRIMES(329),
            VESPA_IOS_PRIMES(331),
            PLAY_GAMES_PRIMES(TIFFConstants.TIFFTAG_INKSET),
            GMSCORE_API_COUNTERS(TIFFConstants.TIFFTAG_INKNAMES),
            EARTH(TIFFConstants.TIFFTAG_NUMBEROFINKS),
            EARTH_COUNTERS(405),
            CALENDAR_CLIENT(335),
            SV_ANDROID_PRIMES(TIFFConstants.TIFFTAG_DOTRANGE),
            PHOTOS_IOS_PRIMES(TIFFConstants.TIFFTAG_TARGETPRINTER),
            GARAGE_ANDROID_PRIMES(TIFFConstants.TIFFTAG_EXTRASAMPLES),
            GARAGE_IOS_PRIMES(TIFFConstants.TIFFTAG_SAMPLEFORMAT),
            SOCIAL_GOOD_DONATION_WIDGET(TIFFConstants.TIFFTAG_SMINSAMPLEVALUE),
            SANDCLOCK(TIFFConstants.TIFFTAG_SMAXSAMPLEVALUE),
            IMAGERY_VIEWER(342),
            ADWORDS_EXPRESS_ANDROID_PRIMES(343),
            IMPROV_POSTIT(345),
            IMPROV_SHARPIE(346),
            DRAPER_IOS_PRIMES(TIFFConstants.TIFFTAG_JPEGTABLES),
            SMARTCAM(348),
            DASHER_USERHUB(349),
            ...
            ATV_REMOTE_SERVICE_PRIMES(MetaDo.META_DELETEOBJECT),
            BRELLA(497),
            ANDROID_GROWTH(498),
            GHS_CLIENT_LOGS(499),
            ...
            GOOGLE_RED_ANDROID_PRIMES(MetaDo.META_CREATEPATTERNBRUSH),
            SEARCHLITE(506),
            ...
            VR_STREAMING_COUNTERS(TIFFConstants.TIFFTAG_JPEGIFBYTECOUNT),
            TOPAZ_IOS_PRIMES(TIFFConstants.TIFFTAG_JPEGLOSSLESSPREDICTORS),
            NEWS_EVENT(TIFFConstants.TIFFTAG_JPEGPOINTTRANSFORM),
            CHROMOTING(TIFFConstants.TIFFTAG_JPEGQTABLES),
            CHROMOTING_COUNTERS(TIFFConstants.TIFFTAG_JPEGDCTABLES),
            GMM_WEARABLE_COUNTERS(521),
            VR_STREAMING_ANDROID_PRIMES(MetaDo.META_SETTEXTJUSTIFICATION),
            REACHABILITY_GCORE(MetaDo.META_SETWINDOWORG),
            DMAGENT_IOS(MetaDo.META_SETWINDOWEXT),
            DMAGENT_IOS_PRIMES(MetaDo.META_SETVIEWPORTORG),
            SESAME_UNLOCK_PRIMES(MetaDo.META_SETVIEWPORTEXT),
            SESAME_TRUST_API_PRIMES(MetaDo.META_OFFSETWINDOWORG),
            GSTORE(528),
            OPA_IOS(529),
            VRCORE_ANDROID_PRIMES(TIFFConstants.TIFFTAG_YCBCRSUBSAMPLING),
            MOMA(531),
            ...
            GWS_JS(MetaDo.META_OFFSETCLIPRGN),
            ...
            ANDROID_WEBVIEW(MetaDo.META_FILLREGION),
            NEARBY(553),
            ...
            GBOARD_ANDROID_PRIMES(MetaDo.META_SETMAPPERFLAGS),
            NAKSHA_ANDROID_PRIMES(562),
            PAISA_COUNTERS(563),
            CONSTELLATION(MetaDo.META_SELECTPALETTE),
            ZANDRIA(565),
            CORP_IOS_LATIOS(566),
            ...
            KLOPFKLOPF(Element.WRITABLE_DIRECT),
            ...
            GMAIL_ANDROID(760),
            STREAMZ_PLX(761),
            INCIDENT_REPORT(MetaDo.META_CREATEPENINDIRECT),
            ELDAR(MetaDo.META_CREATEFONTINDIRECT),
