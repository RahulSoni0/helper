...
final class zzhk implements zzlm {
    ...
    public static zzhk zza(zzhi zzhi) {
        if (zzhi.zza != null) {
            return zzhi.zza;
        }
        return new zzhk(zzhi);
    }

    private zzhk(zzhi zzhi) {
        zzhi zzhi2 = (zzhi) zzia.zza(zzhi, "output");
        this.zza = zzhi2;
        zzhi2.zza = this;
    }
    ...
    public final void zza(int i, Object obj, zzkb zzkb) throws IOException {
        this.zza.zza(i, (zzjj) obj, zzkb);
    }

    public final void zzb(int i, Object obj, zzkb zzkb) throws IOException {
        zzhi zzhi = this.zza;
        zzhi.zza(i, 3);
        zzkb.zza((zzjj) obj, (zzlm) zzhi.zza);
        zzhi.zza(i, 4);
    }
    ...
    public final void zza(int i, List<?> list, zzkb zzkb) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zza(i, (Object) list.get(i2), zzkb);
        }
    }

    public final void zzb(int i, List<?> list, zzkb zzkb) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzb(i, (Object) list.get(i2), zzkb);
        }
    }

    public final <K, V> void zza(int i, zzja<K, V> zzja, Map<K, V> map) throws IOException {
        for (Map.Entry next : map.entrySet()) {
            this.zza.zza(i, 2);
            this.zza.zzb(zzjb.zza(zzja, next.getKey(), next.getValue()));
            zzjb.zza(this.zza, zzja, next.getKey(), next.getValue());
        }
    }
}
