...
final class zzgl {
    ...
    static int zza(int i, byte[] bArr, int i2, zzgo zzgo) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            zzgo.zza = i5 | (b2 << BidiOrder.f1234BN);
            return i6;
        }
        int i7 = i5 | ((b2 & ByteCompanionObject.MAX_VALUE) << BidiOrder.f1234BN);
        int i8 = i6 + 1;
        byte b3 = bArr[i6];
        if (b3 >= 0) {
            zzgo.zza = i7 | (b3 << 21);
    ...
    static int zza(byte[] bArr, int i) {
        return ((bArr[i + 3] & UByte.MAX_VALUE) << 24) | (bArr[i] & UByte.MAX_VALUE) | ((bArr[i + 1] & UByte.MAX_VALUE) << 8) | ((bArr[i + 2] & UByte.MAX_VALUE) << BidiOrder.f1242S);
    }
    ...
    static int zza(com.google.android.gms.internal.measurement.zzkb r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.measurement.zzgo r10) throws java.io.IOException {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
        ...
        L_0x0025:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzgl.zza(com.google.android.gms.internal.measurement.zzkb, byte[], int, int, com.google.android.gms.internal.measurement.zzgo):int");
    }
    ...
    static int zza(zzkb<?> zzkb, int i, byte[] bArr, int i2, int i3, zzig<?> zzig, zzgo zzgo) throws IOException {
        int zza = zza((zzkb) zzkb, bArr, i2, i3, zzgo);
        zzig.add(zzgo.zzc);
        while (zza < i3) {
            int zza2 = zza(bArr, zza, zzgo);
            if (i != zzgo.zza) {
            ...
            zza = zza((zzkb) zzkb, bArr, zza2, i3, zzgo);
            zzig.add(zzgo.zzc);
        }
        return zza;
    }
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzks zzks, zzgo zzgo) throws zzij {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                ...
                zzks.zza(i, (Object) Long.valueOf(zzgo.zzb));
                return zzb;
            } else if (i4 == 1) {
                zzks.zza(i, (Object) Long.valueOf(zzb(bArr, i2)));
                return i2 + 8;
            } else if (i4 == 2) {
                int zza = zza(bArr, i2, zzgo);
                int i5 = zzgo.zza;
                if (i5 < 0) {
                    ...
                    if (i5 == 0) {
                        zzks.zza(i, (Object) zzgp.zza);
                    } else {
                        zzks.zza(i, (Object) zzgp.zza(bArr, zza, i5));
                    }
                    return zza + i5;
                } else {
                    throw zzij.zza();
                ...
                zzks.zza(i, (Object) zzb2);
                return i2;
            } else if (i4 == 5) {
                zzks.zza(i, (Object) Integer.valueOf(zza(bArr, i2)));
                return i2 + 4;
            } else {
                throw zzij.zzd();
            }
