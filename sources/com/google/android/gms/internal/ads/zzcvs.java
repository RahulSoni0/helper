...
public final class zzcvs extends zzaty {
    ...
    public static void zzc(Activity activity, zzm zzm, zzbh zzbh, zzcvk zzcvk, zzcni zzcni, zzdvo zzdvo, String str, String str2) {
        ...
        if (zzf == null) {
            ...
            str6 = zzf.getString(C0930R.string.offline_opt_in_decline);
        }
        zzcvk zzcvk2 = zzcvk;
        String str7 = str;
        zzcni zzcni2 = zzcni;
    ...
    public final void zzf(IObjectWrapper iObjectWrapper, String str, String str2) {
        ...
        PendingIntent zza2 = zzebr.zza(context, 0, intent, zzebr.zza | 1073741824, 0);
        Intent intent2 = new Intent();
        intent2.setClass(context, AdService.class);
        intent2.setAction("offline_notification_dismissed");
        intent2.putExtra("offline_notification_action", "offline_notification_dismissed");
        intent2.putExtra("gws_query_id", str2);
        PendingIntent zza3 = zzebr.zza(context, 0, intent2, zzebr.zza | 1073741824, 0);
        Resources zzf = zzs.zzg().zzf();
        ...
        if (zzf == null) {
            ...
            str3 = zzf.getString(C0930R.string.offline_notification_title);
        }
        NotificationCompat.Builder contentTitle = builder.setContentTitle(str3);
        if (zzf == null) {
            str4 = "Tap to open ad";
        } else {
            str4 = zzf.getString(C0930R.string.offline_notification_text);
        }
