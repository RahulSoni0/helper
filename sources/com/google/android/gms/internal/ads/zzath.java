    ...
    public final void zza() {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            if (!TextUtils.isEmpty(lastPathSegment) && lastPathSegment.matches("([^\\s]+(\\.(?i)(jpg|png|gif|bmp|webp))$)")) {
                ...
                builder.setTitle(zzf != null ? zzf.getString(C0930R.string.f120s1) : "Save image");
                builder.setMessage(zzf != null ? zzf.getString(C0930R.string.f121s2) : "Allow Ad to store image in Picture gallery?");
                builder.setPositiveButton(zzf != null ? zzf.getString(C0930R.string.f122s3) : "Accept", new zzatf(this, str, lastPathSegment));
                builder.setNegativeButton(zzf != null ? zzf.getString(C0930R.string.f123s4) : "Decline", new zzatg(this));
                builder.create().show();
                return;
            }
