...
public final class zzrj implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:51:0x0102 A[RETURN] */
    ...
    public final void zzj(int r28) {
        ...
        L_0x0048:
            ...
            com.google.android.gms.ads.internal.util.zze.zzg(r13, r0)
        L_0x004e:
            r0 = r8[r10]
            r4.left = r0
            r0 = r8[r9]
        ...
        L_0x0074:
            ...
            java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ Exception -> 0x00b5 }
            r0.<init>()     // Catch:{ Exception -> 0x00b5 }
            android.view.ViewParent r11 = r8.getParent()     // Catch:{ Exception -> 0x00b5 }
        L_0x0091:
            boolean r12 = r11 instanceof android.view.View     // Catch:{ Exception -> 0x00b5 }
            if (r12 == 0) goto L_0x00c8
            r12 = r11
            android.view.View r12 = (android.view.View) r12     // Catch:{ Exception -> 0x00b5 }
            android.graphics.Rect r13 = new android.graphics.Rect     // Catch:{ Exception -> 0x00b5 }
            r13.<init>()     // Catch:{ Exception -> 0x00b5 }
            boolean r14 = r12.isScrollContainer()     // Catch:{ Exception -> 0x00b5 }
            if (r14 == 0) goto L_0x00b0
            boolean r12 = r12.getGlobalVisibleRect(r13)     // Catch:{ Exception -> 0x00b5 }
            if (r12 == 0) goto L_0x00b0
            android.graphics.Rect r12 = r1.zzc(r13)     // Catch:{ Exception -> 0x00b5 }
            r0.add(r12)     // Catch:{ Exception -> 0x00b5 }
        L_0x00b0:
            android.view.ViewParent r11 = r11.getParent()     // Catch:{ Exception -> 0x00b5 }
            goto L_0x0091
        L_0x00b5:
            r0 = move-exception
    ...
    private final void zzl(View view) {
        ...
        if (application != null) {
            try {
                ...
                zze.zzg("Error registering activity lifecycle callbacks.", e);
            }
        }
    }
    ...
    private final void zzm(View view) {
        try {
            ...
            zze.zzg("Error while unregistering listeners from the last ViewTreeObserver.", e);
        }
        try {
            ...
            zze.zzg("Error while unregistering listeners from the ViewTreeObserver.", e2);
        }
        if (this.zza != null) {
            try {
                zzs.zzx().zzc(this.zzd, this.zza);
            } catch (IllegalStateException e3) {
                zze.zzg("Failed trying to unregister the receiver", e3);
            } catch (Exception e4) {
        ...
        if (application != null) {
            try {
                ...
                zze.zzg("Error registering activity lifecycle callbacks.", e5);
            }
        }
    }
