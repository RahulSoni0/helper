...
public final class zzazt {
    ...
    private final void zzA(String str, boolean z) {
        if (!this.zza.get()) {
            ...
            zze.zzi(sb.toString());
            if (z) {
                zze.zzi("The Google Mobile Ads SDK will not integrate with Firebase. Admob/Firebase integration requires the latest Firebase SDK jar, but Firebase SDK is either missing or out of date");
                this.zza.set(true);
            }
        }
    }
            ...
            if (this.zzf.get() == -1) {
                ...
                if (!zzbbd.zzn(context, GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_VERSION_CODE)) {
                    ...
                    if (zzbbd.zzo(context)) {
                        zze.zzi("Google Play Service is out of date, the Google Mobile Ads SDK will not integrate with Firebase. Admob/Firebase integration requires updated Google Play Service.");
                        this.zzf.set(0);
                    }
                }
                this.zzf.set(1);
