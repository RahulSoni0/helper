...
public final class zzit implements Parcelable {
    ...
    public static zzit zza(String str, String str2, String str3, int i, int i2, int i3, int i4, float f, List<byte[]> list, int i5, float f2, byte[] bArr, int i6, zzqm zzqm, zzkq zzkq) {
        return new zzit(str, (String) null, str2, (String) null, -1, i2, i3, i4, -1.0f, i5, f2, bArr, i6, zzqm, -1, -1, -1, -1, -1, 0, (String) null, -1, LongCompanionObject.MAX_VALUE, list, zzkq, (zzmz) null);
    }
    ...
    public static zzit zzc(String str, String str2, String str3, int i, int i2, int i3, int i4, int i5, int i6, int i7, List<byte[]> list, zzkq zzkq, int i8, String str4, zzmz zzmz) {
        return new zzit(str, (String) null, str2, (String) null, -1, i2, -1, -1, -1.0f, -1, -1.0f, (byte[]) null, -1, (zzqm) null, i3, i4, i5, -1, -1, i8, str4, -1, LongCompanionObject.MAX_VALUE, list, zzkq, (zzmz) null);
    }
    ...
    public static zzit zze(String str, String str2, String str3, int i, List<byte[]> list, String str4, zzkq zzkq) {
        return new zzit(str, (String) null, str2, (String) null, -1, -1, -1, -1, -1.0f, -1, -1.0f, (byte[]) null, -1, (zzqm) null, -1, -1, -1, -1, -1, 0, str4, -1, LongCompanionObject.MAX_VALUE, list, zzkq, (zzmz) null);
    }

    public static zzit zzf(String str, String str2, String str3, int i, zzkq zzkq) {
        return new zzit(str, (String) null, "application/x-camera-motion", (String) null, -1, -1, -1, -1, -1.0f, -1, -1.0f, (byte[]) null, -1, (zzqm) null, -1, -1, -1, -1, -1, 0, (String) null, -1, LongCompanionObject.MAX_VALUE, (List<byte[]>) null, zzkq, (zzmz) null);
    }
    ...
    public final MediaFormat zzl() {
        ...
        mediaFormat.setString(Annotation.MIMETYPE, this.zzf);
        String str = this.zzy;
        if (str != null) {
            mediaFormat.setString(DublinCoreProperties.LANGUAGE, str);
        }
        zzm(mediaFormat, "max-input-size", this.zzg);
        zzm(mediaFormat, HtmlTags.WIDTH, this.zzj);
        zzm(mediaFormat, HtmlTags.HEIGHT, this.zzk);
        float f = this.zzl;
        if (f != -1.0f) {
