...
public final class zzagc {
    ...
    public static final zzafs<Boolean> zzh = zzafs.zza("gads:gma_attestation:request:enable_javascript", false);
    public static final zzafs<Boolean> zzi = zzafs.zza("gads:gma_attestation:request:enable", false);
