...
public final class zzbdf extends FrameLayout implements zzbcx {
    ...
    public zzbdf(Context context, zzbdp zzbdp, int i, boolean z, zzaff zzaff, zzbdo zzbdo) {
        ...
        if (applicationInfo == null || applicationInfo.targetSdkVersion >= 11) {
            ...
            if (i == 2) {
                zzbcy = new zzbef(context, zzbdq, zzbdp, z, zzbdh.zza(zzbdp), zzbdo);
            } else {
                Context context3 = context;
                zzbcy = new zzbcw(context3, zzbdp, z, zzbdh.zza(zzbdp), zzbdo, new zzbdq(context3, zzbdp.zzt(), zzbdp.zzm(), zzaff, zzbdp.zzi()));
            }
        } else {
            zzbcy = null;
        }
    ...
    public final void zzb() {
        ...
        if (zzbcy != null && this.zzl == 0) {
            zzH("canplaythrough", "duration", String.valueOf(((float) zzbcy.zzg()) / 1000.0f), "videoWidth", String.valueOf(this.zzf.zzk()), "videoHeight", String.valueOf(this.zzf.zzl()));
        }
    }
    ...
    public final void zzj(int i, int i2) {
        if (this.zzj) {
            int max = Math.max(i / ((Integer) zzaaa.zzc().zzb(zzaeq.zzB)).intValue(), 1);
            int max2 = Math.max(i2 / ((Integer) zzaaa.zzc().zzb(zzaeq.zzB)).intValue(), 1);
