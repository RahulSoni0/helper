...
public final class zzbfo implements zzakp<zzbdp> {
    ...
    public final /* bridge */ /* synthetic */ void zza(Object obj, Map map) {
        ...
        if (!map.containsKey("abort")) {
            ...
            if (str != null) {
                ...
                if (str2 != null) {
                    try {
                        ...
                        zze.zzi(str2.length() != 0 ? "Malformed demuxed URL list for precache: ".concat(str2) : new String("Malformed demuxed URL list for precache: "));
                        strArr = null;
                    }
                }
                if (strArr == null) {
                ...
                if (zzbfg.zzc(zzbdp) != null) {
                    zze.zzi("Precache task is already running.");
                    return;
                } else if (zzbdp.zzk() == null) {
                    zze.zzi("Precache requires a dependency provider.");
                    return;
                } else {
                ...
                if (zzc != null) {
                    ...
                    zze.zzi("Precache must specify a source.");
                    return;
                }
            }
            ...
            zze.zzi("Precache abort but no precache task running.");
        }
    }
}
