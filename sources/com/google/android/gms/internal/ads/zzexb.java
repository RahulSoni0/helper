...
public final class zzexb extends zzeth<zzexb, zzewy> implements zzeup {
    ...
    private int zzb;
    private zzexa zze;
    private zzetq<zzewt> zzf = zzaE();
    private zzesf zzg = zzesf.zzb;
    private zzesf zzh = zzesf.zzb;
    private int zzi;
    private zzesf zzj = zzesf.zzb;
    private byte zzk = 2;
    ...
    public final Object zzb(int i, Object obj, Object obj2) {
        ...
        byte b = 1;
        if (i2 == 2) {
            return zzaz(zzl, "\u0001\u0006\u0000\u0001\u0001\u0006\u0006\u0000\u0001\u0001\u0001ဉ\u0000\u0002Л\u0003ည\u0001\u0004ည\u0002\u0005င\u0003\u0006ည\u0004", new Object[]{"zzb", "zze", "zzf", zzewt.class, "zzg", "zzh", "zzi", "zzj"});
        } else if (i2 == 3) {
            return new zzexb();
        } else {
            if (i2 == 4) {
