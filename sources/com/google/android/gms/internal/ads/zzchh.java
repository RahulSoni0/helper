...
final /* synthetic */ class zzchh implements Callable {
    ...
    public final Object call() {
        ...
        if (zzdrg.zzg.contains(Integer.toString(zzcex.zzt()))) {
            ...
            zzcex.zzo(HtmlTags.BODY, jSONObject.optString(HtmlTags.BODY, (String) null));
            zzcex.zzo("call_to_action", jSONObject.optString("call_to_action", (String) null));
            zzcex.zzo("store", jSONObject.optString("store", (String) null));
            zzcex.zzo(Constants.RESPONSE_PRICE, jSONObject.optString(Constants.RESPONSE_PRICE, (String) null));
