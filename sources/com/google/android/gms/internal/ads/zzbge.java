...
public final class zzbge extends WebChromeClient {
    ...
    public final void onCloseWindow(WebView webView) {
        if (!(webView instanceof zzbgf)) {
            zze.zzi("Tried to close a WebView that wasn't an AdWebView.");
            return;
        }
        zzm zzN = ((zzbgf) webView).zzN();
        if (zzN == null) {
            zze.zzi("Tried to close an AdWebView not associated with an overlay.");
        } else {
            zzN.zzb();
        }
    }
    ...
    public final void onHideCustomView() {
        ...
        if (zzN == null) {
            zze.zzi("Could not get ad overlay when hiding custom view.");
        } else {
            zzN.zzc();
        }
    }
    ...
    public final void onShowCustomView(View view, int i, WebChromeClient.CustomViewCallback customViewCallback) {
        zzm zzN = this.zza.zzN();
        if (zzN == null) {
            zze.zzi("Could not get ad overlay when showing custom view.");
    ...
    public final boolean zza(Context context, String str, String str2, String str3, String str4, JsResult jsResult, JsPromptResult jsPromptResult, boolean z) {
        ...
        try {
            ...
            zze.zzj("Fail to display Dialog.", e);
        }
    }
