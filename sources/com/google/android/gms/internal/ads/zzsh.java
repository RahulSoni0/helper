...
public final class zzsh extends Thread {
    ...
    public final void run() {
        ...
        L_0x002a:
            ...
            com.google.android.gms.ads.internal.util.zze.zzd(r0)     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00dc:
            ...
            com.google.android.gms.ads.internal.util.zze.zzd(r1)     // Catch:{ InterruptedException -> 0x00dc }
    ...
    public final void zza() {
        synchronized (this.zzc) {
            if (this.zza) {
                zze.zzd("Content hash thread already started, quiting...");
                return;
            }
            this.zza = true;
            start();
    ...
    public final void zzb(View view) {
        try {
            ...
            zze.zzg("Exception in fetchContentOnUIThread", e);
    ...
    public final void zzf() {
        synchronized (this.zzc) {
            this.zzb = false;
            this.zzc.notifyAll();
            zze.zzd("ContentFetchThread: wakeup");
        }
    }
