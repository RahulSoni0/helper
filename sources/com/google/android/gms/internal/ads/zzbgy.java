...
final class zzbgy extends WebView implements DownloadListener, ViewTreeObserver.OnGlobalLayoutListener, zzbgf {
    ...
    protected zzbgy(zzbhu zzbhu, zzbhv zzbhv, String str, boolean z, boolean z2, zzfh zzfh, zzafp zzafp, zzbbq zzbbq, zzaff zzaff, zzl zzl2, zza zza2, zzug zzug, zzdqo zzdqo, zzdqr zzdqr) {
        ...
        try {
            ...
            zze.zzg("Unable to enable Javascript.", e);
        }
    ...
    private final synchronized void zzaU(String str) {
        try {
            ...
            zze.zzj("Could not call loadUrl. ", e);
        }
    }

    private final synchronized void zzaV() {
        Boolean zzc2 = zzs.zzg().zzc();
        this.zzw = zzc2;
        if (zzc2 == null) {
            try {
        ...
        if (!this.zzu) {
            if (!this.zzq.zzg()) {
                if (Build.VERSION.SDK_INT < 18) {
                    zze.zzd("Disabling hardware acceleration on an AdView.");
                    zzaY();
                    return;
                }
                zze.zzd("Enabling hardware acceleration on an AdView.");
                zzaZ();
                return;
            }
        }
        zze.zzd("Enabling hardware acceleration on an overlay.");
        zzaZ();
    }
    ...
    public final synchronized void loadData(String str, String str2, String str3) {
        if (!zzX()) {
            ...
            zze.zzi("#004 The webview is destroyed. Ignoring action.");
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:116:0x01c9 A[SYNTHETIC, Splitter:B:116:0x01c9] */
    /* JADX WARNING: Removed duplicated region for block: B:88:0x0127  */
    /* JADX WARNING: Removed duplicated region for block: B:95:0x0141  */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:66:0x00e0=Splitter:B:66:0x00e0, B:126:0x01ea=Splitter:B:126:0x01ea} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void onMeasure(int r9, int r10) {
        /*
            r8 = this;
            monitor-enter(r8)
            boolean r0 = r8.zzX()     // Catch:{ all -> 0x01ef }
            r1 = 0
            if (r0 == 0) goto L_0x000d
            r8.setMeasuredDimension(r1, r1)     // Catch:{ all -> 0x01ef }
            monitor-exit(r8)
            return
        L_0x000d:
            boolean r0 = r8.isInEditMode()     // Catch:{ all -> 0x01ef }
            if (r0 != 0) goto L_0x01ea
            boolean r0 = r8.zzu     // Catch:{ all -> 0x01ef }
            if (r0 != 0) goto L_0x01ea
            com.google.android.gms.internal.ads.zzbhv r0 = r8.zzq     // Catch:{ all -> 0x01ef }
            boolean r0 = r0.zzh()     // Catch:{ all -> 0x01ef }
            if (r0 == 0) goto L_0x0021
            goto L_0x01ea
        L_0x0021:
            com.google.android.gms.internal.ads.zzbhv r0 = r8.zzq     // Catch:{ all -> 0x01ef }
            boolean r0 = r0.zzj()     // Catch:{ all -> 0x01ef }
            if (r0 == 0) goto L_0x002e
            super.onMeasure(r9, r10)     // Catch:{ all -> 0x01ef }
            monitor-exit(r8)
            return
        L_0x002e:
            com.google.android.gms.internal.ads.zzbhv r0 = r8.zzq     // Catch:{ all -> 0x01ef }
            boolean r0 = r0.zzi()     // Catch:{ all -> 0x01ef }
            if (r0 == 0) goto L_0x0095
            com.google.android.gms.internal.ads.zzaei<java.lang.Boolean> r0 = com.google.android.gms.internal.ads.zzaeq.zzce     // Catch:{ all -> 0x01ef }
            com.google.android.gms.internal.ads.zzaeo r2 = com.google.android.gms.internal.ads.zzaaa.zzc()     // Catch:{ all -> 0x01ef }
            java.lang.Object r0 = r2.zzb(r0)     // Catch:{ all -> 0x01ef }
            ...
            return
        L_0x004d:
            com.google.android.gms.internal.ads.zzbhb r0 = r8.zzh()     // Catch:{ all -> 0x01ef }
            r2 = 0
            if (r0 == 0) goto L_0x0059
            float r0 = r0.zzm()     // Catch:{ all -> 0x01ef }
            goto L_0x005a
        L_0x0059:
            r0 = 0
        L_0x005a:
            ...
            return
        L_0x0063:
            int r9 = android.view.View.MeasureSpec.getSize(r9)     // Catch:{ all -> 0x01ef }
            int r10 = android.view.View.MeasureSpec.getSize(r10)     // Catch:{ all -> 0x01ef }
            float r2 = (float) r10     // Catch:{ all -> 0x01ef }
            float r2 = r2 * r0
            int r2 = (int) r2     // Catch:{ all -> 0x01ef }
            float r3 = (float) r9     // Catch:{ all -> 0x01ef }
            float r3 = r3 / r0
            int r3 = (int) r3     // Catch:{ all -> 0x01ef }
            if (r10 != 0) goto L_0x007e
            if (r3 == 0) goto L_0x007d
            float r10 = (float) r3     // Catch:{ all -> 0x01ef }
            float r10 = r10 * r0
            int r2 = (int) r10     // Catch:{ all -> 0x01ef }
            r1 = r9
            r10 = r3
            goto L_0x0088
        L_0x007d:
        ...
        L_0x007e:
            ...
            float r9 = (float) r2     // Catch:{ all -> 0x01ef }
            float r9 = r9 / r0
            int r3 = (int) r9     // Catch:{ all -> 0x01ef }
            r1 = r2
            goto L_0x0088
        L_0x0087:
            r1 = r9
        L_0x0088:
            int r9 = java.lang.Math.min(r2, r1)     // Catch:{ all -> 0x01ef }
            int r10 = java.lang.Math.min(r3, r10)     // Catch:{ all -> 0x01ef }
            r8.setMeasuredDimension(r9, r10)     // Catch:{ all -> 0x01ef }
            monitor-exit(r8)
            return
        L_0x0095:
            com.google.android.gms.internal.ads.zzbhv r0 = r8.zzq     // Catch:{ all -> 0x01ef }
            boolean r0 = r0.zzf()     // Catch:{ all -> 0x01ef }
            if (r0 == 0) goto L_0x00e5
            com.google.android.gms.internal.ads.zzaei<java.lang.Boolean> r0 = com.google.android.gms.internal.ads.zzaeq.zzch     // Catch:{ all -> 0x01ef }
            com.google.android.gms.internal.ads.zzaeo r1 = com.google.android.gms.internal.ads.zzaaa.zzc()     // Catch:{ all -> 0x01ef }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x01ef }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x01ef }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x01ef }
            if (r0 != 0) goto L_0x00e0
            boolean r0 = com.google.android.gms.common.util.PlatformVersion.isAtLeastJellyBeanMR1()     // Catch:{ all -> 0x01ef }
            if (r0 != 0) goto L_0x00b6
            goto L_0x00e0
        L_0x00b6:
            com.google.android.gms.internal.ads.zzbgw r0 = new com.google.android.gms.internal.ads.zzbgw     // Catch:{ all -> 0x01ef }
            r0.<init>(r8)     // Catch:{ all -> 0x01ef }
            java.lang.String r1 = "/contentHeight"
            r8.zzab(r1, r0)     // Catch:{ all -> 0x01ef }
            java.lang.String r0 = "(function() {  var height = -1;  if (document.body) {    height = document.body.offsetHeight;  } else if (document.documentElement) {    height = document.documentElement.offsetHeight;  }  var url = 'gmsg://mobileads.google.com/contentHeight?';  url += 'height=' + height;  try {    window.googleAdsJsInterface.notify(url);  } catch (e) {    var frame = document.getElementById('afma-notify-fluid');    if (!frame) {      frame = document.createElement('IFRAME');      frame.id = 'afma-notify-fluid';      frame.style.display = 'none';      var body = document.body || document.documentElement;      body.appendChild(frame);    }    frame.src = url;  }})();"
            r8.zzaN(r0)     // Catch:{ all -> 0x01ef }
            android.util.DisplayMetrics r0 = r8.zzh     // Catch:{ all -> 0x01ef }
            float r0 = r0.density     // Catch:{ all -> 0x01ef }
            int r9 = android.view.View.MeasureSpec.getSize(r9)     // Catch:{ all -> 0x01ef }
            int r1 = r8.zzG     // Catch:{ all -> 0x01ef }
            r2 = -1
            if (r1 == r2) goto L_0x00d7
            float r10 = (float) r1     // Catch:{ all -> 0x01ef }
            float r10 = r10 * r0
        ...
        L_0x00e5:
            com.google.android.gms.internal.ads.zzbhv r0 = r8.zzq     // Catch:{ all -> 0x01ef }
            boolean r0 = r0.zzg()     // Catch:{ all -> 0x01ef }
            if (r0 == 0) goto L_0x00fa
            android.util.DisplayMetrics r9 = r8.zzh     // Catch:{ all -> 0x01ef }
            int r9 = r9.widthPixels     // Catch:{ all -> 0x01ef }
            android.util.DisplayMetrics r10 = r8.zzh     // Catch:{ all -> 0x01ef }
            int r10 = r10.heightPixels     // Catch:{ all -> 0x01ef }
            r8.setMeasuredDimension(r9, r10)     // Catch:{ all -> 0x01ef }
            monitor-exit(r8)
            return
        L_0x00fa:
            int r0 = android.view.View.MeasureSpec.getMode(r9)     // Catch:{ all -> 0x01ef }
            int r9 = android.view.View.MeasureSpec.getSize(r9)     // Catch:{ all -> 0x01ef }
            int r2 = android.view.View.MeasureSpec.getMode(r10)     // Catch:{ all -> 0x01ef }
            int r10 = android.view.View.MeasureSpec.getSize(r10)     // Catch:{ all -> 0x01ef }
        ...
        L_0x011f:
            r3 = r10
        L_0x0120:
            com.google.android.gms.internal.ads.zzbhv r2 = r8.zzq     // Catch:{ all -> 0x01ef }
            int r4 = r2.zzb     // Catch:{ all -> 0x01ef }
            r5 = 1
            if (r4 > r0) goto L_0x012e
            int r2 = r2.zza     // Catch:{ all -> 0x01ef }
        ...
        L_0x012e:
            r2 = 1
        L_0x012f:
            com.google.android.gms.internal.ads.zzaei<java.lang.Boolean> r4 = com.google.android.gms.internal.ads.zzaeq.zzdC     // Catch:{ all -> 0x01ef }
            com.google.android.gms.internal.ads.zzaeo r6 = com.google.android.gms.internal.ads.zzaaa.zzc()     // Catch:{ all -> 0x01ef }
            java.lang.Object r4 = r6.zzb(r4)     // Catch:{ all -> 0x01ef }
            java.lang.Boolean r4 = (java.lang.Boolean) r4     // Catch:{ all -> 0x01ef }
            boolean r4 = r4.booleanValue()     // Catch:{ all -> 0x01ef }
            if (r4 == 0) goto L_0x0160
            com.google.android.gms.internal.ads.zzbhv r4 = r8.zzq     // Catch:{ all -> 0x01ef }
            int r6 = r4.zzb     // Catch:{ all -> 0x01ef }
            float r7 = r8.zzi     // Catch:{ all -> 0x01ef }
            float r6 = (float) r6     // Catch:{ all -> 0x01ef }
            float r6 = r6 / r7
            float r0 = (float) r0     // Catch:{ all -> 0x01ef }
            float r0 = r0 / r7
            int r0 = (r6 > r0 ? 1 : (r6 == r0 ? 0 : -1))
            if (r0 > 0) goto L_0x015b
            int r0 = r4.zza     // Catch:{ all -> 0x01ef }
            float r0 = (float) r0     // Catch:{ all -> 0x01ef }
            float r0 = r0 / r7
            float r3 = (float) r3     // Catch:{ all -> 0x01ef }
            float r3 = r3 / r7
        ...
        L_0x0160:
            ...
            com.google.android.gms.internal.ads.zzbhv r2 = r8.zzq     // Catch:{ all -> 0x01ef }
            int r3 = r2.zzb     // Catch:{ all -> 0x01ef }
            float r4 = r8.zzi     // Catch:{ all -> 0x01ef }
            int r2 = r2.zza     // Catch:{ all -> 0x01ef }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x01ef }
            r7 = 103(0x67, float:1.44E-43)
            r6.<init>(r7)     // Catch:{ all -> 0x01ef }
            java.lang.String r7 = "Not enough space to show ad. Needs "
            r6.append(r7)     // Catch:{ all -> 0x01ef }
            float r3 = (float) r3     // Catch:{ all -> 0x01ef }
            float r3 = r3 / r4
            int r3 = (int) r3     // Catch:{ all -> 0x01ef }
            r6.append(r3)     // Catch:{ all -> 0x01ef }
            java.lang.String r3 = "x"
            r6.append(r3)     // Catch:{ all -> 0x01ef }
            float r2 = (float) r2     // Catch:{ all -> 0x01ef }
            float r2 = r2 / r4
            int r2 = (int) r2     // Catch:{ all -> 0x01ef }
            r6.append(r2)     // Catch:{ all -> 0x01ef }
            java.lang.String r2 = " dp, but only has "
            r6.append(r2)     // Catch:{ all -> 0x01ef }
            float r9 = (float) r9     // Catch:{ all -> 0x01ef }
            float r9 = r9 / r4
            int r9 = (int) r9     // Catch:{ all -> 0x01ef }
            r6.append(r9)     // Catch:{ all -> 0x01ef }
            java.lang.String r9 = "x"
            r6.append(r9)     // Catch:{ all -> 0x01ef }
            float r9 = (float) r10     // Catch:{ all -> 0x01ef }
            float r9 = r9 / r4
            int r9 = (int) r9     // Catch:{ all -> 0x01ef }
            r6.append(r9)     // Catch:{ all -> 0x01ef }
            java.lang.String r9 = " dp."
            r6.append(r9)     // Catch:{ all -> 0x01ef }
            java.lang.String r9 = r6.toString()     // Catch:{ all -> 0x01ef }
            com.google.android.gms.ads.internal.util.zze.zzi(r9)     // Catch:{ all -> 0x01ef }
            int r9 = r8.getVisibility()     // Catch:{ all -> 0x01ef }
            if (r9 == r0) goto L_0x01b5
            r9 = 4
            r8.setVisibility(r9)     // Catch:{ all -> 0x01ef }
        L_0x01b5:
            r8.setMeasuredDimension(r1, r1)     // Catch:{ all -> 0x01ef }
            boolean r9 = r8.zzl     // Catch:{ all -> 0x01ef }
            if (r9 != 0) goto L_0x01c7
            com.google.android.gms.internal.ads.zzug r9 = r8.zzY     // Catch:{ all -> 0x01ef }
            com.google.android.gms.internal.ads.zzui r10 = com.google.android.gms.internal.ads.zzui.BANNER_SIZE_INVALID     // Catch:{ all -> 0x01ef }
            r9.zzb(r10)     // Catch:{ all -> 0x01ef }
            r8.zzl = r5     // Catch:{ all -> 0x01ef }
            monitor-exit(r8)
            return
        L_0x01c7:
            monitor-exit(r8)
        ...
        L_0x01c9:
            ...
            r8.setVisibility(r1)     // Catch:{ all -> 0x01ef }
        L_0x01d2:
            boolean r9 = r8.zzm     // Catch:{ all -> 0x01ef }
            if (r9 != 0) goto L_0x01df
            com.google.android.gms.internal.ads.zzug r9 = r8.zzY     // Catch:{ all -> 0x01ef }
            com.google.android.gms.internal.ads.zzui r10 = com.google.android.gms.internal.ads.zzui.BANNER_SIZE_VALID     // Catch:{ all -> 0x01ef }
            r9.zzb(r10)     // Catch:{ all -> 0x01ef }
            r8.zzm = r5     // Catch:{ all -> 0x01ef }
        L_0x01df:
            com.google.android.gms.internal.ads.zzbhv r9 = r8.zzq     // Catch:{ all -> 0x01ef }
            int r10 = r9.zzb     // Catch:{ all -> 0x01ef }
            int r9 = r9.zza     // Catch:{ all -> 0x01ef }
            r8.setMeasuredDimension(r10, r9)     // Catch:{ all -> 0x01ef }
            monitor-exit(r8)
            return
        L_0x01ea:
            super.onMeasure(r9, r10)     // Catch:{ all -> 0x01ef }
    ...
    public final void onPause() {
        if (!zzX()) {
            try {
                ...
                zze.zzg("Could not pause webview.", e);
            }
        }
    }
    ...
    public final void onResume() {
        if (!zzX()) {
            try {
                ...
                zze.zzg("Could not resume webview.", e);
            }
        }
    }
    ...
    public final void stopLoading() {
        if (!zzX()) {
            try {
                ...
                zze.zzg("Could not stop loading webview.", e);
            }
        }
    }
    ...
    public final synchronized void zzat(String str, String str2, String str3) {
        ...
        if (!zzX()) {
            ...
            try {
                ...
                zze.zzj("Unable to build MRAID_ENV", e);
                str4 = null;
            }
            strArr[0] = str4;
    ...
    public final void zzd(String str, JSONObject jSONObject) {
        ...
        zze.zzd(valueOf.length() != 0 ? "Dispatching AFMA event: ".concat(valueOf) : new String("Dispatching AFMA event: "));
        zzaN(sb.toString());
    }
    ...
    public final synchronized void zzx(zzbhb zzbhb) {
        if (this.zzz != null) {
            zze.zzf("Attempt to create multiple AdWebViewVideoControllers.");
        } else {
            this.zzz = zzbhb;
        }
    }
