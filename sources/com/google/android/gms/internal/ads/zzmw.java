...
public final class zzmw {
    ...
    private static java.util.List<com.google.android.gms.internal.ads.zzml> zze(com.google.android.gms.internal.ads.zzmr r18, com.google.android.gms.internal.ads.zzmt r19) throws com.google.android.gms.internal.ads.zzms {
        /*
            r1 = r18
            r2 = r19
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ Exception -> 0x02a6 }
            r3.<init>()     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r4 = r1.zza     // Catch:{ Exception -> 0x02a6 }
            int r5 = r19.zza()     // Catch:{ Exception -> 0x02a6 }
            boolean r6 = r19.zzc()     // Catch:{ Exception -> 0x02a6 }
            r8 = 0
        L_0x0014:
            if (r8 >= r5) goto L_0x02a5
            android.media.MediaCodecInfo r9 = r2.zzb(r8)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r10 = r9.getName()     // Catch:{ Exception -> 0x02a6 }
            boolean r0 = r9.isEncoder()     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
            java.lang.String r11 = ".secure"
            if (r6 != 0) goto L_0x0030
            boolean r0 = r10.endsWith(r11)     // Catch:{ Exception -> 0x02a6 }
            if (r0 == 0) goto L_0x0030
            goto L_0x029a
        L_0x0030:
            int r0 = com.google.android.gms.internal.ads.zzqj.zza     // Catch:{ Exception -> 0x02a6 }
            r12 = 21
            if (r0 >= r12) goto L_0x0066
            java.lang.String r0 = "CIPAACDecoder"
            boolean r0 = r0.equals(r10)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
        ...
        L_0x0074:
            ...
            java.lang.String r12 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
            boolean r0 = r0.equals(r12)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
        L_0x008a:
            int r0 = com.google.android.gms.internal.ads.zzqj.zza     // Catch:{ Exception -> 0x02a6 }
            r12 = 16
            ...
            java.lang.String r13 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
            boolean r0 = r0.equals(r13)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
            ...
            boolean r0 = r0.equals(r13)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
            java.lang.String r0 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r13 = "gee"
            boolean r0 = r0.startsWith(r13)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
        ...
        L_0x0144:
            ...
            java.lang.String r14 = com.google.android.gms.internal.ads.zzqj.zzc     // Catch:{ Exception -> 0x02a6 }
            boolean r0 = r0.equals(r14)     // Catch:{ Exception -> 0x02a6 }
            if (r0 == 0) goto L_0x018e
            java.lang.String r0 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r14 = "d2"
            boolean r0 = r0.startsWith(r14)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
            java.lang.String r0 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
            ...
            if (r0 != 0) goto L_0x029a
            java.lang.String r0 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
            boolean r0 = r0.startsWith(r12)     // Catch:{ Exception -> 0x02a6 }
            if (r0 != 0) goto L_0x029a
            java.lang.String r0 = com.google.android.gms.internal.ads.zzqj.zzb     // Catch:{ Exception -> 0x02a6 }
        ...
        L_0x018e:
            ...
            if (r0 != 0) goto L_0x029a
        L_0x01a2:
            java.lang.String[] r12 = r9.getSupportedTypes()     // Catch:{ Exception -> 0x02a6 }
            int r13 = r12.length     // Catch:{ Exception -> 0x02a6 }
            r14 = 0
        L_0x01a8:
            if (r14 >= r13) goto L_0x029a
            r15 = r12[r14]     // Catch:{ Exception -> 0x02a6 }
            boolean r0 = r15.equalsIgnoreCase(r4)     // Catch:{ Exception -> 0x02a6 }
            ...
            int r2 = com.google.android.gms.internal.ads.zzqj.zza     // Catch:{ Exception -> 0x021e }
            r16 = r5
            r5 = 22
            r17 = r9
            r9 = 1
            if (r2 > r5) goto L_0x01ed
            java.lang.String r2 = com.google.android.gms.internal.ads.zzqj.zzd     // Catch:{ Exception -> 0x01eb }
        ...
        L_0x01f7:
            ...
            goto L_0x01f5
        L_0x01fe:
            com.google.android.gms.internal.ads.zzml r0 = com.google.android.gms.internal.ads.zzml.zzb(r10, r4, r0, r2, r5)     // Catch:{ Exception -> 0x0207 }
        ...
        L_0x0209:
            ...
            com.google.android.gms.internal.ads.zzml r0 = com.google.android.gms.internal.ads.zzml.zzb(r7, r4, r0, r2, r9)     // Catch:{ Exception -> 0x0207 }
            r3.add(r0)     // Catch:{ Exception -> 0x0207 }
            return r3
        L_0x021e:
            r0 = move-exception
        ...
        L_0x0223:
            r5 = 0
        L_0x0224:
            int r2 = com.google.android.gms.internal.ads.zzqj.zza     // Catch:{ Exception -> 0x02a6 }
            r7 = 23
            java.lang.String r9 = "MediaCodecUtil"
            if (r2 > r7) goto L_0x0256
            boolean r2 = r3.isEmpty()     // Catch:{ Exception -> 0x02a6 }
            if (r2 != 0) goto L_0x0256
            java.lang.String r0 = java.lang.String.valueOf(r10)     // Catch:{ Exception -> 0x02a6 }
            int r0 = r0.length()     // Catch:{ Exception -> 0x02a6 }
            int r0 = r0 + 46
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x02a6 }
            r2.<init>(r0)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r0 = "Skipping codec "
            r2.append(r0)     // Catch:{ Exception -> 0x02a6 }
            r2.append(r10)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r0 = " (failed to query capabilities)"
            r2.append(r0)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r0 = r2.toString()     // Catch:{ Exception -> 0x02a6 }
            android.util.Log.e(r9, r0)     // Catch:{ Exception -> 0x02a6 }
            goto L_0x0290
        L_0x0256:
            java.lang.String r1 = java.lang.String.valueOf(r10)     // Catch:{ Exception -> 0x02a6 }
            int r1 = r1.length()     // Catch:{ Exception -> 0x02a6 }
            int r1 = r1 + 25
            java.lang.String r2 = java.lang.String.valueOf(r15)     // Catch:{ Exception -> 0x02a6 }
            int r2 = r2.length()     // Catch:{ Exception -> 0x02a6 }
            int r1 = r1 + r2
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x02a6 }
            r2.<init>(r1)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r1 = "Failed to query codec "
            r2.append(r1)     // Catch:{ Exception -> 0x02a6 }
            r2.append(r10)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r1 = " ("
            r2.append(r1)     // Catch:{ Exception -> 0x02a6 }
            r2.append(r15)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r1 = ")"
            r2.append(r1)     // Catch:{ Exception -> 0x02a6 }
            java.lang.String r1 = r2.toString()     // Catch:{ Exception -> 0x02a6 }
            android.util.Log.e(r9, r1)     // Catch:{ Exception -> 0x02a6 }
