...
abstract class zzeet<OutputT> extends zzeeh.zzi<OutputT> {
    ...
    private static final Logger zzaK;
    ...
    static {
        Throwable th;
        zzeeq zzeeq;
        Class<zzeet> cls = zzeet.class;
        zzaK = Logger.getLogger(cls.getName());
        try {
            zzeeq = new zzeer(AtomicReferenceFieldUpdater.newUpdater(cls, Set.class, "seenExceptions"), AtomicIntegerFieldUpdater.newUpdater(cls, "remaining"));
            th = null;
        } catch (Throwable th2) {
