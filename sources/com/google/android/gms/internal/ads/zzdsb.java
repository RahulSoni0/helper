...
public final class zzdsb {
    public static zzym zza(Throwable th) {
        if (th instanceof zzcwa) {
            ...
            zzap zzap = (zzap) th;
            return new zzym(zzap.zza(), zzecs.zza(zzap.getMessage()), MobileAds.ERROR_DOMAIN, (zzym) null, (IBinder) null);
        }
    }
    ...
    public static zzym zzb(Throwable th, zzcwb zzcwb) {
        ...
        zzym zza = zza(th);
        int i = zza.zza;
        if ((i == 3 || i == 0) && (zzym = zza.zzd) != null && !zzym.zzc.equals(MobileAds.ERROR_DOMAIN)) {
            zza.zzd = null;
        }
