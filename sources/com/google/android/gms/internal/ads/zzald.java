    ...
    public final void zza(Object obj, Map<String, String> map) {
        ...
        synchronized (this.zza) {
            ...
            if (remove == null) {
                ...
                zze.zzi(valueOf2.length() != 0 ? "Received result for unexpected method invocation: ".concat(valueOf2) : new String("Received result for unexpected method invocation: "));
