...
public final class zzcht {
    ...
    private static Integer zzk(JSONObject jSONObject, String str) {
        try {
            ...
            return Integer.valueOf(Color.rgb(jSONObject2.getInt("r"), jSONObject2.getInt("g"), jSONObject2.getInt(HtmlTags.f1191B)));
    ...
    public final zzefw<zzbgf> zzd(JSONObject jSONObject) {
        ...
        zzefw<zzbgf> zzb2 = this.zzi.zzb(zzh2.optString("base_url"), zzh2.optString("html"));
