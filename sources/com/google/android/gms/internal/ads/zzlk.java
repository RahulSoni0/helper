...
public final class zzlk implements zzku {
    public static final zzkw zza = new zzlh();
    private static final byte[] zzb = {49, 10, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 44, ByteBuffer.ZERO, ByteBuffer.ZERO, ByteBuffer.ZERO, DocWriter.SPACE, 45, 45, DocWriter.f1152GT, DocWriter.SPACE, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 58, ByteBuffer.ZERO, ByteBuffer.ZERO, 44, ByteBuffer.ZERO, ByteBuffer.ZERO, ByteBuffer.ZERO, 10};
    private static final byte[] zzc = {DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE, DocWriter.SPACE};
            ...
            if (zzlj.zze) {
                ...
                if ((b2 & 1) == 1) {
                    ...
                    if (b3 == 2) {
                        ...
                        int i6 = (this.zzW >> 1) + 1;
                        int i7 = (i6 * 6) + 2;
                        java.nio.ByteBuffer byteBuffer = this.zzq;
                        if (byteBuffer == null || byteBuffer.capacity() < i7) {
                            this.zzq = java.nio.ByteBuffer.allocate(i7);
                        }
                        this.zzq.position(0);
    ...
    public zzlk(int i) {
        ...
        this.zzj = new zzqc(4);
        this.zzk = new zzqc(java.nio.ByteBuffer.allocate(4).putInt(-1).array());
        this.zzl = new zzqc(4);
