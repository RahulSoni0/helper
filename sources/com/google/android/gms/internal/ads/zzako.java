...
public final class zzako {
    ...
    public static zzefw<String> zza(zzbgf zzbgf, String str) {
        ...
        try {
            ...
            zze.zzi(str.length() != 0 ? "Unable to append parameter to URL: ".concat(str) : new String("Unable to append parameter to URL: "));
        }
        String zzb2 = zzazv.zzb(parse, zzbgf.getContext());
        if (!zzagc.zzf.zze().booleanValue()) {
            return zzefo.zza(zzb2);
        }
        return zzefo.zze(zzefo.zzi(zzefo.zze(zzeff.zzw(zzbgf.zzaE()), Throwable.class, zzajx.zza, zzbbw.zzf), new zzajy(zzb2), zzbbw.zzf), Throwable.class, new zzajz(zzb2), zzbbw.zzf);
    }
            ...
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    try {
                        ...
                        String optString2 = jSONObject2.optString(HtmlTags.f1209U);
                        String optString3 = jSONObject2.optString(HtmlTags.f1201I);
                        String optString4 = jSONObject2.optString("m");
                        String optString5 = jSONObject2.optString(HtmlTags.f1204P);
                        ...
                        if (!TextUtils.isEmpty(optString7)) {
                            try {
                                ...
                                zze.zzg(str, uRISyntaxException);
                            }
                        }
                        boolean z = true;
                        if (intent == null) {
                        ...
                        try {
                            ...
                            zze.zzg("Error constructing openable urls response.", e2);
                        }
                    } catch (JSONException e3) {
                        zze.zzg("Error parsing the intent data.", e3);
                    }
                }
