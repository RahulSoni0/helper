...
import com.google.android.gms.ads.C0929R;
...
public final class zzzf {
    ...
    public zzzf(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0929R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0929R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0929R.styleable.AdsAttrs_adSizes);
        ...
        String string3 = obtainAttributes.getString(C0929R.styleable.AdsAttrs_adUnitId);
        this.zzb = string3;
        obtainAttributes.recycle();
