...
public final class zzdxu {
    ...
    private static final String[] zzc = {"x", "y", HtmlTags.WIDTH, HtmlTags.HEIGHT};
    ...
    public static JSONObject zzb(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            jSONObject.put(HtmlTags.WIDTH, (double) (((float) i3) / zza));
            jSONObject.put(HtmlTags.HEIGHT, (double) (((float) i4) / zza));
            ...
            if (optJSONArray != null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (optJSONObject != null) {
                        ...
                        double optDouble3 = optJSONObject.optDouble(HtmlTags.WIDTH);
                        double optDouble4 = optJSONObject.optDouble(HtmlTags.HEIGHT);
                        f2 = Math.max(f2, (float) (optDouble + optDouble3));
                        f3 = Math.max(f3, (float) (optDouble2 + optDouble4));
                    }
                }
                f = f3;
                jSONObject2.put(HtmlTags.WIDTH, (double) f2);
                jSONObject2.put(HtmlTags.HEIGHT, (double) f);
            }
        } else if (zzb != null) {
