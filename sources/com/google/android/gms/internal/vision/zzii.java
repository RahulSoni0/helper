...
public abstract class zzii extends zzhq {
    ...
    public abstract void zza(int i, zzht zzht) throws IOException;

    public abstract void zza(int i, zzkk zzkk) throws IOException;

    /* access modifiers changed from: package-private */
    public abstract void zza(int i, zzkk zzkk, zzlc zzlc) throws IOException;
    ...
    public abstract void zza(zzht zzht) throws IOException;

    public abstract void zza(zzkk zzkk) throws IOException;
    ...
    public abstract void zzb(int i, zzht zzht) throws IOException;
    ...
    private static class zza extends zzii {
        ...
        /* access modifiers changed from: package-private */
        public final void zza(int i, zzkk zzkk, zzlc zzlc) throws IOException {
            zza(i, 2);
            zzhf zzhf = (zzhf) zzkk;
            int zzi = zzhf.zzi();
            if (zzi == -1) {
        ...
        public final void zza(int i, zzkk zzkk) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, 2);
            zza(zzkk);
        ...
        public final void zzb(int i, zzht zzht) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, zzht);
            zza(1, 4);
        ...
        public final void zza(zzkk zzkk) throws IOException {
            zzb(zzkk.zzm());
            zzkk.zza(this);
        }
        ...
        public final void zza(long j) throws IOException {
            if (!zzii.zzc || zza() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.zze;
                    this.zze = i3 + 1;
                    zzma.zza(bArr3, (long) i3, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.zzb;
                int i4 = this.zze;
    ...
    /* access modifiers changed from: package-private */
    public final void zza(String str, zzmg zzmg) throws IOException {
