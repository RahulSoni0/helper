    ...
    public final T zzd() {
        synchronized (this.zzb) {
            ...
            try {
                ...
                C1237L.m294d("Cannot load thick client module, fall back to load optional module %s", format);
                try {
                    dynamiteModule = DynamiteModule.load(this.zza, DynamiteModule.PREFER_REMOTE, format);
                } catch (DynamiteModule.LoadingException e) {
                    C1237L.m297e(e, "Error loading optional module %s", format);
                    if (!this.zzf) {
                        C1237L.m294d("Broadcasting download intent for dependency %s", this.zze);
                        String str = this.zze;
