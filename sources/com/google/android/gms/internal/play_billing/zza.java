...
public final class zza {
    ...
    public static List<Purchase> zza(Bundle bundle) {
        ...
        ArrayList<String> stringArrayList = bundle.getStringArrayList(Constants.INAPP_PURCHASE_DATA_LIST);
        ArrayList<String> stringArrayList2 = bundle.getStringArrayList(Constants.INAPP_DATA_SIGNATURE_LIST);
        ArrayList arrayList = new ArrayList();
        if (stringArrayList == null || stringArrayList2 == null) {
            zzb("BillingHelper", "Couldn't find purchase lists, trying to find single data.");
            Purchase zzc = zzc(bundle.getString(Constants.INAPP_PURCHASE_DATA), bundle.getString(Constants.RESPONSE_INAPP_SIGNATURE));
            if (zzc == null) {
    ...
    public static Bundle zza(int i, boolean z, String str, String str2, ArrayList<zzap> arrayList) {
        ...
        if (i >= 14) {
            ...
            boolean z2 = false;
            while (i2 < size) {
                zzap zzap = arrayList.get(i2);
                i2++;
                zzap zzap2 = zzap;
                arrayList2.add(zzap2.zzb());
                z2 |= !TextUtils.isEmpty(zzap2.zzb());
            }
            if (z2) {
