...
public final class zah implements Handler.Callback {
    ...
    public final void zaa(com.google.android.gms.common.ConnectionResult r8) {
        /*
            ...
            monitor-enter(r0)
            java.util.ArrayList r1 = new java.util.ArrayList     // Catch:{ all -> 0x004c }
            java.util.ArrayList<com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener> r2 = r7.zad     // Catch:{ all -> 0x004c }
            r1.<init>(r2)     // Catch:{ all -> 0x004c }
            java.util.concurrent.atomic.AtomicInteger r2 = r7.zaf     // Catch:{ all -> 0x004c }
            int r2 = r2.get()     // Catch:{ all -> 0x004c }
            r3 = r1
            java.util.ArrayList r3 = (java.util.ArrayList) r3     // Catch:{ all -> 0x004c }
            int r3 = r1.size()     // Catch:{ all -> 0x004c }
            r4 = 0
        L_0x0025:
            if (r4 >= r3) goto L_0x004a
            java.lang.Object r5 = r1.get(r4)     // Catch:{ all -> 0x004c }
            int r4 = r4 + 1
            com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener r5 = (com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener) r5     // Catch:{ all -> 0x004c }
            boolean r6 = r7.zae     // Catch:{ all -> 0x004c }
            if (r6 == 0) goto L_0x0048
            java.util.concurrent.atomic.AtomicInteger r6 = r7.zaf     // Catch:{ all -> 0x004c }
            int r6 = r6.get()     // Catch:{ all -> 0x004c }
            if (r6 == r2) goto L_0x003c
            goto L_0x0048
        L_0x003c:
            java.util.ArrayList<com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener> r6 = r7.zad     // Catch:{ all -> 0x004c }
            boolean r6 = r6.contains(r5)     // Catch:{ all -> 0x004c }
            if (r6 == 0) goto L_0x0025
            r5.onConnectionFailed(r8)     // Catch:{ all -> 0x004c }
            goto L_0x0025
        L_0x0048:
