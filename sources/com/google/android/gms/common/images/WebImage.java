...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        this(zaa(jSONObject), jSONObject.optInt(HtmlTags.WIDTH, 0), jSONObject.optInt(HtmlTags.HEIGHT, 0));
    }
    ...
    public final JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(HtmlTags.WIDTH, this.zac);
            jSONObject.put(HtmlTags.HEIGHT, this.zad);
        } catch (JSONException unused) {
        }
        return jSONObject;
    }
