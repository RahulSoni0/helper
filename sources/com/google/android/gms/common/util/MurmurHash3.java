...
public class MurmurHash3 {
    ...
    public static int murmurhash3_x86_32(byte[] bArr, int i, int i2, int i3) {
        int i4 = (i2 & -4) + i;
        while (i < i4) {
            int i5 = ((bArr[i] & UByte.MAX_VALUE) | ((bArr[i + 1] & UByte.MAX_VALUE) << 8) | ((bArr[i + 2] & UByte.MAX_VALUE) << BidiOrder.f1242S) | (bArr[i + 3] << 24)) * -862048943;
        ...
        if (i7 != 1) {
            if (i7 != 2) {
                if (i7 == 3) {
                    i8 = (bArr[i4 + 2] & UByte.MAX_VALUE) << BidiOrder.f1242S;
                }
                int i9 = i3 ^ i2;
