...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return applicationRestrictions != null && PdfBoolean.TRUE.equals(applicationRestrictions.getString("restricted_profile"));
    }
    ...
    public static int isGooglePlayServicesAvailable(android.content.Context r10, int r11) {
        /*
            ...
            int r2 = com.google.android.gms.common.C0938R.string.common_google_play_services_unknown_issue     // Catch:{ all -> 0x000c }
