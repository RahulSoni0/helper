...
public class FastParser<T extends FastJsonResponse> {
    ...
    private static final char[] zag = {'r', 'u', Barcode128.CODE_BC_TO_A};
    private static final char[] zah = {'r', 'u', Barcode128.CODE_BC_TO_A, Typography.quote};
    private static final char[] zai = {'a', 'l', 's', Barcode128.CODE_BC_TO_A};
    private static final char[] zaj = {'a', 'l', 's', Barcode128.CODE_BC_TO_A, Typography.quote};
