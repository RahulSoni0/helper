    ...
    private final zzw zzc(String str, boolean z, boolean z2) {
        ...
        if (zzm.zzd()) {
            ...
            try {
                ...
                if (packageInfo == null) {
                    zzw = zzw.zzd("null pkg");
                } else if (packageInfo.signatures == null || packageInfo.signatures.length != 1) {
                    zzw = zzw.zzd("single cert required");
                } else {
                    zzj zzj = new zzj(packageInfo.signatures[0].toByteArray());
                    String str2 = packageInfo.packageName;
                    zzw zzc2 = zzm.zzc(str2, zzj, honorsDebugCertificates, false);
                    zzw = (!zzc2.zza || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || !zzm.zzc(str2, zzj, false, true).zza) ? zzc2 : zzw.zzd("debuggable release cert app rejected");
                }
