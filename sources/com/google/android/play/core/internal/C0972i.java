...
public final class C0972i {
    /* renamed from: a */
    static Pair<ByteBuffer, Long> m126a(RandomAccessFile randomAccessFile) throws IOException {
        if (randomAccessFile.length() < 22) {
            return null;
        }
        Pair<ByteBuffer, Long> h = m133h(randomAccessFile, 0);
        return h != null ? h : m133h(randomAccessFile, 65535);
    }

    /* renamed from: b */
    public static long m127b(ByteBuffer byteBuffer) {
        m134i(byteBuffer);
        return m135j(byteBuffer, byteBuffer.position() + 16);
    }

    /* renamed from: c */
    public static void m128c(ByteBuffer byteBuffer, long j) {
        m134i(byteBuffer);
    ...
    /* renamed from: d */
    public static long m129d(ByteBuffer byteBuffer) {
        m134i(byteBuffer);
        return m135j(byteBuffer, byteBuffer.position() + 12);
    }

    /* renamed from: e */
    public static String m130e(String str, String str2) {
    ...
    /* renamed from: f */
    public static String m131f(String str, String str2, String str3) {
    ...
    /* renamed from: g */
    public static X509Certificate[][] m132g(String str) throws C1699f, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> a = m126a(randomAccessFile);
            if (a != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C1699f("ZIP64 APK not supported");
                    }
                }
                long b = m127b(byteBuffer2);
                if (b >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C1699f(sb.toString());
                } else if (m129d(byteBuffer2) + b != longValue) {
                    throw new C1699f("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (b >= 32) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        throw new C1699f(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] k = m136k(randomAccessFile.getChannel(), new C1698e(m143r(slice, i4 - 4), longValue2, b, longValue, byteBuffer2));
                                                    ...
                                                    sb5.append(i2);
                                                    throw new C1699f(sb5.toString());
                                                }
                                            }
                                            throw new C1699f("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C1699f(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: h */
    private static Pair<ByteBuffer, Long> m133h(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
        long length = randomAccessFile.length();
        if (length < 22) {
            return null;
    ...
    /* renamed from: i */
    private static void m134i(ByteBuffer byteBuffer) {
        if (byteBuffer.order() != ByteOrder.LITTLE_ENDIAN) {
            throw new IllegalArgumentException("ByteBuffer byte order must be little endian");
        }
    }
    ...
    /* renamed from: j */
    private static long m135j(ByteBuffer byteBuffer, int i) {
        return ((long) byteBuffer.getInt(i)) & 4294967295L;
    }

    /* renamed from: k */
    private static X509Certificate[][] m136k(FileChannel fileChannel, C1698e eVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer s = m144s(eVar.f875a);
                int i = 0;
                while (s.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m137l(m144s(s), hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m138m(hashMap, fileChannel, eVar.f876b, eVar.f877c, eVar.f878d, eVar.f879e);
    ...
    private static java.security.cert.X509Certificate[] m137l(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = m144s(r22)
            java.nio.ByteBuffer r1 = m144s(r22)
            byte[] r2 = m145t(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = m144s(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = m140o(r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = m140o(r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = m145t(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x014e:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = m144s(r0)
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = m144s(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = m145t(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
        ...
        L_0x029f:
            goto L_0x029e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C0972i.m137l(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    /* renamed from: m */
    private static void m138m(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C1697d dVar = new C1697d(fileChannel, 0, j);
            C1697d dVar2 = new C1697d(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            m128c(duplicate, j);
            C1683b bVar = new C1683b(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] n = m139n(iArr, new C1691c[]{dVar, dVar2, bVar});
                while (i < size) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), n[i])) {
                        ...
                        throw new SecurityException(m141p(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    /* renamed from: n */
    private static byte[][] m139n(int[] iArr, C1691c[] cVarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (cVarArr[i2].mo30897a() + 1048575) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m142q(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                m146u(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            int i8 = 0;
            for (i = 3; i6 < i; i = 3) {
                C1691c cVar = cVarArr[i6];
                long j4 = j2;
                int i9 = i6;
                long a = cVar.mo30897a();
                while (a > j2) {
                    ...
                    long j5 = j4;
                    try {
                        cVar.mo30898b(messageDigestArr, j5, min);
                        int i11 = 0;
    ...
    /* renamed from: o */
    private static int m140o(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: p */
    private static String m141p(int i) {
        if (i == 1) {
            return "SHA-256";
        }
        if (i == 2) {
    ...
    /* renamed from: q */
    private static int m142q(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: r */
    private static ByteBuffer m143r(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: s */
    private static ByteBuffer m144s(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m143r(byteBuffer, i);
            } else {
    ...
    /* renamed from: t */
    private static byte[] m145t(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
    ...
    /* renamed from: u */
    private static void m146u(int i, byte[] bArr) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
