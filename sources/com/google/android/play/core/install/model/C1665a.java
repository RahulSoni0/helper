...
public final class C1665a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f841a;

    /* renamed from: b */
    private static final Map<Integer, String> f842b;
    ...
    /* renamed from: a */
    public static String m665a(int i) {
        Map<Integer, String> map = f841a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        Map<Integer, String> map2 = f842b;
