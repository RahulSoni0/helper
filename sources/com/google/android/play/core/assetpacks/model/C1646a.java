...
public final class C1646a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f797a;

    /* renamed from: b */
    private static final Map<Integer, String> f798b;
    ...
    /* renamed from: a */
    public static String m627a(int i) {
        Map<Integer, String> map = f797a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f798b.get(valueOf);
