...
final class C1626cv {
    ...
    /* renamed from: a */
    private static final C0944ag f721a = new C0944ag("PackageStateCache");
    ...
    public final synchronized int mo30818a() {
        /*
            r3 = this;
            monitor-enter(r3)
            int r0 = r3.f723c     // Catch:{ all -> 0x0029 }
            r1 = -1
            if (r0 != r1) goto L_0x0025
            r0 = 0
            android.content.Context r1 = r3.f722b     // Catch:{ NameNotFoundException -> 0x001c }
            java.lang.String r1 = r1.getPackageName()     // Catch:{ NameNotFoundException -> 0x001c }
            android.content.Context r2 = r3.f722b     // Catch:{ NameNotFoundException -> 0x001c }
            ...
            r3.f723c = r1     // Catch:{ NameNotFoundException -> 0x001c }
            goto L_0x0025
        L_0x001c:
            com.google.android.play.core.internal.ag r1 = f721a     // Catch:{ all -> 0x0029 }
            ...
            r1.mo17055b(r2, r0)     // Catch:{ all -> 0x0029 }
        L_0x0025:
            int r0 = r3.f723c     // Catch:{ all -> 0x0029 }
            monitor-exit(r3)
            return r0
        L_0x0029:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.assetpacks.C1626cv.mo30818a():int");
    }
}
