...
public final class C0974a {
    ...
    /* renamed from: a */
    private final C0976c f170a;

    public C0974a(C0976c cVar) {
        this.f170a = cVar;
    }

    /* renamed from: c */
    public static final int m163c(AssetManager assetManager, File file) {
        int intValue = ((Integer) C0960bh.m97a(assetManager, "addAssetPath", Integer.class, String.class, file.getPath())).intValue();
    ...
    public final synchronized boolean mo17096a(android.content.Context r5, java.util.Set<java.lang.String> r6) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L_0x0022:
            ...
            com.google.android.play.core.splitcompat.c r3 = r4.f170a     // Catch:{ Exception -> 0x0045 }
            java.io.File r2 = r3.mo17101c(r2)     // Catch:{ Exception -> 0x0045 }
            r1.add(r2)     // Catch:{ Exception -> 0x0045 }
            goto L_0x0022
        L_0x0038:
            r4.mo17097b(r5, r1)     // Catch:{ Exception -> 0x0045 }
        ...
        L_0x005e:
            goto L_0x005d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitcompat.C0974a.mo17096a(android.content.Context, java.util.Set):boolean");
    }

    /* renamed from: b */
    public final synchronized void mo17097b(Context context, Set<File> set) {
