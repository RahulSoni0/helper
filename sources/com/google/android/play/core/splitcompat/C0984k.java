...
public final class C0984k {
    ...
    /* renamed from: b */
    private static final Pattern f188b = Pattern.compile("lib/([^/]+)/(.*\\.so)$");

    /* renamed from: c */
    private final C0976c f189c;

    C0984k(C0976c cVar) throws IOException {
        this.f189c = cVar;
    }

    /* renamed from: d */
    static /* synthetic */ Set m196d(C0984k kVar, Set set, C0990q qVar, ZipFile zipFile) throws IOException {
        HashSet hashSet = new HashSet();
        kVar.m198f(qVar, set, new C0980g(hashSet, qVar, zipFile));
        return hashSet;
    }
    ...
    private static void m197e(com.google.android.play.core.splitcompat.C0990q r13, com.google.android.play.core.splitcompat.C0981h r14) throws java.io.IOException {
        /*
            java.util.zip.ZipFile r0 = new java.util.zip.ZipFile     // Catch:{ IOException -> 0x00f0 }
            java.io.File r1 = r13.mo17121a()     // Catch:{ IOException -> 0x00f0 }
            r0.<init>(r1)     // Catch:{ IOException -> 0x00f0 }
            java.lang.String r13 = r13.mo17122b()     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x0016:
            ...
            java.util.regex.Pattern r9 = f188b     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x0094:
            ...
            com.google.android.play.core.splitcompat.j r11 = (com.google.android.play.core.splitcompat.C0983j) r11     // Catch:{ IOException -> 0x00ee }
            java.lang.String r12 = r11.f185a     // Catch:{ IOException -> 0x00ee }
            ...
            java.lang.String r11 = r11.f185a     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x00de:
            ...
            r14.mo17114a(r0, r1)     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x00f8:
            r14 = move-exception
            com.google.android.play.core.internal.C0971bz.m125a(r13, r14)
        L_0x00fc:
            goto L_0x00fe
        L_0x00fd:
            throw r13
        L_0x00fe:
            goto L_0x00fd
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitcompat.C0984k.m197e(com.google.android.play.core.splitcompat.q, com.google.android.play.core.splitcompat.h):void");
    }

    /* access modifiers changed from: private */
    /* renamed from: f */
    public final void m198f(C0990q qVar, Set<C0983j> set, C0982i iVar) throws IOException {
        for (C0983j next : set) {
            File e = this.f189c.mo17103e(qVar.mo17122b(), next.f185a);
            boolean z = false;
            if (e.exists() && e.length() == next.f186b.getSize()) {
                z = true;
            }
            iVar.mo17113a(next, e, z);
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public final Set<File> mo17115a() throws IOException {
        Log.d("SplitCompat", "NativeLibraryExtractor: synchronizing native libraries");
        Set<C0990q> i = this.f189c.mo17107i();
        for (String next : this.f189c.mo17108j()) {
            Iterator<C0990q> it = i.iterator();
            while (true) {
                if (it.hasNext()) {
                    if (it.next().mo17122b().equals(next)) {
                        break;
                    }
                } else {
        ...
        for (C0990q next2 : i) {
            ...
            m197e(next2, new C0979f(this, hashSet2, next2));
            for (File next3 : this.f189c.mo17111m(next2.mo17122b())) {
                if (!hashSet2.contains(next3)) {
                    Log.i("SplitCompat", String.format("NativeLibraryExtractor: file '%s' found in split '%s' that is not in the split file '%s'; removing", new Object[]{next3.getAbsolutePath(), next2.mo17122b(), next2.mo17121a().getAbsolutePath()}));
                    this.f189c.mo17110l(next3);
                }
            }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final Set<File> mo17116b(C0990q qVar) throws IOException {
        AtomicBoolean atomicBoolean = new AtomicBoolean(true);
        HashSet hashSet = new HashSet();
        m197e(qVar, new C0978e(this, qVar, hashSet, atomicBoolean));
