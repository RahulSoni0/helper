...
public final class C1759a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f976a;

    /* renamed from: b */
    private static final Map<Integer, String> f977b;
    ...
    /* renamed from: a */
    public static String m898a(int i) {
        Map<Integer, String> map = f976a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        Map<Integer, String> map2 = f977b;
