...
final class C1754av {
    ...
    C1754av(Context context) {
        this.f957a = context;
    }

    /* renamed from: c */
    private final SharedPreferences m888c() {
        return this.f957a.getSharedPreferences("playcore_split_install_internal", 0);
    }
    ...
    public final synchronized java.util.Set<java.lang.String> mo31028a() {
        /*
            r3 = this;
            monitor-enter(r3)
            android.content.SharedPreferences r0 = r3.m888c()     // Catch:{ Exception -> 0x001b }
        ...
        L_0x0022:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitinstall.C1754av.mo31028a():java.util.Set");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final synchronized void mo31029b(Collection<String> collection) {
        Set<String> a = mo31028a();
        boolean z = false;
        ...
        if (z) {
            try {
                m888c().edit().putStringSet("deferred_uninstall_module_list", a).apply();
