    ...
    public static class Builder {
        ...
        public BillingFlowParams build() {
            ...
            if (this.zzf.size() > 1) {
                ...
                int i2 = 0;
                while (i2 < size2) {
                    SkuDetails skuDetails3 = arrayList4.get(i2);
                    i2++;
                ...
                ArrayList<SkuDetails> arrayList6 = this.zzf;
                ArrayList arrayList7 = arrayList6;
                int size3 = arrayList6.size();
                int i3 = 0;
                while (i3 < size3) {
                    SkuDetails skuDetails4 = arrayList6.get(i3);
                    i3++;
                    if (!zza2.equals(skuDetails4.zza())) {
