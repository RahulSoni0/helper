...
public class Purchase {
    ...
    public String getOrderId() {
        return this.zzc.optString(Constants.RESPONSE_ORDER_ID);
    }

    public String getPackageName() {
        return this.zzc.optString(Constants.RESPONSE_PACKAGE_NAME);
    }
    ...
    public int getPurchaseState() {
        return this.zzc.optInt(Constants.RESPONSE_PURCHASE_STATE, 1) != 4 ? 1 : 2;
    }
    ...
    public boolean isAutoRenewing() {
        return this.zzc.optBoolean(Constants.RESPONSE_AUTO_RENEWING);
    }
