...
class BillingClientImpl extends BillingClient {
    ...
    private final class zza implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (BillingClientImpl.this.zza(new zzag(this), (long) WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, (Runnable) new zzaf(this)) == null) {
            ...
            if (z && !this.zzj) {
                ...
                if (this.zzl) {
                    ...
                    while (i4 < size) {
                        ...
                        String zza4 = zza(skuDetails3.getOriginalJson());
                        arrayList2.add(zza4);
                    ...
                    if (zza2.size() > 1) {
                        ...
                        for (int i5 = 1; i5 < zza2.size(); i5++) {
                            arrayList4.add(zza2.get(i5).getSku());
                        }
                ...
                try {
                    ...
                    intent.putExtra(Constants.BUY_INTENT, (PendingIntent) bundle.getParcelable(Constants.BUY_INTENT));
    ...
    public void querySkuDetailsAsync(SkuDetailsParams skuDetailsParams, SkuDetailsResponseListener skuDetailsResponseListener) {
        ...
        if (zza(new zzad(this, skuType, arrayList, (String) null, skuDetailsResponseListener), (long) WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, (Runnable) new zzg(this, skuDetailsResponseListener)) == null) {
    ...
    public void consumeAsync(ConsumeParams consumeParams, ConsumeResponseListener consumeResponseListener) {
        ...
        } else if (zza(new zzj(this, consumeParams, consumeResponseListener), (long) WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, (Runnable) new zzi(this, consumeResponseListener, consumeParams)) == null) {
    ...
    public void queryPurchaseHistoryAsync(String str, PurchaseHistoryResponseListener purchaseHistoryResponseListener) {
        ...
        } else if (zza(new zzl(this, str, purchaseHistoryResponseListener), (long) WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, (Runnable) new zzn(this, purchaseHistoryResponseListener)) == null) {
    ...
    public final zzb zzb(String str) {
        ...
        while (this.zzl) {
            try {
                ...
                ArrayList<String> stringArrayList2 = zza3.getStringArrayList(Constants.INAPP_PURCHASE_DATA_LIST);
                ArrayList<String> stringArrayList3 = zza3.getStringArrayList(Constants.INAPP_DATA_SIGNATURE_LIST);
                int i = 0;
    ...
    public void acknowledgePurchase(AcknowledgePurchaseParams acknowledgePurchaseParams, AcknowledgePurchaseResponseListener acknowledgePurchaseResponseListener) {
        ...
        } else if (zza(new zzm(this, acknowledgePurchaseParams, acknowledgePurchaseResponseListener), (long) WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, (Runnable) new zzr(this, acknowledgePurchaseResponseListener)) == null) {
    ...
    public final SkuDetails.zza zza(String str, List<zzap> list, String str2) {
        ...
        while (i < size) {
            ...
            bundle2.putStringArrayList(Constants.PRODUCTS_LIST, arrayList3);
            ...
            try {
                ...
                if (bundle == null) {
                ...
                } else if (!bundle.containsKey(Constants.DETAILS_LIST)) {
                    ...
                    ArrayList<String> stringArrayList = bundle.getStringArrayList(Constants.DETAILS_LIST);
    ...
    public final void zza(ConsumeParams consumeParams, ConsumeResponseListener consumeResponseListener) {
        ...
        try {
            ...
            if (this.zzn) {
                ...
                int i2 = zzc2.getInt(Constants.RESPONSE_CODE);
