...
final class zzam {
    static BillingResult zza(Bundle bundle, String str, String str2) {
        ...
        if (zza != 0) {
            ...
            return build;
        } else if (!bundle.containsKey("INAPP_PURCHASE_ITEM_LIST") || !bundle.containsKey(Constants.INAPP_PURCHASE_DATA_LIST) || !bundle.containsKey(Constants.INAPP_DATA_SIGNATURE_LIST)) {
