...
final class DistinguishedNameParser {
    ...
    private String quotedAV() {
        ...
        while (true) {
            ...
            if (i2 != this.length) {
                ...
                throw new IllegalStateException("Unexpected end of DN: " + this.f319dn);
            }
        }
    }
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f319dn);
            } else {
                i2 = c - '7';
            }
            char c2 = cArr[i4];
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f319dn.toCharArray();
