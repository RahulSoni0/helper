...
public final class Http2Stream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f318id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void sendResponseHeaders(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f318id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f318id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f318id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f318id);
            return true;
        }
    }
    ...
    private final class FramingSource implements Source {
        ...
        public long read(okio.Buffer r8, long r9) throws java.io.IOException {
            ...
            L_0x001d:
                ...
                int r3 = r3.f318id     // Catch:{ all -> 0x0099 }
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f318id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r8.this$0.connection.writeData(r8.this$0.f318id, true, (okio.Buffer) null, 0);
         */
