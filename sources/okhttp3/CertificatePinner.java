...
public final class CertificatePinner {
    ...
    static ByteString sha1(X509Certificate x509Certificate) {
        return ByteString.m280of(x509Certificate.getPublicKey().getEncoded()).sha1();
    }

    static ByteString sha256(X509Certificate x509Certificate) {
        return ByteString.m280of(x509Certificate.getPublicKey().getEncoded()).sha256();
    }
    ...
    static final class Pin {
        ...
        public int hashCode() {
            return ((((MetaDo.META_OFFSETWINDOWORG + this.pattern.hashCode()) * 31) + this.hashAlgorithm.hashCode()) * 31) + this.hash.hashCode();
        }
