...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C11921.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    static /* synthetic */ class C11921 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.HttpUrl.C11921.<clinit>():void");
        }
    }
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) cArr[readByte & BidiOrder.f1233B]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }
